...
import com.aliyuncs.v5.imm.model.v20170906.GetMediaMetaResponse;
import com.aliyuncs.v5.imm.model.v20170906.GetMediaMetaResponse.MediaMeta;
import com.aliyuncs.v5.imm.model.v20170906.GetMediaMetaResponse.MediaMeta.MediaFormat;
import com.aliyuncs.v5.imm.model.v20170906.GetMediaMetaResponse.MediaMeta.MediaFormat.Address;
import com.aliyuncs.v5.imm.model.v20170906.GetMediaMetaResponse.MediaMeta.MediaFormat.Tag;
import com.aliyuncs.v5.imm.model.v20170906.GetMediaMetaResponse.MediaMeta.MediaStreams;
import com.aliyuncs.v5.imm.model.v20170906.GetMediaMetaResponse.MediaMeta.MediaStreams.AudioStream;
import com.aliyuncs.v5.imm.model.v20170906.GetMediaMetaResponse.MediaMeta.MediaStreams.SubtitleStream;
import com.aliyuncs.v5.imm.model.v20170906.GetMediaMetaResponse.MediaMeta.MediaStreams.VideoStream;
...
public class GetMediaMetaResponseUnmarshaller {
	...
	public static GetMediaMetaResponse unmarshall(GetMediaMetaResponse getMediaMetaResponse, UnmarshallerContext _ctx) {
		...
		List<VideoStream> videoStreamsList = new ArrayList<VideoStream>();
		...
		mediaStreams.setVideoStreams(videoStreamsList);

		List<SubtitleStream> subtitleStreamsList = new ArrayList<SubtitleStream>();
		for (int i = 0; i < _ctx.lengthValue("GetMediaMetaResponse.MediaMeta.MediaStreams.SubtitleStreams.Length"); i++) {
			...
			subtitleStreamsList.add(subtitleStream);
		}
		mediaStreams.setSubtitleStreams(subtitleStreamsList);

		List<AudioStream> audioStreamsList = new ArrayList<AudioStream>();
		for (int i = 0; i < _ctx.lengthValue("GetMediaMetaResponse.MediaMeta.MediaStreams.AudioStreams.Length"); i++) {
			...
			audioStreamsList.add(audioStream);
		}
		mediaStreams.setAudioStreams(audioStreamsList);

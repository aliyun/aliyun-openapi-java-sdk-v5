...
import com.aliyuncs.v5.imm.model.v20170906.ListImageJobsResponse;
import com.aliyuncs.v5.imm.model.v20170906.ListImageJobsResponse.JobsItem;
...
public class ListImageJobsResponseUnmarshaller {
	...
	public static ListImageJobsResponse unmarshall(ListImageJobsResponse listImageJobsResponse, UnmarshallerContext _ctx) {
		...
		List<JobsItem> jobsList = new ArrayList<JobsItem>();
		for (int i = 0; i < _ctx.lengthValue("ListImageJobsResponse.Jobs.Length"); i++) {
			...
			jobsList.add(jobsItem);
		}
		listImageJobsResponse.setJobs(jobsList);

...
import com.aliyuncs.v5.imm.model.v20170906.ListProjectsResponse;
import com.aliyuncs.v5.imm.model.v20170906.ListProjectsResponse.ProjectsItem;
...
public class ListProjectsResponseUnmarshaller {
	...
	public static ListProjectsResponse unmarshall(ListProjectsResponse listProjectsResponse, UnmarshallerContext _ctx) {
		...
		listProjectsResponse.setProjects(projectsList);

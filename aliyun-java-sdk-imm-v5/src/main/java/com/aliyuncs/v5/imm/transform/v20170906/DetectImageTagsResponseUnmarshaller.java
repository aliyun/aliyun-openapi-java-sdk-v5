...
import com.aliyuncs.v5.imm.model.v20170906.DetectImageTagsResponse;
import com.aliyuncs.v5.imm.model.v20170906.DetectImageTagsResponse.TagsItem;
...
public class DetectImageTagsResponseUnmarshaller {
	...
	public static DetectImageTagsResponse unmarshall(DetectImageTagsResponse detectImageTagsResponse, UnmarshallerContext _ctx) {
		...
		detectImageTagsResponse.setTags(tagsList);

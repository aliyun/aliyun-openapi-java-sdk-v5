...
import com.aliyuncs.v5.imm.model.v20170906.ListVideoTasksResponse;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoTasksResponse.TasksItem;
...
public class ListVideoTasksResponseUnmarshaller {
	...
	public static ListVideoTasksResponse unmarshall(ListVideoTasksResponse listVideoTasksResponse, UnmarshallerContext _ctx) {
		...
		listVideoTasksResponse.setTasks(tasksList);

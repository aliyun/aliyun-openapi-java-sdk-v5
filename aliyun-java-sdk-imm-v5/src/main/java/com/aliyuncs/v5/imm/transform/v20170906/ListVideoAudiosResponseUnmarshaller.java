...
import com.aliyuncs.v5.imm.model.v20170906.ListVideoAudiosResponse;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoAudiosResponse.AudiosItem;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoAudiosResponse.AudiosItem.AudioTextsItem;
...
public class ListVideoAudiosResponseUnmarshaller {
	...
	public static ListVideoAudiosResponse unmarshall(ListVideoAudiosResponse listVideoAudiosResponse, UnmarshallerContext _ctx) {
		...
		List<AudiosItem> audiosList = new ArrayList<AudiosItem>();
		for (int i = 0; i < _ctx.lengthValue("ListVideoAudiosResponse.Audios.Length"); i++) {
			...
			List<AudioTextsItem> audioTextsList = new ArrayList<AudioTextsItem>();
			for (int j = 0; j < _ctx.lengthValue("ListVideoAudiosResponse.Audios["+ i +"].AudioTexts.Length"); j++) {
				...
				audioTextsList.add(audioTextsItem);
			}
			audiosItem.setAudioTexts(audioTextsList);

			audiosList.add(audiosItem);
		}
		listVideoAudiosResponse.setAudios(audiosList);

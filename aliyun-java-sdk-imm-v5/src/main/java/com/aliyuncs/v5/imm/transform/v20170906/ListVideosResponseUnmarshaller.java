...
import com.aliyuncs.v5.imm.model.v20170906.ListVideosResponse;
import com.aliyuncs.v5.imm.model.v20170906.ListVideosResponse.VideosItem;
import com.aliyuncs.v5.imm.model.v20170906.ListVideosResponse.VideosItem.CelebrityItem;
import com.aliyuncs.v5.imm.model.v20170906.ListVideosResponse.VideosItem.PersonsItem;
import com.aliyuncs.v5.imm.model.v20170906.ListVideosResponse.VideosItem.VideoTagsItem;
...
public class ListVideosResponseUnmarshaller {
	...
	public static ListVideosResponse unmarshall(ListVideosResponse listVideosResponse, UnmarshallerContext _ctx) {
		...
		List<VideosItem> videosList = new ArrayList<VideosItem>();
		for (int i = 0; i < _ctx.lengthValue("ListVideosResponse.Videos.Length"); i++) {
			...
			List<VideoTagsItem> videoTagsList = new ArrayList<VideoTagsItem>();
			for (int j = 0; j < _ctx.lengthValue("ListVideosResponse.Videos["+ i +"].VideoTags.Length"); j++) {
				...
				videoTagsList.add(videoTagsItem);
			}
			videosItem.setVideoTags(videoTagsList);
			...
			videosItem.setCelebrity(celebrityList);

			List<PersonsItem> personsList = new ArrayList<PersonsItem>();
			...
			videosItem.setPersons(personsList);

			videosList.add(videosItem);
		}
		listVideosResponse.setVideos(videosList);

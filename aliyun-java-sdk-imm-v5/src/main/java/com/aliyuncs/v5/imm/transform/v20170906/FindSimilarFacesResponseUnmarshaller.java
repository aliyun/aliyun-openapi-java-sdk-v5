...
import com.aliyuncs.v5.imm.model.v20170906.FindSimilarFacesResponse;
import com.aliyuncs.v5.imm.model.v20170906.FindSimilarFacesResponse.FacesItem;
import com.aliyuncs.v5.imm.model.v20170906.FindSimilarFacesResponse.FacesItem.FaceAttributes;
import com.aliyuncs.v5.imm.model.v20170906.FindSimilarFacesResponse.FacesItem.FaceAttributes.FaceBoundary2;
import com.aliyuncs.v5.imm.model.v20170906.FindSimilarFacesResponse.FacesItem.SimilarFacesItem;
import com.aliyuncs.v5.imm.model.v20170906.FindSimilarFacesResponse.FacesItem.SimilarFacesItem.FaceAttributes1;
import com.aliyuncs.v5.imm.model.v20170906.FindSimilarFacesResponse.FacesItem.SimilarFacesItem.FaceAttributes1.FaceBoundary;
...
public class FindSimilarFacesResponseUnmarshaller {
	...
	public static FindSimilarFacesResponse unmarshall(FindSimilarFacesResponse findSimilarFacesResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("FindSimilarFacesResponse.Faces.Length"); i++) {
			...
			List<SimilarFacesItem> similarFacesList = new ArrayList<SimilarFacesItem>();
			for (int j = 0; j < _ctx.lengthValue("FindSimilarFacesResponse.Faces["+ i +"].SimilarFaces.Length"); j++) {
				...
				similarFacesList.add(similarFacesItem);
			}
			facesItem.setSimilarFaces(similarFacesList);

			facesList.add(facesItem);
		}
		findSimilarFacesResponse.setFaces(facesList);

...
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem.CelebrityItem;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem.CelebrityItem.CelebrityBoundary;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem.FacesItem;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem.FacesItem.EmotionDetails;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem.FacesItem.FaceAttributes;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem.FacesItem.FaceAttributes.FaceBoundary;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem.FacesItem.FaceAttributes.HeadPose;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem.OCRItem;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem.OCRItem.OCRBoundary;
import com.aliyuncs.v5.imm.model.v20170906.ListVideoFramesResponse.FramesItem.TagsItem;
...
public class ListVideoFramesResponseUnmarshaller {
	...
	public static ListVideoFramesResponse unmarshall(ListVideoFramesResponse listVideoFramesResponse, UnmarshallerContext _ctx) {
		...
		List<FramesItem> framesList = new ArrayList<FramesItem>();
		for (int i = 0; i < _ctx.lengthValue("ListVideoFramesResponse.Frames.Length"); i++) {
			...
			framesItem.setCelebrity(celebrityList);

			framesList.add(framesItem);
		}
		listVideoFramesResponse.setFrames(framesList);

...
import com.aliyuncs.v5.imm.model.v20170906.ListSetsResponse;
import com.aliyuncs.v5.imm.model.v20170906.ListSetsResponse.SetsItem;
...
public class ListSetsResponseUnmarshaller {
	...
	public static ListSetsResponse unmarshall(ListSetsResponse listSetsResponse, UnmarshallerContext _ctx) {
		...
		List<SetsItem> setsList = new ArrayList<SetsItem>();
		for (int i = 0; i < _ctx.lengthValue("ListSetsResponse.Sets.Length"); i++) {
			...
			setsList.add(setsItem);
		}
		listSetsResponse.setSets(setsList);

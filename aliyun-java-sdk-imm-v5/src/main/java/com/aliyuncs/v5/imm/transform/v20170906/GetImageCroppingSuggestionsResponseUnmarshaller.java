...
import com.aliyuncs.v5.imm.model.v20170906.GetImageCroppingSuggestionsResponse;
import com.aliyuncs.v5.imm.model.v20170906.GetImageCroppingSuggestionsResponse.CroppingSuggestionsItem;
import com.aliyuncs.v5.imm.model.v20170906.GetImageCroppingSuggestionsResponse.CroppingSuggestionsItem.CroppingBoundary;
...
public class GetImageCroppingSuggestionsResponseUnmarshaller {
	...
	public static GetImageCroppingSuggestionsResponse unmarshall(GetImageCroppingSuggestionsResponse getImageCroppingSuggestionsResponse, UnmarshallerContext _ctx) {
		...
		List<CroppingSuggestionsItem> croppingSuggestionsList = new ArrayList<CroppingSuggestionsItem>();
		for (int i = 0; i < _ctx.lengthValue("GetImageCroppingSuggestionsResponse.CroppingSuggestions.Length"); i++) {
			...
			croppingSuggestionsList.add(croppingSuggestionsItem);
		}
		getImageCroppingSuggestionsResponse.setCroppingSuggestions(croppingSuggestionsList);

...
import com.aliyuncs.v5.imm.model.v20170906.DetectImageLogosResponse;
import com.aliyuncs.v5.imm.model.v20170906.DetectImageLogosResponse.LogosItem;
import com.aliyuncs.v5.imm.model.v20170906.DetectImageLogosResponse.LogosItem.LogoBoundary;
...
public class DetectImageLogosResponseUnmarshaller {
	...
	public static DetectImageLogosResponse unmarshall(DetectImageLogosResponse detectImageLogosResponse, UnmarshallerContext _ctx) {
		...
		List<LogosItem> logosList = new ArrayList<LogosItem>();
		for (int i = 0; i < _ctx.lengthValue("DetectImageLogosResponse.Logos.Length"); i++) {
			...
			logosList.add(logosItem);
		}
		detectImageLogosResponse.setLogos(logosList);

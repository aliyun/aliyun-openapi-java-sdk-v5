...
import com.aliyuncs.v5.imm.model.v20170906.ListSetTagsResponse;
import com.aliyuncs.v5.imm.model.v20170906.ListSetTagsResponse.TagsItem;
...
public class ListSetTagsResponseUnmarshaller {
	...
	public static ListSetTagsResponse unmarshall(ListSetTagsResponse listSetTagsResponse, UnmarshallerContext _ctx) {
		...
		listSetTagsResponse.setTags(tagsList);

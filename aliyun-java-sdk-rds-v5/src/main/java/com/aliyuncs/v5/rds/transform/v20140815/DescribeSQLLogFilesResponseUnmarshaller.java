...
import com.aliyuncs.v5.rds.model.v20140815.DescribeSQLLogFilesResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeSQLLogFilesResponse.LogFile;
...
public class DescribeSQLLogFilesResponseUnmarshaller {
	...
	public static DescribeSQLLogFilesResponse unmarshall(DescribeSQLLogFilesResponse describeSQLLogFilesResponse, UnmarshallerContext _ctx) {
		...
		List<LogFile> itemsList = new ArrayList<LogFile>();
		for (int i = 0; i < _ctx.lengthValue("DescribeSQLLogFilesResponse.Items.Length"); i++) {
			...
			itemsList.add(logFile);
		}
		describeSQLLogFilesResponse.setItems(itemsList);

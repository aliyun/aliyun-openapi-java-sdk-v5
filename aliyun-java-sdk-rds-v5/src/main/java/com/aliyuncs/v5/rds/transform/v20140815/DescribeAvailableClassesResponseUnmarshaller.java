...
import com.aliyuncs.v5.rds.model.v20140815.DescribeAvailableClassesResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeAvailableClassesResponse.DBInstanceClass;
import com.aliyuncs.v5.rds.model.v20140815.DescribeAvailableClassesResponse.DBInstanceClass.DBInstanceStorageRange;
...
public class DescribeAvailableClassesResponseUnmarshaller {
	...
	public static DescribeAvailableClassesResponse unmarshall(DescribeAvailableClassesResponse describeAvailableClassesResponse, UnmarshallerContext _ctx) {
		...
		List<DBInstanceClass> dBInstanceClassesList = new ArrayList<DBInstanceClass>();
		for (int i = 0; i < _ctx.lengthValue("DescribeAvailableClassesResponse.DBInstanceClasses.Length"); i++) {
			...
			dBInstanceClassesList.add(dBInstanceClass);
		}
		describeAvailableClassesResponse.setDBInstanceClasses(dBInstanceClassesList);

...
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBProxyResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBProxyResponse.DBProxyConnectStringItemsItem;
...
public class DescribeDBProxyResponseUnmarshaller {
	...
	public static DescribeDBProxyResponse unmarshall(DescribeDBProxyResponse describeDBProxyResponse, UnmarshallerContext _ctx) {
		...
		List<DBProxyConnectStringItemsItem> dBProxyConnectStringItemsList = new ArrayList<DBProxyConnectStringItemsItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDBProxyResponse.DBProxyConnectStringItems.Length"); i++) {
			...
			dBProxyConnectStringItemsList.add(dBProxyConnectStringItemsItem);
		}
		describeDBProxyResponse.setDBProxyConnectStringItems(dBProxyConnectStringItemsList);

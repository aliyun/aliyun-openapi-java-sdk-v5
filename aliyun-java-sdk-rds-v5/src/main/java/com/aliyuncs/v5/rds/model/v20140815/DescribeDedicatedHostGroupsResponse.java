...
import com.aliyuncs.v5.rds.transform.v20140815.DescribeDedicatedHostGroupsResponseUnmarshaller;
...
public class DescribeDedicatedHostGroupsResponse extends AcsResponse {
	...
	public static class DedicatedHostGroupsItem {
		...
		public String getDedicatedHostCountGroupByHostType() {
			return this.dedicatedHostCountGroupByHostType;
		}

		public void setDedicatedHostCountGroupByHostType(String dedicatedHostCountGroupByHostType) {

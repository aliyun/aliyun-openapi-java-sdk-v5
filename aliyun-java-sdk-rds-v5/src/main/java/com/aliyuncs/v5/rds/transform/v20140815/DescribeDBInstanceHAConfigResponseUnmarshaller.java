...
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstanceHAConfigResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstanceHAConfigResponse.NodeInfo;
...
public class DescribeDBInstanceHAConfigResponseUnmarshaller {
	...
	public static DescribeDBInstanceHAConfigResponse unmarshall(DescribeDBInstanceHAConfigResponse describeDBInstanceHAConfigResponse, UnmarshallerContext _ctx) {
		...
		List<NodeInfo> hostInstanceInfosList = new ArrayList<NodeInfo>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDBInstanceHAConfigResponse.HostInstanceInfos.Length"); i++) {
			...
			hostInstanceInfosList.add(nodeInfo);
		}
		describeDBInstanceHAConfigResponse.setHostInstanceInfos(hostInstanceInfosList);

...
import com.aliyuncs.v5.rds.model.v20140815.DescribeEventsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeEventsResponse.EventItemsItem;
...
public class DescribeEventsResponseUnmarshaller {
	...
	public static DescribeEventsResponse unmarshall(DescribeEventsResponse describeEventsResponse, UnmarshallerContext _ctx) {
		...
		describeEventsResponse.setEventItems(eventItemsList);

...
import com.aliyuncs.v5.rds.model.v20140815.DescribeSlowLogRecordsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeSlowLogRecordsResponse.SQLSlowRecord;
...
public class DescribeSlowLogRecordsResponseUnmarshaller {
	...
	public static DescribeSlowLogRecordsResponse unmarshall(DescribeSlowLogRecordsResponse describeSlowLogRecordsResponse, UnmarshallerContext _ctx) {
		...
		List<SQLSlowRecord> itemsList = new ArrayList<SQLSlowRecord>();

...
import com.aliyuncs.v5.rds.model.v20140815.DescribeParameterGroupsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeParameterGroupsResponse.ParameterGroup;
...
public class DescribeParameterGroupsResponseUnmarshaller {
	...
	public static DescribeParameterGroupsResponse unmarshall(DescribeParameterGroupsResponse describeParameterGroupsResponse, UnmarshallerContext _ctx) {
		...
		List<ParameterGroup> parameterGroupsList = new ArrayList<ParameterGroup>();
		for (int i = 0; i < _ctx.lengthValue("DescribeParameterGroupsResponse.ParameterGroups.Length"); i++) {
			...
			parameterGroupsList.add(parameterGroup);
		}
		describeParameterGroupsResponse.setParameterGroups(parameterGroupsList);

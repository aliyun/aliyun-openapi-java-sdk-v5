...
import com.aliyuncs.v5.rds.model.v20140815.DescibeImportsFromDatabaseResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescibeImportsFromDatabaseResponse.ImportResultFromDB;
...
public class DescibeImportsFromDatabaseResponseUnmarshaller {
	...
	public static DescibeImportsFromDatabaseResponse unmarshall(DescibeImportsFromDatabaseResponse descibeImportsFromDatabaseResponse, UnmarshallerContext _ctx) {
		...
		List<ImportResultFromDB> itemsList = new ArrayList<ImportResultFromDB>();
		for (int i = 0; i < _ctx.lengthValue("DescibeImportsFromDatabaseResponse.Items.Length"); i++) {
			...
			itemsList.add(importResultFromDB);
		}
		descibeImportsFromDatabaseResponse.setItems(itemsList);

...
import com.aliyuncs.v5.rds.model.v20140815.DescribeSlowLogsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeSlowLogsResponse.SQLSlowLog;
...
public class DescribeSlowLogsResponseUnmarshaller {
	...
	public static DescribeSlowLogsResponse unmarshall(DescribeSlowLogsResponse describeSlowLogsResponse, UnmarshallerContext _ctx) {
		...
		List<SQLSlowLog> itemsList = new ArrayList<SQLSlowLog>();
		for (int i = 0; i < _ctx.lengthValue("DescribeSlowLogsResponse.Items.Length"); i++) {
			...
			itemsList.add(sQLSlowLog);
		}
		describeSlowLogsResponse.setItems(itemsList);

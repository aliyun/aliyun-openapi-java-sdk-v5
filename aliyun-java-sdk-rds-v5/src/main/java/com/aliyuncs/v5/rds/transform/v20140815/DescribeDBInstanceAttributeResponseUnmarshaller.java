...
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstanceAttributeResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstanceAttributeResponse.DBInstanceAttribute;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstanceAttributeResponse.DBInstanceAttribute.Extra;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstanceAttributeResponse.DBInstanceAttribute.ReadOnlyDBInstanceId;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstanceAttributeResponse.DBInstanceAttribute.SlaveZone;
...
public class DescribeDBInstanceAttributeResponseUnmarshaller {
	...
	public static DescribeDBInstanceAttributeResponse unmarshall(DescribeDBInstanceAttributeResponse describeDBInstanceAttributeResponse, UnmarshallerContext _ctx) {
		...
		List<DBInstanceAttribute> itemsList = new ArrayList<DBInstanceAttribute>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDBInstanceAttributeResponse.Items.Length"); i++) {
			...
			List<SlaveZone> slaveZonesList = new ArrayList<SlaveZone>();
			for (int j = 0; j < _ctx.lengthValue("DescribeDBInstanceAttributeResponse.Items["+ i +"].SlaveZones.Length"); j++) {
				...
				slaveZonesList.add(slaveZone);
			}
			dBInstanceAttribute.setSlaveZones(slaveZonesList);

			List<ReadOnlyDBInstanceId> readOnlyDBInstanceIdsList = new ArrayList<ReadOnlyDBInstanceId>();
			for (int j = 0; j < _ctx.lengthValue("DescribeDBInstanceAttributeResponse.Items["+ i +"].ReadOnlyDBInstanceIds.Length"); j++) {
				...
				readOnlyDBInstanceIdsList.add(readOnlyDBInstanceId);
			}
			dBInstanceAttribute.setReadOnlyDBInstanceIds(readOnlyDBInstanceIdsList);

			itemsList.add(dBInstanceAttribute);
		}
		describeDBInstanceAttributeResponse.setItems(itemsList);

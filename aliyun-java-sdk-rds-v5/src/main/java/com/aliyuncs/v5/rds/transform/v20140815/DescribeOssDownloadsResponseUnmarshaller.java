...
import com.aliyuncs.v5.rds.model.v20140815.DescribeOssDownloadsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeOssDownloadsResponse.OssDownload;
...
public class DescribeOssDownloadsResponseUnmarshaller {
	...
	public static DescribeOssDownloadsResponse unmarshall(DescribeOssDownloadsResponse describeOssDownloadsResponse, UnmarshallerContext _ctx) {
		...
		describeOssDownloadsResponse.setItems(itemsList);

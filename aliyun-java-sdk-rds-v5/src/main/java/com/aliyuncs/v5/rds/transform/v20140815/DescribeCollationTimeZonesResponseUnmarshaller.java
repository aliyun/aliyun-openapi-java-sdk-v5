...
import com.aliyuncs.v5.rds.model.v20140815.DescribeCollationTimeZonesResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeCollationTimeZonesResponse.CollationTimeZone;
...
public class DescribeCollationTimeZonesResponseUnmarshaller {
	...
	public static DescribeCollationTimeZonesResponse unmarshall(DescribeCollationTimeZonesResponse describeCollationTimeZonesResponse, UnmarshallerContext _ctx) {
		...
		List<CollationTimeZone> collationTimeZonesList = new ArrayList<CollationTimeZone>();
		for (int i = 0; i < _ctx.lengthValue("DescribeCollationTimeZonesResponse.CollationTimeZones.Length"); i++) {
			...
			collationTimeZonesList.add(collationTimeZone);
		}
		describeCollationTimeZonesResponse.setCollationTimeZones(collationTimeZonesList);

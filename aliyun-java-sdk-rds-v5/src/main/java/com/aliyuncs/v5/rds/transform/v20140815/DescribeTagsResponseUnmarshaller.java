...
import com.aliyuncs.v5.rds.model.v20140815.DescribeTagsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeTagsResponse.TagInfos;
...
public class DescribeTagsResponseUnmarshaller {
	...
	public static DescribeTagsResponse unmarshall(DescribeTagsResponse describeTagsResponse, UnmarshallerContext _ctx) {
		...
		List<TagInfos> itemsList = new ArrayList<TagInfos>();
		for (int i = 0; i < _ctx.lengthValue("DescribeTagsResponse.Items.Length"); i++) {
			...
			itemsList.add(tagInfos);
		}
		describeTagsResponse.setItems(itemsList);

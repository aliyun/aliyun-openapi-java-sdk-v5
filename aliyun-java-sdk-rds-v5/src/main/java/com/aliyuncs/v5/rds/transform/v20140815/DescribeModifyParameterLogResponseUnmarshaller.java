...
import com.aliyuncs.v5.rds.model.v20140815.DescribeModifyParameterLogResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeModifyParameterLogResponse.ParameterChangeLog;
...
public class DescribeModifyParameterLogResponseUnmarshaller {
	...
	public static DescribeModifyParameterLogResponse unmarshall(DescribeModifyParameterLogResponse describeModifyParameterLogResponse, UnmarshallerContext _ctx) {
		...
		List<ParameterChangeLog> itemsList = new ArrayList<ParameterChangeLog>();
		for (int i = 0; i < _ctx.lengthValue("DescribeModifyParameterLogResponse.Items.Length"); i++) {
			...
			itemsList.add(parameterChangeLog);
		}
		describeModifyParameterLogResponse.setItems(itemsList);

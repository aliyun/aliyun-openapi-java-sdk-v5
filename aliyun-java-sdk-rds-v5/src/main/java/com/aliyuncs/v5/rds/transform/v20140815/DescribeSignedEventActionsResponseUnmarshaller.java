...
import com.aliyuncs.v5.rds.model.v20140815.DescribeSignedEventActionsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeSignedEventActionsResponse.EventItemsItem;
...
public class DescribeSignedEventActionsResponseUnmarshaller {
	...
	public static DescribeSignedEventActionsResponse unmarshall(DescribeSignedEventActionsResponse describeSignedEventActionsResponse, UnmarshallerContext _ctx) {
		...
		List<EventItemsItem> eventItemsList = new ArrayList<EventItemsItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeSignedEventActionsResponse.EventItems.Length"); i++) {
			...
			eventItemsList.add(eventItemsItem);
		}
		describeSignedEventActionsResponse.setEventItems(eventItemsList);

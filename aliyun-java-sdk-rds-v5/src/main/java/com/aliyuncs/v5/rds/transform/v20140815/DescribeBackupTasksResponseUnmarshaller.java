...
import com.aliyuncs.v5.rds.model.v20140815.DescribeBackupTasksResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeBackupTasksResponse.BackupJob;
...
public class DescribeBackupTasksResponseUnmarshaller {
	...
	public static DescribeBackupTasksResponse unmarshall(DescribeBackupTasksResponse describeBackupTasksResponse, UnmarshallerContext _ctx) {
		...
		List<BackupJob> itemsList = new ArrayList<BackupJob>();
		for (int i = 0; i < _ctx.lengthValue("DescribeBackupTasksResponse.Items.Length"); i++) {
			...
			itemsList.add(backupJob);
		}
		describeBackupTasksResponse.setItems(itemsList);

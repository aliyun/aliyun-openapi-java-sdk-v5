...
import com.aliyuncs.v5.rds.model.v20140815.DescribeRdsResourceSettingsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeRdsResourceSettingsResponse.RdsInstanceResourceSetting;
...
public class DescribeRdsResourceSettingsResponseUnmarshaller {
	...
	public static DescribeRdsResourceSettingsResponse unmarshall(DescribeRdsResourceSettingsResponse describeRdsResourceSettingsResponse, UnmarshallerContext _ctx) {
		...
		List<RdsInstanceResourceSetting> rdsInstanceResourceSettingsList = new ArrayList<RdsInstanceResourceSetting>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRdsResourceSettingsResponse.RdsInstanceResourceSettings.Length"); i++) {
			...
			rdsInstanceResourceSettingsList.add(rdsInstanceResourceSetting);
		}
		describeRdsResourceSettingsResponse.setRdsInstanceResourceSettings(rdsInstanceResourceSettingsList);

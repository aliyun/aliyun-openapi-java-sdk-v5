...
import com.aliyuncs.v5.rds.model.v20140815.DescribeRegionsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeRegionsResponse.RDSRegion;
...
public class DescribeRegionsResponseUnmarshaller {
	...
	public static DescribeRegionsResponse unmarshall(DescribeRegionsResponse describeRegionsResponse, UnmarshallerContext _ctx) {
		...
		List<RDSRegion> regionsList = new ArrayList<RDSRegion>();

...
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstancesOverviewResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstancesOverviewResponse.RegionModel;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstancesOverviewResponse.RegionModel.TypeModel;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstancesOverviewResponse.RegionModel.TypeModel.InstanceModel;
...
public class DescribeDBInstancesOverviewResponseUnmarshaller {
	...
	public static DescribeDBInstancesOverviewResponse unmarshall(DescribeDBInstancesOverviewResponse describeDBInstancesOverviewResponse, UnmarshallerContext _ctx) {
		...
		List<RegionModel> regionsList = new ArrayList<RegionModel>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDBInstancesOverviewResponse.Regions.Length"); i++) {
			...
			List<TypeModel> typeModelsList = new ArrayList<TypeModel>();
			for (int j = 0; j < _ctx.lengthValue("DescribeDBInstancesOverviewResponse.Regions["+ i +"].TypeModels.Length"); j++) {
				...
				List<InstanceModel> instanceModelsList = new ArrayList<InstanceModel>();
				for (int k = 0; k < _ctx.lengthValue("DescribeDBInstancesOverviewResponse.Regions["+ i +"].TypeModels["+ j +"].InstanceModels.Length"); k++) {
					...
					instanceModelsList.add(instanceModel);
				}
				typeModel.setInstanceModels(instanceModelsList);

				typeModelsList.add(typeModel);
			}
			regionModel.setTypeModels(typeModelsList);

			regionsList.add(regionModel);
		}
		describeDBInstancesOverviewResponse.setRegions(regionsList);

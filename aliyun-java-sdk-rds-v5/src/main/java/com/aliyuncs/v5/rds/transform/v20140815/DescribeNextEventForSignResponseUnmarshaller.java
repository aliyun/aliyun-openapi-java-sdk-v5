...
import com.aliyuncs.v5.rds.model.v20140815.DescribeNextEventForSignResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeNextEventForSignResponse.EventItemsItem;
...
public class DescribeNextEventForSignResponseUnmarshaller {
	...
	public static DescribeNextEventForSignResponse unmarshall(DescribeNextEventForSignResponse describeNextEventForSignResponse, UnmarshallerContext _ctx) {
		...
		describeNextEventForSignResponse.setEventItems(eventItemsList);

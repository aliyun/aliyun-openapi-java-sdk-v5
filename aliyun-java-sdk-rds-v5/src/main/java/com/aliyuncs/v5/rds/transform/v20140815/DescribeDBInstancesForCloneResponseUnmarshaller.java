...
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstancesForCloneResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstancesForCloneResponse.DBInstance;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstancesForCloneResponse.DBInstance.ReadOnlyDBInstanceId;
...
public class DescribeDBInstancesForCloneResponseUnmarshaller {
	...
	public static DescribeDBInstancesForCloneResponse unmarshall(DescribeDBInstancesForCloneResponse describeDBInstancesForCloneResponse, UnmarshallerContext _ctx) {
		...
		List<DBInstance> itemsList = new ArrayList<DBInstance>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDBInstancesForCloneResponse.Items.Length"); i++) {
			...
			dBInstance.setReadOnlyDBInstanceIds(readOnlyDBInstanceIdsList);

			itemsList.add(dBInstance);
		}
		describeDBInstancesForCloneResponse.setItems(itemsList);

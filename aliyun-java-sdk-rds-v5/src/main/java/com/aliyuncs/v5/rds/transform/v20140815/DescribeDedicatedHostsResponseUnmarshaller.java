...
import com.aliyuncs.v5.rds.model.v20140815.DescribeDedicatedHostsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDedicatedHostsResponse.DedicatedHostsItem;
...
public class DescribeDedicatedHostsResponseUnmarshaller {
	...
	public static DescribeDedicatedHostsResponse unmarshall(DescribeDedicatedHostsResponse describeDedicatedHostsResponse, UnmarshallerContext _ctx) {
		...
		List<DedicatedHostsItem> dedicatedHostsList = new ArrayList<DedicatedHostsItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDedicatedHostsResponse.DedicatedHosts.Length"); i++) {
			...
			dedicatedHostsList.add(dedicatedHostsItem);
		}
		describeDedicatedHostsResponse.setDedicatedHosts(dedicatedHostsList);

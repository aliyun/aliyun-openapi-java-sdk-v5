...
import com.aliyuncs.v5.rds.model.v20140815.DescribeBinlogFilesResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeBinlogFilesResponse.BinLogFile;
...
public class DescribeBinlogFilesResponseUnmarshaller {
	...
	public static DescribeBinlogFilesResponse unmarshall(DescribeBinlogFilesResponse describeBinlogFilesResponse, UnmarshallerContext _ctx) {
		...
		describeBinlogFilesResponse.setItems(itemsList);

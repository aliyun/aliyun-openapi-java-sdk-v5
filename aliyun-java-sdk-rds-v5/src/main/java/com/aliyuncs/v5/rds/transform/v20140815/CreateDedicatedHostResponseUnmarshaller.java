...
import com.aliyuncs.v5.rds.model.v20140815.CreateDedicatedHostResponse;
import com.aliyuncs.v5.rds.model.v20140815.CreateDedicatedHostResponse.DedicateHostListItem;
...
public class CreateDedicatedHostResponseUnmarshaller {
	...
	public static CreateDedicatedHostResponse unmarshall(CreateDedicatedHostResponse createDedicatedHostResponse, UnmarshallerContext _ctx) {
		...
		List<DedicateHostListItem> dedicateHostListList = new ArrayList<DedicateHostListItem>();
		for (int i = 0; i < _ctx.lengthValue("CreateDedicatedHostResponse.DedicateHostList.Length"); i++) {
			...
			dedicateHostListList.add(dedicateHostListItem);
		}
		createDedicatedHostResponse.setDedicateHostList(dedicateHostListList);

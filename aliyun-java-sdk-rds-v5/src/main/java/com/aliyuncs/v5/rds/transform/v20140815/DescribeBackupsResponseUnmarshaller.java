...
import com.aliyuncs.v5.rds.model.v20140815.DescribeBackupsResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeBackupsResponse.Backup;
...
public class DescribeBackupsResponseUnmarshaller {
	...
	public static DescribeBackupsResponse unmarshall(DescribeBackupsResponse describeBackupsResponse, UnmarshallerContext _ctx) {
		...
		describeBackupsResponse.setItems(itemsList);

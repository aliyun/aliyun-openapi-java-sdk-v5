...
import com.aliyuncs.v5.rds.model.v20140815.CalculateDBInstanceWeightResponse;
import com.aliyuncs.v5.rds.model.v20140815.CalculateDBInstanceWeightResponse.DBInstanceWeight;
...
public class CalculateDBInstanceWeightResponseUnmarshaller {
	...
	public static CalculateDBInstanceWeightResponse unmarshall(CalculateDBInstanceWeightResponse calculateDBInstanceWeightResponse, UnmarshallerContext _ctx) {
		...
		List<DBInstanceWeight> itemsList = new ArrayList<DBInstanceWeight>();
		for (int i = 0; i < _ctx.lengthValue("CalculateDBInstanceWeightResponse.Items.Length"); i++) {
			...
			itemsList.add(dBInstanceWeight);
		}
		calculateDBInstanceWeightResponse.setItems(itemsList);

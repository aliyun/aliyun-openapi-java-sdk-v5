...
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstanceIPArrayListResponse;
import com.aliyuncs.v5.rds.model.v20140815.DescribeDBInstanceIPArrayListResponse.DBInstanceIPArray;
...
public class DescribeDBInstanceIPArrayListResponseUnmarshaller {
	...
	public static DescribeDBInstanceIPArrayListResponse unmarshall(DescribeDBInstanceIPArrayListResponse describeDBInstanceIPArrayListResponse, UnmarshallerContext _ctx) {
		...
		List<DBInstanceIPArray> itemsList = new ArrayList<DBInstanceIPArray>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDBInstanceIPArrayListResponse.Items.Length"); i++) {
			...
			itemsList.add(dBInstanceIPArray);
		}
		describeDBInstanceIPArrayListResponse.setItems(itemsList);

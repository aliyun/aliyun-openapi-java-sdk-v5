...
import com.aliyuncs.v5.vod.model.v20170321.ListLiveRecordVideoResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListLiveRecordVideoResponse.LiveRecordVideo;
import com.aliyuncs.v5.vod.model.v20170321.ListLiveRecordVideoResponse.LiveRecordVideo.PlayInfo;
import com.aliyuncs.v5.vod.model.v20170321.ListLiveRecordVideoResponse.LiveRecordVideo.Video;
...
public class ListLiveRecordVideoResponseUnmarshaller {
	...
	public static ListLiveRecordVideoResponse unmarshall(ListLiveRecordVideoResponse listLiveRecordVideoResponse, UnmarshallerContext _ctx) {
		...
		List<LiveRecordVideo> liveRecordVideoListList = new ArrayList<LiveRecordVideo>();
		for (int i = 0; i < _ctx.lengthValue("ListLiveRecordVideoResponse.LiveRecordVideoList.Length"); i++) {
			...
			liveRecordVideo.setPlayInfoList(playInfoListList);

			liveRecordVideoListList.add(liveRecordVideo);
		}
		listLiveRecordVideoResponse.setLiveRecordVideoList(liveRecordVideoListList);

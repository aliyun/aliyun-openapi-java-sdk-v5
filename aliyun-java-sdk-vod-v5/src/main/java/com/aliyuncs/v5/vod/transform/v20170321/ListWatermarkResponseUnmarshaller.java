...
import com.aliyuncs.v5.vod.model.v20170321.ListWatermarkResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListWatermarkResponse.WatermarkInfo;
...
public class ListWatermarkResponseUnmarshaller {
	...
	public static ListWatermarkResponse unmarshall(ListWatermarkResponse listWatermarkResponse, UnmarshallerContext _ctx) {
		...
		List<WatermarkInfo> watermarkInfosList = new ArrayList<WatermarkInfo>();
		for (int i = 0; i < _ctx.lengthValue("ListWatermarkResponse.WatermarkInfos.Length"); i++) {
			...
			watermarkInfosList.add(watermarkInfo);
		}
		listWatermarkResponse.setWatermarkInfos(watermarkInfosList);

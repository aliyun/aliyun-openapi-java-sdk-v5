...
import com.aliyuncs.v5.vod.model.v20170321.ListTranscodeTemplateGroupResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListTranscodeTemplateGroupResponse.TranscodeTemplateGroup;
...
public class ListTranscodeTemplateGroupResponseUnmarshaller {
	...
	public static ListTranscodeTemplateGroupResponse unmarshall(ListTranscodeTemplateGroupResponse listTranscodeTemplateGroupResponse, UnmarshallerContext _ctx) {
		...
		List<TranscodeTemplateGroup> transcodeTemplateGroupListList = new ArrayList<TranscodeTemplateGroup>();
		for (int i = 0; i < _ctx.lengthValue("ListTranscodeTemplateGroupResponse.TranscodeTemplateGroupList.Length"); i++) {
			...
			transcodeTemplateGroupListList.add(transcodeTemplateGroup);
		}
		listTranscodeTemplateGroupResponse.setTranscodeTemplateGroupList(transcodeTemplateGroupListList);

...
import com.aliyuncs.v5.vod.model.v20170321.GetAIImageJobsResponse;
import com.aliyuncs.v5.vod.model.v20170321.GetAIImageJobsResponse.AIImageJob;
...
public class GetAIImageJobsResponseUnmarshaller {
	...
	public static GetAIImageJobsResponse unmarshall(GetAIImageJobsResponse getAIImageJobsResponse, UnmarshallerContext _ctx) {
		...
		List<AIImageJob> aIImageJobListList = new ArrayList<AIImageJob>();
		for (int i = 0; i < _ctx.lengthValue("GetAIImageJobsResponse.AIImageJobList.Length"); i++) {
			...
			aIImageJobListList.add(aIImageJob);
		}
		getAIImageJobsResponse.setAIImageJobList(aIImageJobListList);

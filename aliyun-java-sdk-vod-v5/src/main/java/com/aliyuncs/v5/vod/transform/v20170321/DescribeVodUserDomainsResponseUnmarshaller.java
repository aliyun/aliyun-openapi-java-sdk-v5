...
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodUserDomainsResponse;
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodUserDomainsResponse.PageData;
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodUserDomainsResponse.PageData.Source;
...
public class DescribeVodUserDomainsResponseUnmarshaller {
	...
	public static DescribeVodUserDomainsResponse unmarshall(DescribeVodUserDomainsResponse describeVodUserDomainsResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeVodUserDomainsResponse.Domains.Length"); i++) {
			...
			pageData.setSources(sourcesList);

			domainsList.add(pageData);
		}
		describeVodUserDomainsResponse.setDomains(domainsList);

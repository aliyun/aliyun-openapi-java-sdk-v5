...
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodDomainTrafficDataResponse;
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodDomainTrafficDataResponse.DataModule;
...
public class DescribeVodDomainTrafficDataResponseUnmarshaller {
	...
	public static DescribeVodDomainTrafficDataResponse unmarshall(DescribeVodDomainTrafficDataResponse describeVodDomainTrafficDataResponse, UnmarshallerContext _ctx) {
		...
		List<DataModule> trafficDataPerIntervalList = new ArrayList<DataModule>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVodDomainTrafficDataResponse.TrafficDataPerInterval.Length"); i++) {
			...
			trafficDataPerIntervalList.add(dataModule);
		}
		describeVodDomainTrafficDataResponse.setTrafficDataPerInterval(trafficDataPerIntervalList);

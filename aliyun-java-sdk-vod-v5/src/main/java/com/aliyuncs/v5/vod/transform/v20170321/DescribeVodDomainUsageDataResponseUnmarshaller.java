...
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodDomainUsageDataResponse;
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodDomainUsageDataResponse.DataModule;
...
public class DescribeVodDomainUsageDataResponseUnmarshaller {
	...
	public static DescribeVodDomainUsageDataResponse unmarshall(DescribeVodDomainUsageDataResponse describeVodDomainUsageDataResponse, UnmarshallerContext _ctx) {
		...
		List<DataModule> usageDataPerIntervalList = new ArrayList<DataModule>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVodDomainUsageDataResponse.UsageDataPerInterval.Length"); i++) {
			...
			usageDataPerIntervalList.add(dataModule);
		}
		describeVodDomainUsageDataResponse.setUsageDataPerInterval(usageDataPerIntervalList);

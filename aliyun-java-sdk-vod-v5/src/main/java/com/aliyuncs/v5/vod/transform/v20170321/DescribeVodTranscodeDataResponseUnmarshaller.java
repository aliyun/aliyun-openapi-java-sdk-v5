...
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodTranscodeDataResponse;
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodTranscodeDataResponse.TranscodeDataItem;
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodTranscodeDataResponse.TranscodeDataItem.DataItem;
...
public class DescribeVodTranscodeDataResponseUnmarshaller {
	...
	public static DescribeVodTranscodeDataResponse unmarshall(DescribeVodTranscodeDataResponse describeVodTranscodeDataResponse, UnmarshallerContext _ctx) {
		...
		List<TranscodeDataItem> transcodeDataList = new ArrayList<TranscodeDataItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVodTranscodeDataResponse.TranscodeData.Length"); i++) {
			...
			transcodeDataItem.setData(dataList);

			transcodeDataList.add(transcodeDataItem);
		}
		describeVodTranscodeDataResponse.setTranscodeData(transcodeDataList);

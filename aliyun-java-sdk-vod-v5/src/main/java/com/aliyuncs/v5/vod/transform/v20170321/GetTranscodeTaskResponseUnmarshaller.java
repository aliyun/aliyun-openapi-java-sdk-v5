...
import com.aliyuncs.v5.vod.model.v20170321.GetTranscodeTaskResponse;
import com.aliyuncs.v5.vod.model.v20170321.GetTranscodeTaskResponse.TranscodeTask;
import com.aliyuncs.v5.vod.model.v20170321.GetTranscodeTaskResponse.TranscodeTask.TranscodeJobInfo;
import com.aliyuncs.v5.vod.model.v20170321.GetTranscodeTaskResponse.TranscodeTask.TranscodeJobInfo.OutputFile;
...
public class GetTranscodeTaskResponseUnmarshaller {
	...
	public static GetTranscodeTaskResponse unmarshall(GetTranscodeTaskResponse getTranscodeTaskResponse, UnmarshallerContext _ctx) {
		...
		List<TranscodeJobInfo> transcodeJobInfoListList = new ArrayList<TranscodeJobInfo>();
		for (int i = 0; i < _ctx.lengthValue("GetTranscodeTaskResponse.TranscodeTask.TranscodeJobInfoList.Length"); i++) {
			...
			transcodeJobInfoListList.add(transcodeJobInfo);
		}
		transcodeTask.setTranscodeJobInfoList(transcodeJobInfoListList);

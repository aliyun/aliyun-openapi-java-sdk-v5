...
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodTagResourcesResponse;
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodTagResourcesResponse.TagResource;
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodTagResourcesResponse.TagResource.TagItem;
...
public class DescribeVodTagResourcesResponseUnmarshaller {
	...
	public static DescribeVodTagResourcesResponse unmarshall(DescribeVodTagResourcesResponse describeVodTagResourcesResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeVodTagResourcesResponse.TagResources.Length"); i++) {
			...
			List<TagItem> tagList = new ArrayList<TagItem>();
			...
			tagResource.setTag(tagList);

			tagResourcesList.add(tagResource);
		}
		describeVodTagResourcesResponse.setTagResources(tagResourcesList);

...
import com.aliyuncs.v5.vod.model.v20170321.ListDynamicImageResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListDynamicImageResponse.DynamicImage;
...
public class ListDynamicImageResponseUnmarshaller {
	...
	public static ListDynamicImageResponse unmarshall(ListDynamicImageResponse listDynamicImageResponse, UnmarshallerContext _ctx) {
		...
		List<DynamicImage> dynamicImageListList = new ArrayList<DynamicImage>();
		for (int i = 0; i < _ctx.lengthValue("ListDynamicImageResponse.DynamicImageList.Length"); i++) {
			...
			dynamicImageListList.add(dynamicImage);
		}
		listDynamicImageResponse.setDynamicImageList(dynamicImageListList);

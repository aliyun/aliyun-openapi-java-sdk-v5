...
import com.aliyuncs.v5.vod.model.v20170321.GetVideoInfosResponse;
import com.aliyuncs.v5.vod.model.v20170321.GetVideoInfosResponse.Video;
import com.aliyuncs.v5.vod.model.v20170321.GetVideoInfosResponse.Video.Thumbnail;
...
public class GetVideoInfosResponseUnmarshaller {
	...
	public static GetVideoInfosResponse unmarshall(GetVideoInfosResponse getVideoInfosResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("GetVideoInfosResponse.VideoList.Length"); i++) {
			...
			video.setThumbnailList(thumbnailListList);

			videoListList.add(video);
		}
		getVideoInfosResponse.setVideoList(videoListList);

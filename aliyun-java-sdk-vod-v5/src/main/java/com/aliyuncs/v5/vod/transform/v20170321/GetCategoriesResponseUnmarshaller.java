...
import com.aliyuncs.v5.vod.model.v20170321.GetCategoriesResponse;
import com.aliyuncs.v5.vod.model.v20170321.GetCategoriesResponse.Category;
import com.aliyuncs.v5.vod.model.v20170321.GetCategoriesResponse.Category1;
...
public class GetCategoriesResponseUnmarshaller {
	...
	public static GetCategoriesResponse unmarshall(GetCategoriesResponse getCategoriesResponse, UnmarshallerContext _ctx) {
		...
		getCategoriesResponse.setSubCategories(subCategoriesList);

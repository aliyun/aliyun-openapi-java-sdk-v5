...
import com.aliyuncs.v5.vod.model.v20170321.ListAIJobResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListAIJobResponse.AIJob;
...
public class ListAIJobResponseUnmarshaller {
	...
	public static ListAIJobResponse unmarshall(ListAIJobResponse listAIJobResponse, UnmarshallerContext _ctx) {
		...
		listAIJobResponse.setAIJobList(aIJobListList);

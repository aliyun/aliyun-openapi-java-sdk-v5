...
import com.aliyuncs.v5.vod.model.v20170321.ListVodTemplateResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListVodTemplateResponse.VodTemplateInfo;
...
public class ListVodTemplateResponseUnmarshaller {
	...
	public static ListVodTemplateResponse unmarshall(ListVodTemplateResponse listVodTemplateResponse, UnmarshallerContext _ctx) {
		...
		List<VodTemplateInfo> vodTemplateInfoListList = new ArrayList<VodTemplateInfo>();
		for (int i = 0; i < _ctx.lengthValue("ListVodTemplateResponse.VodTemplateInfoList.Length"); i++) {
			...
			vodTemplateInfoListList.add(vodTemplateInfo);
		}
		listVodTemplateResponse.setVodTemplateInfoList(vodTemplateInfoListList);

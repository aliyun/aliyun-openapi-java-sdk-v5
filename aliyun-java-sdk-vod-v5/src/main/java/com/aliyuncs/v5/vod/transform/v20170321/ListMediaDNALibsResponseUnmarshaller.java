...
import com.aliyuncs.v5.vod.model.v20170321.ListMediaDNALibsResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListMediaDNALibsResponse.AIDNALibInfo;
...
public class ListMediaDNALibsResponseUnmarshaller {
	...
	public static ListMediaDNALibsResponse unmarshall(ListMediaDNALibsResponse listMediaDNALibsResponse, UnmarshallerContext _ctx) {
		...
		List<AIDNALibInfo> aIDNALibInfoListList = new ArrayList<AIDNALibInfo>();
		for (int i = 0; i < _ctx.lengthValue("ListMediaDNALibsResponse.AIDNALibInfoList.Length"); i++) {
			...
			aIDNALibInfoListList.add(aIDNALibInfo);
		}
		listMediaDNALibsResponse.setAIDNALibInfoList(aIDNALibInfoListList);

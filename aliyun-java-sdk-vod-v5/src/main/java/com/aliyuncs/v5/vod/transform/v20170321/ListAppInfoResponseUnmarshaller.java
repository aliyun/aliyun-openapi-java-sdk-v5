...
import com.aliyuncs.v5.vod.model.v20170321.ListAppInfoResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListAppInfoResponse.AppInfo;
...
public class ListAppInfoResponseUnmarshaller {
	...
	public static ListAppInfoResponse unmarshall(ListAppInfoResponse listAppInfoResponse, UnmarshallerContext _ctx) {
		...
		listAppInfoResponse.setAppInfoList(appInfoListList);

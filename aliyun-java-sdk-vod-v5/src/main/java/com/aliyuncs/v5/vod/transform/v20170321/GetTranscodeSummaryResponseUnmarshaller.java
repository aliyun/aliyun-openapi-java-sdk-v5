...
import com.aliyuncs.v5.vod.model.v20170321.GetTranscodeSummaryResponse;
import com.aliyuncs.v5.vod.model.v20170321.GetTranscodeSummaryResponse.TranscodeSummary;
import com.aliyuncs.v5.vod.model.v20170321.GetTranscodeSummaryResponse.TranscodeSummary.TranscodeJobInfoSummary;
...
public class GetTranscodeSummaryResponseUnmarshaller {
	...
	public static GetTranscodeSummaryResponse unmarshall(GetTranscodeSummaryResponse getTranscodeSummaryResponse, UnmarshallerContext _ctx) {
		...
		List<TranscodeSummary> transcodeSummaryListList = new ArrayList<TranscodeSummary>();
		for (int i = 0; i < _ctx.lengthValue("GetTranscodeSummaryResponse.TranscodeSummaryList.Length"); i++) {
			...
			List<TranscodeJobInfoSummary> transcodeJobInfoSummaryListList = new ArrayList<TranscodeJobInfoSummary>();
			for (int j = 0; j < _ctx.lengthValue("GetTranscodeSummaryResponse.TranscodeSummaryList["+ i +"].TranscodeJobInfoSummaryList.Length"); j++) {
				...
				transcodeJobInfoSummaryListList.add(transcodeJobInfoSummary);
			}
			transcodeSummary.setTranscodeJobInfoSummaryList(transcodeJobInfoSummaryListList);

			transcodeSummaryListList.add(transcodeSummary);
		}
		getTranscodeSummaryResponse.setTranscodeSummaryList(transcodeSummaryListList);

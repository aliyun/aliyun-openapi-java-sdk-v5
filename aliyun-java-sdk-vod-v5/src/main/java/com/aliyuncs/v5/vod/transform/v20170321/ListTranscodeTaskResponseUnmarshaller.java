...
import com.aliyuncs.v5.vod.model.v20170321.ListTranscodeTaskResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListTranscodeTaskResponse.TranscodeTask;
...
public class ListTranscodeTaskResponseUnmarshaller {
	...
	public static ListTranscodeTaskResponse unmarshall(ListTranscodeTaskResponse listTranscodeTaskResponse, UnmarshallerContext _ctx) {
		...
		List<TranscodeTask> transcodeTaskListList = new ArrayList<TranscodeTask>();
		for (int i = 0; i < _ctx.lengthValue("ListTranscodeTaskResponse.TranscodeTaskList.Length"); i++) {
			...
			transcodeTaskListList.add(transcodeTask);
		}
		listTranscodeTaskResponse.setTranscodeTaskList(transcodeTaskListList);

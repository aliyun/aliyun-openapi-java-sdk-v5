...
import com.aliyuncs.v5.vod.model.v20170321.ListMediaDNADeleteJobResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListMediaDNADeleteJobResponse.AIJob;
...
public class ListMediaDNADeleteJobResponseUnmarshaller {
	...
	public static ListMediaDNADeleteJobResponse unmarshall(ListMediaDNADeleteJobResponse listMediaDNADeleteJobResponse, UnmarshallerContext _ctx) {
		...
		List<AIJob> aIJobListList = new ArrayList<AIJob>();
		for (int i = 0; i < _ctx.lengthValue("ListMediaDNADeleteJobResponse.AIJobList.Length"); i++) {
			...
			aIJobListList.add(aIJob);
		}
		listMediaDNADeleteJobResponse.setAIJobList(aIJobListList);

...
import com.aliyuncs.v5.vod.model.v20170321.RegisterMediaResponse;
import com.aliyuncs.v5.vod.model.v20170321.RegisterMediaResponse.RegisteredMedia;
...
public class RegisterMediaResponseUnmarshaller {
	...
	public static RegisterMediaResponse unmarshall(RegisterMediaResponse registerMediaResponse, UnmarshallerContext _ctx) {
		...
		List<RegisteredMedia> registeredMediaListList = new ArrayList<RegisteredMedia>();
		for (int i = 0; i < _ctx.lengthValue("RegisterMediaResponse.RegisteredMediaList.Length"); i++) {
			...
			registeredMediaListList.add(registeredMedia);
		}
		registerMediaResponse.setRegisteredMediaList(registeredMediaListList);

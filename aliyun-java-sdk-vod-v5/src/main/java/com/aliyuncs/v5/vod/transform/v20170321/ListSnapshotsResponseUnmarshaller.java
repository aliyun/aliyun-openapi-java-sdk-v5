...
import com.aliyuncs.v5.vod.model.v20170321.ListSnapshotsResponse;
import com.aliyuncs.v5.vod.model.v20170321.ListSnapshotsResponse.MediaSnapshot;
import com.aliyuncs.v5.vod.model.v20170321.ListSnapshotsResponse.MediaSnapshot.Snapshot;
...
public class ListSnapshotsResponseUnmarshaller {
	...
	public static ListSnapshotsResponse unmarshall(ListSnapshotsResponse listSnapshotsResponse, UnmarshallerContext _ctx) {
		...
		List<Snapshot> snapshotsList = new ArrayList<Snapshot>();
		...
		mediaSnapshot.setSnapshots(snapshotsList);

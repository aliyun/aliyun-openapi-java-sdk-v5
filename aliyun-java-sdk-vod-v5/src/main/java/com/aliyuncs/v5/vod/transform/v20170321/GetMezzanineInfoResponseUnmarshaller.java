...
import com.aliyuncs.v5.vod.model.v20170321.GetMezzanineInfoResponse;
import com.aliyuncs.v5.vod.model.v20170321.GetMezzanineInfoResponse.Mezzanine;
import com.aliyuncs.v5.vod.model.v20170321.GetMezzanineInfoResponse.Mezzanine.AudioStream;
import com.aliyuncs.v5.vod.model.v20170321.GetMezzanineInfoResponse.Mezzanine.VideoStream;
...
public class GetMezzanineInfoResponseUnmarshaller {
	...
	public static GetMezzanineInfoResponse unmarshall(GetMezzanineInfoResponse getMezzanineInfoResponse, UnmarshallerContext _ctx) {
		...
		List<AudioStream> audioStreamListList = new ArrayList<AudioStream>();
		for (int i = 0; i < _ctx.lengthValue("GetMezzanineInfoResponse.Mezzanine.AudioStreamList.Length"); i++) {
			...
			audioStreamListList.add(audioStream);
		}
		mezzanine.setAudioStreamList(audioStreamListList);

		List<VideoStream> videoStreamListList = new ArrayList<VideoStream>();
		for (int i = 0; i < _ctx.lengthValue("GetMezzanineInfoResponse.Mezzanine.VideoStreamList.Length"); i++) {
			...
			videoStreamListList.add(videoStream);
		}
		mezzanine.setVideoStreamList(videoStreamListList);

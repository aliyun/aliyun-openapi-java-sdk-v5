...
import com.aliyuncs.v5.vod.model.v20170321.SearchEditingProjectResponse;
import com.aliyuncs.v5.vod.model.v20170321.SearchEditingProjectResponse.Project;
...
public class SearchEditingProjectResponseUnmarshaller {
	...
	public static SearchEditingProjectResponse unmarshall(SearchEditingProjectResponse searchEditingProjectResponse, UnmarshallerContext _ctx) {
		...
		List<Project> projectListList = new ArrayList<Project>();
		for (int i = 0; i < _ctx.lengthValue("SearchEditingProjectResponse.ProjectList.Length"); i++) {
			...
			projectListList.add(project);
		}
		searchEditingProjectResponse.setProjectList(projectListList);

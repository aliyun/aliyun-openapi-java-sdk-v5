...
import com.aliyuncs.v5.vod.model.v20170321.DescribePlayVideoStatisResponse;
import com.aliyuncs.v5.vod.model.v20170321.DescribePlayVideoStatisResponse.VideoPlayStatisDetail;
...
public class DescribePlayVideoStatisResponseUnmarshaller {
	...
	public static DescribePlayVideoStatisResponse unmarshall(DescribePlayVideoStatisResponse describePlayVideoStatisResponse, UnmarshallerContext _ctx) {
		...
		List<VideoPlayStatisDetail> videoPlayStatisDetailsList = new ArrayList<VideoPlayStatisDetail>();
		for (int i = 0; i < _ctx.lengthValue("DescribePlayVideoStatisResponse.VideoPlayStatisDetails.Length"); i++) {
			...
			videoPlayStatisDetailsList.add(videoPlayStatisDetail);
		}
		describePlayVideoStatisResponse.setVideoPlayStatisDetails(videoPlayStatisDetailsList);

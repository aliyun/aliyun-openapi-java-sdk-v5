...
import com.aliyuncs.v5.vod.model.v20170321.GetAuditHistoryResponse;
import com.aliyuncs.v5.vod.model.v20170321.GetAuditHistoryResponse.History;
...
public class GetAuditHistoryResponseUnmarshaller {
	...
	public static GetAuditHistoryResponse unmarshall(GetAuditHistoryResponse getAuditHistoryResponse, UnmarshallerContext _ctx) {
		...
		List<History> historiesList = new ArrayList<History>();
		...
		getAuditHistoryResponse.setHistories(historiesList);

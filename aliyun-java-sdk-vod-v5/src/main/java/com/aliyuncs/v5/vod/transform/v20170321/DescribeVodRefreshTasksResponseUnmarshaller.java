...
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodRefreshTasksResponse;
import com.aliyuncs.v5.vod.model.v20170321.DescribeVodRefreshTasksResponse.Task;
...
public class DescribeVodRefreshTasksResponseUnmarshaller {
	...
	public static DescribeVodRefreshTasksResponse unmarshall(DescribeVodRefreshTasksResponse describeVodRefreshTasksResponse, UnmarshallerContext _ctx) {
		...
		describeVodRefreshTasksResponse.setTasks(tasksList);

...
import com.aliyuncs.v5.vod.model.v20170321.GetURLUploadInfosResponse;
import com.aliyuncs.v5.vod.model.v20170321.GetURLUploadInfosResponse.UrlUploadJobInfoDTO;
...
public class GetURLUploadInfosResponseUnmarshaller {
	...
	public static GetURLUploadInfosResponse unmarshall(GetURLUploadInfosResponse getURLUploadInfosResponse, UnmarshallerContext _ctx) {
		...
		List<UrlUploadJobInfoDTO> uRLUploadInfoListList = new ArrayList<UrlUploadJobInfoDTO>();
		for (int i = 0; i < _ctx.lengthValue("GetURLUploadInfosResponse.URLUploadInfoList.Length"); i++) {
			...
			uRLUploadInfoListList.add(urlUploadJobInfoDTO);
		}
		getURLUploadInfosResponse.setURLUploadInfoList(uRLUploadInfoListList);

...
import com.aliyuncs.v5.vod.model.v20170321.DescribePlayUserAvgResponse;
import com.aliyuncs.v5.vod.model.v20170321.DescribePlayUserAvgResponse.UserPlayStatisAvg;
...
public class DescribePlayUserAvgResponseUnmarshaller {
	...
	public static DescribePlayUserAvgResponse unmarshall(DescribePlayUserAvgResponse describePlayUserAvgResponse, UnmarshallerContext _ctx) {
		...
		List<UserPlayStatisAvg> userPlayStatisAvgsList = new ArrayList<UserPlayStatisAvg>();
		for (int i = 0; i < _ctx.lengthValue("DescribePlayUserAvgResponse.UserPlayStatisAvgs.Length"); i++) {
			...
			userPlayStatisAvgsList.add(userPlayStatisAvg);
		}
		describePlayUserAvgResponse.setUserPlayStatisAvgs(userPlayStatisAvgsList);

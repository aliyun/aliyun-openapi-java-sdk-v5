...
import com.aliyuncs.v5.vod.model.v20170321.DescribePlayTopVideosResponse;
import com.aliyuncs.v5.vod.model.v20170321.DescribePlayTopVideosResponse.TopPlayVideoStatis;
...
public class DescribePlayTopVideosResponseUnmarshaller {
	...
	public static DescribePlayTopVideosResponse unmarshall(DescribePlayTopVideosResponse describePlayTopVideosResponse, UnmarshallerContext _ctx) {
		...
		List<TopPlayVideoStatis> topPlayVideosList = new ArrayList<TopPlayVideoStatis>();
		for (int i = 0; i < _ctx.lengthValue("DescribePlayTopVideosResponse.TopPlayVideos.Length"); i++) {
			...
			topPlayVideosList.add(topPlayVideoStatis);
		}
		describePlayTopVideosResponse.setTopPlayVideos(topPlayVideosList);

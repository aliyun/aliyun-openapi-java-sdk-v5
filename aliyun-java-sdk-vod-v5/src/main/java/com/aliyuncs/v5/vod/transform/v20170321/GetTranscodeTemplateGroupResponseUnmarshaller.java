...
import com.aliyuncs.v5.vod.model.v20170321.GetTranscodeTemplateGroupResponse;
import com.aliyuncs.v5.vod.model.v20170321.GetTranscodeTemplateGroupResponse.TranscodeTemplateGroup;
import com.aliyuncs.v5.vod.model.v20170321.GetTranscodeTemplateGroupResponse.TranscodeTemplateGroup.TranscodeTemplate;
...
public class GetTranscodeTemplateGroupResponseUnmarshaller {
	...
	public static GetTranscodeTemplateGroupResponse unmarshall(GetTranscodeTemplateGroupResponse getTranscodeTemplateGroupResponse, UnmarshallerContext _ctx) {
		...
		List<TranscodeTemplate> transcodeTemplateListList = new ArrayList<TranscodeTemplate>();
		for (int i = 0; i < _ctx.lengthValue("GetTranscodeTemplateGroupResponse.TranscodeTemplateGroup.TranscodeTemplateList.Length"); i++) {
			...
			transcodeTemplateListList.add(transcodeTemplate);
		}
		transcodeTemplateGroup.setTranscodeTemplateList(transcodeTemplateListList);

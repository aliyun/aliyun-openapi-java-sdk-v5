...
import com.aliyuncs.v5.vod.model.v20170321.SearchMediaResponse;
import com.aliyuncs.v5.vod.model.v20170321.SearchMediaResponse.Media;
import com.aliyuncs.v5.vod.model.v20170321.SearchMediaResponse.Media.AttachedMedia;
import com.aliyuncs.v5.vod.model.v20170321.SearchMediaResponse.Media.AttachedMedia.Category;
import com.aliyuncs.v5.vod.model.v20170321.SearchMediaResponse.Media.Audio;
import com.aliyuncs.v5.vod.model.v20170321.SearchMediaResponse.Media.Audio.PlayInfo4;
import com.aliyuncs.v5.vod.model.v20170321.SearchMediaResponse.Media.Image;
import com.aliyuncs.v5.vod.model.v20170321.SearchMediaResponse.Media.Video;
import com.aliyuncs.v5.vod.model.v20170321.SearchMediaResponse.Media.Video.PlayInfo;
...
public class SearchMediaResponseUnmarshaller {
	...
	public static SearchMediaResponse unmarshall(SearchMediaResponse searchMediaResponse, UnmarshallerContext _ctx) {
		...
		List<Media> mediaListList = new ArrayList<Media>();
		for (int i = 0; i < _ctx.lengthValue("SearchMediaResponse.MediaList.Length"); i++) {
			...
			List<PlayInfo> playInfoListList = new ArrayList<PlayInfo>();
			for (int j = 0; j < _ctx.lengthValue("SearchMediaResponse.MediaList["+ i +"].Video.PlayInfoList.Length"); j++) {
				...
				playInfoListList.add(playInfo);
			}
			video.setPlayInfoList(playInfoListList);
			...
			List<PlayInfo4> playInfoList3List = new ArrayList<PlayInfo4>();
			for (int j = 0; j < _ctx.lengthValue("SearchMediaResponse.MediaList["+ i +"].Audio.PlayInfoList.Length"); j++) {
				...
				playInfoList3List.add(playInfo4);
			}
			audio.setPlayInfoList3(playInfoList3List);
			...
			mediaListList.add(media);
		}
		searchMediaResponse.setMediaList(mediaListList);

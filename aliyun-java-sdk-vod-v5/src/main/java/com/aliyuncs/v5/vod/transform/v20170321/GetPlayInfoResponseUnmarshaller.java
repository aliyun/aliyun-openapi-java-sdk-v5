...
import com.aliyuncs.v5.vod.model.v20170321.GetPlayInfoResponse;
import com.aliyuncs.v5.vod.model.v20170321.GetPlayInfoResponse.PlayInfo;
import com.aliyuncs.v5.vod.model.v20170321.GetPlayInfoResponse.VideoBase;
import com.aliyuncs.v5.vod.model.v20170321.GetPlayInfoResponse.VideoBase.Thumbnail;
...
public class GetPlayInfoResponseUnmarshaller {
	...
	public static GetPlayInfoResponse unmarshall(GetPlayInfoResponse getPlayInfoResponse, UnmarshallerContext _ctx) {
		...
		List<Thumbnail> thumbnailListList = new ArrayList<Thumbnail>();
		for (int i = 0; i < _ctx.lengthValue("GetPlayInfoResponse.VideoBase.ThumbnailList.Length"); i++) {
			...
			thumbnailListList.add(thumbnail);
		}
		videoBase.setThumbnailList(thumbnailListList);
		...
		getPlayInfoResponse.setPlayInfoList(playInfoListList);

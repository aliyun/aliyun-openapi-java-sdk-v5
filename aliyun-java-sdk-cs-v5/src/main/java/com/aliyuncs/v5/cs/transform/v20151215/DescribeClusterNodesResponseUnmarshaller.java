...
import com.aliyuncs.v5.cs.model.v20151215.DescribeClusterNodesResponse;
import com.aliyuncs.v5.cs.model.v20151215.DescribeClusterNodesResponse.Node;
import com.aliyuncs.v5.cs.model.v20151215.DescribeClusterNodesResponse.Page;
...
public class DescribeClusterNodesResponseUnmarshaller {
	...
	public static DescribeClusterNodesResponse unmarshall(DescribeClusterNodesResponse describeClusterNodesResponse, UnmarshallerContext _ctx) {
		...
		describeClusterNodesResponse.setNodes(nodesList);

...
import com.aliyuncs.v5.cs.model.v20151215.DescribeClustersV1Response;
import com.aliyuncs.v5.cs.model.v20151215.DescribeClustersV1Response.ClustersItem;
import com.aliyuncs.v5.cs.model.v20151215.DescribeClustersV1Response.ClustersItem.TagsItem;
import com.aliyuncs.v5.cs.model.v20151215.DescribeClustersV1Response.Page_info;
...
public class DescribeClustersV1ResponseUnmarshaller {
	...
	public static DescribeClustersV1Response unmarshall(DescribeClustersV1Response describeClustersV1Response, UnmarshallerContext _ctx) {
		...
		List<ClustersItem> clustersList = new ArrayList<ClustersItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeClustersV1Response.clusters.Length"); i++) {
			...
			clustersItem.setTags(tagsList);

			clustersList.add(clustersItem);
		}
		describeClustersV1Response.setClusters(clustersList);

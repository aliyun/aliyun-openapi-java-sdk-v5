...
import com.aliyuncs.v5.cs.model.v20151215.DescribeTemplatesResponse;
import com.aliyuncs.v5.cs.model.v20151215.DescribeTemplatesResponse.Page_info;
import com.aliyuncs.v5.cs.model.v20151215.DescribeTemplatesResponse.TemplatesItem;
...
public class DescribeTemplatesResponseUnmarshaller {
	...
	public static DescribeTemplatesResponse unmarshall(DescribeTemplatesResponse describeTemplatesResponse, UnmarshallerContext _ctx) {
		...
		List<TemplatesItem> templatesList = new ArrayList<TemplatesItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeTemplatesResponse.templates.Length"); i++) {
			...
			templatesList.add(templatesItem);
		}
		describeTemplatesResponse.setTemplates(templatesList);

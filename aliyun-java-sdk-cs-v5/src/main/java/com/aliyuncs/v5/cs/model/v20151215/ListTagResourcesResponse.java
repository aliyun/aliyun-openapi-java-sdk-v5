...
import com.aliyuncs.v5.cs.transform.v20151215.ListTagResourcesResponseUnmarshaller;
...
public class ListTagResourcesResponse extends AcsResponse {
	...
	public static class Tag_resources {
		...
		private Tag_resource tag_resource;

		public Tag_resource getTag_resource() {
			return this.tag_resource;
		}

		public void setTag_resource(Tag_resource tag_resource) {
			this.tag_resource = tag_resource;
		}

		public static class Tag_resource {

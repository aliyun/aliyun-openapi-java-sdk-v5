...
import com.aliyuncs.v5.cs.transform.v20151215.DescribeClusterNodePoolDetailResponseUnmarshaller;
...
public class DescribeClusterNodePoolDetailResponse extends AcsResponse {
	...
	public static class Scaling_group {
		...
		private List<Data_disk> data_disks;
		...
		public List<Data_disk> getData_disks() {
			return this.data_disks;
		}

		public void setData_disks(List<Data_disk> data_disks) {

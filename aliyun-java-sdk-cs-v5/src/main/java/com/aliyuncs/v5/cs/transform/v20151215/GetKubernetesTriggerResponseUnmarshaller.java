...
import com.aliyuncs.v5.cs.model.v20151215.GetKubernetesTriggerResponse;
import com.aliyuncs.v5.cs.model.v20151215.GetKubernetesTriggerResponse.TriggersItem;
...
public class GetKubernetesTriggerResponseUnmarshaller {
	...
	public static GetKubernetesTriggerResponse unmarshall(GetKubernetesTriggerResponse getKubernetesTriggerResponse, UnmarshallerContext _ctx) {
		...
		List<TriggersItem> triggersList = new ArrayList<TriggersItem>();
		for (int i = 0; i < _ctx.lengthValue("GetKubernetesTriggerResponse.triggers.Length"); i++) {
			...
			triggersList.add(triggersItem);
		}
		getKubernetesTriggerResponse.setTriggers(triggersList);

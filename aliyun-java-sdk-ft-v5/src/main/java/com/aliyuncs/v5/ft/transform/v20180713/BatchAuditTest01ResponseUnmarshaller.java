...
import com.aliyuncs.v5.ft.model.v20180713.BatchAuditTest01Response;
import com.aliyuncs.v5.ft.model.v20180713.BatchAuditTest01Response.Demo01;
import com.aliyuncs.v5.ft.model.v20180713.BatchAuditTest01Response.Demo01.Demo011Item;
...
public class BatchAuditTest01ResponseUnmarshaller {
	...
	public static BatchAuditTest01Response unmarshall(BatchAuditTest01Response batchAuditTest01Response, UnmarshallerContext _ctx) {
		...
		List<Demo011Item> demo011List = new ArrayList<Demo011Item>();
		for (int i = 0; i < _ctx.lengthValue("BatchAuditTest01Response.Demo01.Demo011.Length"); i++) {
			...
			demo011List.add(demo011Item);
		}
		demo01.setDemo011(demo011List);

...
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetPartitionResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetPartitionResponse.PartitionModel;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetPartitionResponse.PartitionModel.StorageDescriptorModel;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetPartitionResponse.PartitionModel.StorageDescriptorModel.FieldSchemaModel;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetPartitionResponse.PartitionModel.StorageDescriptorModel.SerDeInfoModel;
...
public class GetPartitionResponseUnmarshaller {
	...
	public static GetPartitionResponse unmarshall(GetPartitionResponse getPartitionResponse, UnmarshallerContext _ctx) {
		...
		partitionModel.setParameters(_ctx.stringValue("GetPartitionResponse.PartitionModel.Parameters"));
		...
		storageDescriptorModel.setParameters(_ctx.stringValue("GetPartitionResponse.PartitionModel.StorageDescriptorModel.Parameters"));
		...
		serDeInfoModel.setParameters(_ctx.stringValue("GetPartitionResponse.PartitionModel.StorageDescriptorModel.SerDeInfoModel.Parameters"));

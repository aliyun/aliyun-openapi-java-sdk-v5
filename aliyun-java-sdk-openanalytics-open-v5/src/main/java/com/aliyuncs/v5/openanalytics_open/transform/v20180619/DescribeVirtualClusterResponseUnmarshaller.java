...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.DescribeVirtualClusterResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.DescribeVirtualClusterResponse.DataItem;
...
public class DescribeVirtualClusterResponseUnmarshaller {
	...
	public static DescribeVirtualClusterResponse unmarshall(DescribeVirtualClusterResponse describeVirtualClusterResponse, UnmarshallerContext _ctx) {
		...
		describeVirtualClusterResponse.setData(dataList);

...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.QueryServiceAccountListResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.QueryServiceAccountListResponse.DataItem;
...
public class QueryServiceAccountListResponseUnmarshaller {
	...
	public static QueryServiceAccountListResponse unmarshall(QueryServiceAccountListResponse queryServiceAccountListResponse, UnmarshallerContext _ctx) {
		...
		queryServiceAccountListResponse.setData(dataList);

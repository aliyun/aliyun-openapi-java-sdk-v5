...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.DescribeVirtualClusterV2Response;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.DescribeVirtualClusterV2Response.DataItem;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.DescribeVirtualClusterV2Response.DataItem.SparkEngineConfig;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.DescribeVirtualClusterV2Response.DataItem.UserNetWorkConfigListItem;
...
public class DescribeVirtualClusterV2ResponseUnmarshaller {
	...
	public static DescribeVirtualClusterV2Response unmarshall(DescribeVirtualClusterV2Response describeVirtualClusterV2Response, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeVirtualClusterV2Response.Data.Length"); i++) {
			...
			List<UserNetWorkConfigListItem> userNetWorkConfigListList = new ArrayList<UserNetWorkConfigListItem>();
			for (int j = 0; j < _ctx.lengthValue("DescribeVirtualClusterV2Response.Data["+ i +"].UserNetWorkConfigList.Length"); j++) {
				...
				userNetWorkConfigListList.add(userNetWorkConfigListItem);
			}
			dataItem.setUserNetWorkConfigList(userNetWorkConfigListList);

			dataList.add(dataItem);
		}
		describeVirtualClusterV2Response.setData(dataList);

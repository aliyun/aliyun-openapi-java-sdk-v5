...
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetDatabaseResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetDatabaseResponse.DatabaseModel;
...
public class GetDatabaseResponseUnmarshaller {
	...
	public static GetDatabaseResponse unmarshall(GetDatabaseResponse getDatabaseResponse, UnmarshallerContext _ctx) {
		...
		databaseModel.setParameters(_ctx.stringValue("GetDatabaseResponse.DatabaseModel.Parameters"));

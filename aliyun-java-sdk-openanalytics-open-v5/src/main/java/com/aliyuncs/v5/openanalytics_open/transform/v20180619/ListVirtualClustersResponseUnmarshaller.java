...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListVirtualClustersResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListVirtualClustersResponse.DataItem;
...
public class ListVirtualClustersResponseUnmarshaller {
	...
	public static ListVirtualClustersResponse unmarshall(ListVirtualClustersResponse listVirtualClustersResponse, UnmarshallerContext _ctx) {
		...
		listVirtualClustersResponse.setData(dataList);

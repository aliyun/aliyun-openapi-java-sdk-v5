...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListSparkJobResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListSparkJobResponse.DataResult;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListSparkJobResponse.DataResult.Data;
...
public class ListSparkJobResponseUnmarshaller {
	...
	public static ListSparkJobResponse unmarshall(ListSparkJobResponse listSparkJobResponse, UnmarshallerContext _ctx) {
		...
		List<Data> jobListList = new ArrayList<Data>();
		for (int i = 0; i < _ctx.lengthValue("ListSparkJobResponse.DataResult.JobList.Length"); i++) {
			...
			jobListList.add(data);
		}
		dataResult.setJobList(jobListList);

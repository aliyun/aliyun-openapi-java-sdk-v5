...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListResourcesSpecResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListResourcesSpecResponse.DataItem;
...
public class ListResourcesSpecResponseUnmarshaller {
	...
	public static ListResourcesSpecResponse unmarshall(ListResourcesSpecResponse listResourcesSpecResponse, UnmarshallerContext _ctx) {
		...
		listResourcesSpecResponse.setData(dataList);

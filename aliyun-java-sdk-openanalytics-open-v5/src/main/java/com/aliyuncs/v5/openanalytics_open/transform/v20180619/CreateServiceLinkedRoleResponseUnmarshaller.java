...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.CreateServiceLinkedRoleResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.CreateServiceLinkedRoleResponse.DataItem;
...
public class CreateServiceLinkedRoleResponseUnmarshaller {
	...
	public static CreateServiceLinkedRoleResponse unmarshall(CreateServiceLinkedRoleResponse createServiceLinkedRoleResponse, UnmarshallerContext _ctx) {
		...
		createServiceLinkedRoleResponse.setData(dataList);

...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.QueryAccountListResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.QueryAccountListResponse.DataItem;
...
public class QueryAccountListResponseUnmarshaller {
	...
	public static QueryAccountListResponse unmarshall(QueryAccountListResponse queryAccountListResponse, UnmarshallerContext _ctx) {
		...
		queryAccountListResponse.setData(dataList);

...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.QueryEndPointListResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.QueryEndPointListResponse.EndPointListItem;
...
public class QueryEndPointListResponseUnmarshaller {
	...
	public static QueryEndPointListResponse unmarshall(QueryEndPointListResponse queryEndPointListResponse, UnmarshallerContext _ctx) {
		...
		List<EndPointListItem> endPointListList = new ArrayList<EndPointListItem>();
		for (int i = 0; i < _ctx.lengthValue("QueryEndPointListResponse.EndPointList.Length"); i++) {
			...
			endPointListList.add(endPointListItem);
		}
		queryEndPointListResponse.setEndPointList(endPointListList);

...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListTagResourcesResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListTagResourcesResponse.TagResourcesItem;
...
public class ListTagResourcesResponseUnmarshaller {
	...
	public static ListTagResourcesResponse unmarshall(ListTagResourcesResponse listTagResourcesResponse, UnmarshallerContext _ctx) {
		...
		List<TagResourcesItem> tagResourcesList = new ArrayList<TagResourcesItem>();
		for (int i = 0; i < _ctx.lengthValue("ListTagResourcesResponse.TagResources.Length"); i++) {
			...
			tagResourcesList.add(tagResourcesItem);
		}

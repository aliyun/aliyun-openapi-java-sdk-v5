...
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetPartitionsResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetPartitionsResponse.PartitionModel;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetPartitionsResponse.PartitionModel.StorageDescriptorModel;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetPartitionsResponse.PartitionModel.StorageDescriptorModel.FieldSchemaModel;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetPartitionsResponse.PartitionModel.StorageDescriptorModel.SerDeInfoModel;
...
public class GetPartitionsResponseUnmarshaller {
	...
	public static GetPartitionsResponse unmarshall(GetPartitionsResponse getPartitionsResponse, UnmarshallerContext _ctx) {
		...
		List<PartitionModel> partitionsList = new ArrayList<PartitionModel>();
		for (int i = 0; i < _ctx.lengthValue("GetPartitionsResponse.Partitions.Length"); i++) {
			...
			partitionModel.setParameters(_ctx.stringValue("GetPartitionsResponse.Partitions["+ i +"].Parameters"));
			...
			storageDescriptorModel.setParameters(_ctx.stringValue("GetPartitionsResponse.Partitions["+ i +"].StorageDescriptorModel.Parameters"));
			...
			serDeInfoModel.setParameters(_ctx.stringValue("GetPartitionsResponse.Partitions["+ i +"].StorageDescriptorModel.SerDeInfoModel.Parameters"));
			...
			List<FieldSchemaModel> colsList = new ArrayList<FieldSchemaModel>();
			for (int j = 0; j < _ctx.lengthValue("GetPartitionsResponse.Partitions["+ i +"].StorageDescriptorModel.Cols.Length"); j++) {
				...
				colsList.add(fieldSchemaModel);
			}
			storageDescriptorModel.setCols(colsList);
			partitionModel.setStorageDescriptorModel(storageDescriptorModel);

			partitionsList.add(partitionModel);
		}
		getPartitionsResponse.setPartitions(partitionsList);

...
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListModulesReleaseResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20180619.ListModulesReleaseResponse.DataItem;
...
public class ListModulesReleaseResponseUnmarshaller {
	...
	public static ListModulesReleaseResponse unmarshall(ListModulesReleaseResponse listModulesReleaseResponse, UnmarshallerContext _ctx) {
		...
		listModulesReleaseResponse.setData(dataList);

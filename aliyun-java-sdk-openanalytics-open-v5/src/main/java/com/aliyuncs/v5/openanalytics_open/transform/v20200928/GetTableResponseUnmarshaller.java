...
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetTableResponse;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetTableResponse.Table;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetTableResponse.Table.PartitionKeysItem;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetTableResponse.Table.StorageDescriptor;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetTableResponse.Table.StorageDescriptor.ColsItem;
import com.aliyuncs.v5.openanalytics_open.model.v20200928.GetTableResponse.Table.StorageDescriptor.SerDeInfo;
...
public class GetTableResponseUnmarshaller {
	...
	public static GetTableResponse unmarshall(GetTableResponse getTableResponse, UnmarshallerContext _ctx) {
		...
		table.setParameters(_ctx.stringValue("GetTableResponse.Table.Parameters"));
		...
		storageDescriptor.setParameters(_ctx.stringValue("GetTableResponse.Table.StorageDescriptor.Parameters"));
		...
		serDeInfo.setParameters(_ctx.stringValue("GetTableResponse.Table.StorageDescriptor.SerDeInfo.Parameters"));
		serDeInfo.setName(_ctx.stringValue("GetTableResponse.Table.StorageDescriptor.SerDeInfo.Name"));
		storageDescriptor.setSerDeInfo(serDeInfo);

		List<ColsItem> colsList = new ArrayList<ColsItem>();
		for (int i = 0; i < _ctx.lengthValue("GetTableResponse.Table.StorageDescriptor.Cols.Length"); i++) {
			...
			colsList.add(colsItem);
		}
		storageDescriptor.setCols(colsList);
		table.setStorageDescriptor(storageDescriptor);

		List<PartitionKeysItem> partitionKeysList = new ArrayList<PartitionKeysItem>();
		for (int i = 0; i < _ctx.lengthValue("GetTableResponse.Table.PartitionKeys.Length"); i++) {
			...
			partitionKeysList.add(partitionKeysItem);
		}
		table.setPartitionKeys(partitionKeysList);

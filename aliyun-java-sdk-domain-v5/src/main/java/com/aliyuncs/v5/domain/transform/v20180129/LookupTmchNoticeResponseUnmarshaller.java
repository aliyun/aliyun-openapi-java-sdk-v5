...
import com.aliyuncs.v5.domain.model.v20180129.LookupTmchNoticeResponse;
import com.aliyuncs.v5.domain.model.v20180129.LookupTmchNoticeResponse.Claim;
import com.aliyuncs.v5.domain.model.v20180129.LookupTmchNoticeResponse.Claim.ClassDesc;
import com.aliyuncs.v5.domain.model.v20180129.LookupTmchNoticeResponse.Claim.Contact;
import com.aliyuncs.v5.domain.model.v20180129.LookupTmchNoticeResponse.Claim.Contact.Addr1;
import com.aliyuncs.v5.domain.model.v20180129.LookupTmchNoticeResponse.Claim.Holder;
import com.aliyuncs.v5.domain.model.v20180129.LookupTmchNoticeResponse.Claim.Holder.Addr;
import com.aliyuncs.v5.domain.model.v20180129.LookupTmchNoticeResponse.Claim.JurDesc;
...
public class LookupTmchNoticeResponseUnmarshaller {
	...
	public static LookupTmchNoticeResponse unmarshall(LookupTmchNoticeResponse lookupTmchNoticeResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("LookupTmchNoticeResponse.Claims.Length"); i++) {
			...
			List<Holder> holdersList = new ArrayList<Holder>();
			...
			claim.setContacts(contactsList);

			List<ClassDesc> classDescsList = new ArrayList<ClassDesc>();
			for (int j = 0; j < _ctx.lengthValue("LookupTmchNoticeResponse.Claims["+ i +"].ClassDescs.Length"); j++) {
				...
				classDescsList.add(classDesc);
			}
			claim.setClassDescs(classDescsList);

			claimsList.add(claim);
		}
		lookupTmchNoticeResponse.setClaims(claimsList);

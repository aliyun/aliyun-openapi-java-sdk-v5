...
import com.aliyuncs.v5.domain.model.v20180129.ListEmailVerificationResponse;
import com.aliyuncs.v5.domain.model.v20180129.ListEmailVerificationResponse.EmailVerification;
...
public class ListEmailVerificationResponseUnmarshaller {
	...
	public static ListEmailVerificationResponse unmarshall(ListEmailVerificationResponse listEmailVerificationResponse, UnmarshallerContext _ctx) {
		...
		List<EmailVerification> dataList = new ArrayList<EmailVerification>();
		for (int i = 0; i < _ctx.lengthValue("ListEmailVerificationResponse.Data.Length"); i++) {
			...
			dataList.add(emailVerification);
		}
		listEmailVerificationResponse.setData(dataList);

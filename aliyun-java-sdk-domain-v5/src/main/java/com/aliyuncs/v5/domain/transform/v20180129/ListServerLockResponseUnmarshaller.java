...
import com.aliyuncs.v5.domain.model.v20180129.ListServerLockResponse;
import com.aliyuncs.v5.domain.model.v20180129.ListServerLockResponse.QueryTransferInResponse;
...
public class ListServerLockResponseUnmarshaller {
	...
	public static ListServerLockResponse unmarshall(ListServerLockResponse listServerLockResponse, UnmarshallerContext _ctx) {
		...
		List<QueryTransferInResponse> dataList = new ArrayList<QueryTransferInResponse>();
		for (int i = 0; i < _ctx.lengthValue("ListServerLockResponse.Data.Length"); i++) {
			...
			dataList.add(queryTransferInResponse);
		}
		listServerLockResponse.setData(dataList);

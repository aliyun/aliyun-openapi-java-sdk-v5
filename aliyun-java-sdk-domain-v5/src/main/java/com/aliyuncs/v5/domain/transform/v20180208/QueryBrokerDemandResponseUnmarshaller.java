...
import com.aliyuncs.v5.domain.model.v20180208.QueryBrokerDemandResponse;
import com.aliyuncs.v5.domain.model.v20180208.QueryBrokerDemandResponse.Demand;
...
public class QueryBrokerDemandResponseUnmarshaller {
	...
	public static QueryBrokerDemandResponse unmarshall(QueryBrokerDemandResponse queryBrokerDemandResponse, UnmarshallerContext _ctx) {
		...
		List<Demand> dataList = new ArrayList<Demand>();
		...
		queryBrokerDemandResponse.setData(dataList);

...
import com.aliyuncs.v5.domain.model.v20180129.QueryDSRecordResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryDSRecordResponse.DSRecord;
...
public class QueryDSRecordResponseUnmarshaller {
	...
	public static QueryDSRecordResponse unmarshall(QueryDSRecordResponse queryDSRecordResponse, UnmarshallerContext _ctx) {
		...
		List<DSRecord> dSRecordListList = new ArrayList<DSRecord>();
		for (int i = 0; i < _ctx.lengthValue("QueryDSRecordResponse.DSRecordList.Length"); i++) {
			...
			dSRecordListList.add(dSRecord);
		}
		queryDSRecordResponse.setDSRecordList(dSRecordListList);

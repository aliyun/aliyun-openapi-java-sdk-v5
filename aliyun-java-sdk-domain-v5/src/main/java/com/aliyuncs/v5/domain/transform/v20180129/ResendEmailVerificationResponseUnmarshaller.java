...
import com.aliyuncs.v5.domain.model.v20180129.ResendEmailVerificationResponse;
import com.aliyuncs.v5.domain.model.v20180129.ResendEmailVerificationResponse.SendResult;
...
public class ResendEmailVerificationResponseUnmarshaller {
	...
	public static ResendEmailVerificationResponse unmarshall(ResendEmailVerificationResponse resendEmailVerificationResponse, UnmarshallerContext _ctx) {
		...
		resendEmailVerificationResponse.setSuccessList(successListList);
		...
		resendEmailVerificationResponse.setFailList(failListList);

...
import com.aliyuncs.v5.domain.model.v20180208.QueryBrokerDemandRecordResponse;
import com.aliyuncs.v5.domain.model.v20180208.QueryBrokerDemandRecordResponse.BrokerDemandRecord;
...
public class QueryBrokerDemandRecordResponseUnmarshaller {
	...
	public static QueryBrokerDemandRecordResponse unmarshall(QueryBrokerDemandRecordResponse queryBrokerDemandRecordResponse, UnmarshallerContext _ctx) {
		...
		List<BrokerDemandRecord> dataList = new ArrayList<BrokerDemandRecord>();
		for (int i = 0; i < _ctx.lengthValue("QueryBrokerDemandRecordResponse.Data.Length"); i++) {
			...
			dataList.add(brokerDemandRecord);
		}
		queryBrokerDemandRecordResponse.setData(dataList);

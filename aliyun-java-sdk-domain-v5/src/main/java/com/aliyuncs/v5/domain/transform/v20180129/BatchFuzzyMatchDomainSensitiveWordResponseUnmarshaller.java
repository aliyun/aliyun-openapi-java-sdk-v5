...
import com.aliyuncs.v5.domain.model.v20180129.BatchFuzzyMatchDomainSensitiveWordResponse;
import com.aliyuncs.v5.domain.model.v20180129.BatchFuzzyMatchDomainSensitiveWordResponse.SensitiveWordMatchResult;
import com.aliyuncs.v5.domain.model.v20180129.BatchFuzzyMatchDomainSensitiveWordResponse.SensitiveWordMatchResult.MatchedSensitiveWord;
...
public class BatchFuzzyMatchDomainSensitiveWordResponseUnmarshaller {
	...
	public static BatchFuzzyMatchDomainSensitiveWordResponse unmarshall(BatchFuzzyMatchDomainSensitiveWordResponse batchFuzzyMatchDomainSensitiveWordResponse, UnmarshallerContext _ctx) {
		...
		List<SensitiveWordMatchResult> sensitiveWordMatchResultListList = new ArrayList<SensitiveWordMatchResult>();
		for (int i = 0; i < _ctx.lengthValue("BatchFuzzyMatchDomainSensitiveWordResponse.SensitiveWordMatchResultList.Length"); i++) {
			...
			sensitiveWordMatchResult.setMatchedSentiveWords(matchedSentiveWordsList);

			sensitiveWordMatchResultListList.add(sensitiveWordMatchResult);
		}
		batchFuzzyMatchDomainSensitiveWordResponse.setSensitiveWordMatchResultList(sensitiveWordMatchResultListList);

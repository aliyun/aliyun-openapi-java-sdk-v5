...
import com.aliyuncs.v5.domain.model.v20180129.QueryQualificationDetailResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryQualificationDetailResponse.QualificationCredential;
...
public class QueryQualificationDetailResponseUnmarshaller {
	...
	public static QueryQualificationDetailResponse unmarshall(QueryQualificationDetailResponse queryQualificationDetailResponse, UnmarshallerContext _ctx) {
		...
		List<QualificationCredential> credentialsList = new ArrayList<QualificationCredential>();
		for (int i = 0; i < _ctx.lengthValue("QueryQualificationDetailResponse.Credentials.Length"); i++) {
			...
			credentialsList.add(qualificationCredential);
		}
		queryQualificationDetailResponse.setCredentials(credentialsList);

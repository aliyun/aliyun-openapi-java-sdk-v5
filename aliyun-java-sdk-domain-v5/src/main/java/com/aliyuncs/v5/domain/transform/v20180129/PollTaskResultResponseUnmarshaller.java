...
import com.aliyuncs.v5.domain.model.v20180129.PollTaskResultResponse;
import com.aliyuncs.v5.domain.model.v20180129.PollTaskResultResponse.TaskDetail;
...
public class PollTaskResultResponseUnmarshaller {
	...
	public static PollTaskResultResponse unmarshall(PollTaskResultResponse pollTaskResultResponse, UnmarshallerContext _ctx) {
		...
		pollTaskResultResponse.setData(dataList);

...
import com.aliyuncs.v5.domain.model.v20180129.QueryChangeLogListResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryChangeLogListResponse.ChangeLog;
...
public class QueryChangeLogListResponseUnmarshaller {
	...
	public static QueryChangeLogListResponse unmarshall(QueryChangeLogListResponse queryChangeLogListResponse, UnmarshallerContext _ctx) {
		...
		List<ChangeLog> dataList = new ArrayList<ChangeLog>();
		for (int i = 0; i < _ctx.lengthValue("QueryChangeLogListResponse.Data.Length"); i++) {
			...
			dataList.add(changeLog);
		}
		queryChangeLogListResponse.setData(dataList);

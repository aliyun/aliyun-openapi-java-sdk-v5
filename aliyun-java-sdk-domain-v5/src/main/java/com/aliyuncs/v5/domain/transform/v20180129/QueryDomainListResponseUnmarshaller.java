...
import com.aliyuncs.v5.domain.model.v20180129.QueryDomainListResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryDomainListResponse.Domain;
...
public class QueryDomainListResponseUnmarshaller {
	...
	public static QueryDomainListResponse unmarshall(QueryDomainListResponse queryDomainListResponse, UnmarshallerContext _ctx) {
		...
		queryDomainListResponse.setData(dataList);

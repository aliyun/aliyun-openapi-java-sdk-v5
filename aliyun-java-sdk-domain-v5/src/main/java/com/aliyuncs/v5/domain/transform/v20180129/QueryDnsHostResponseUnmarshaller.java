...
import com.aliyuncs.v5.domain.model.v20180129.QueryDnsHostResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryDnsHostResponse.DnsHost;
...
public class QueryDnsHostResponseUnmarshaller {
	...
	public static QueryDnsHostResponse unmarshall(QueryDnsHostResponse queryDnsHostResponse, UnmarshallerContext _ctx) {
		...
		List<DnsHost> dnsHostListList = new ArrayList<DnsHost>();
		for (int i = 0; i < _ctx.lengthValue("QueryDnsHostResponse.DnsHostList.Length"); i++) {
			...
			dnsHostListList.add(dnsHost);
		}
		queryDnsHostResponse.setDnsHostList(dnsHostListList);

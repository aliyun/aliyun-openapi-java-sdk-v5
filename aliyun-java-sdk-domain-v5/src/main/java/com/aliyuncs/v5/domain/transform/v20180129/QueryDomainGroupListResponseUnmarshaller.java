...
import com.aliyuncs.v5.domain.model.v20180129.QueryDomainGroupListResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryDomainGroupListResponse.DomainGroup;
...
public class QueryDomainGroupListResponseUnmarshaller {
	...
	public static QueryDomainGroupListResponse unmarshall(QueryDomainGroupListResponse queryDomainGroupListResponse, UnmarshallerContext _ctx) {
		...
		List<DomainGroup> dataList = new ArrayList<DomainGroup>();
		for (int i = 0; i < _ctx.lengthValue("QueryDomainGroupListResponse.Data.Length"); i++) {
			...
			dataList.add(domainGroup);
		}
		queryDomainGroupListResponse.setData(dataList);

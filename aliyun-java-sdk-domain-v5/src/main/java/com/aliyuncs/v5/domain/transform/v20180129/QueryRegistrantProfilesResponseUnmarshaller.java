...
import com.aliyuncs.v5.domain.model.v20180129.QueryRegistrantProfilesResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryRegistrantProfilesResponse.RegistrantProfile;
...
public class QueryRegistrantProfilesResponseUnmarshaller {
	...
	public static QueryRegistrantProfilesResponse unmarshall(QueryRegistrantProfilesResponse queryRegistrantProfilesResponse, UnmarshallerContext _ctx) {
		...
		List<RegistrantProfile> registrantProfilesList = new ArrayList<RegistrantProfile>();
		for (int i = 0; i < _ctx.lengthValue("QueryRegistrantProfilesResponse.RegistrantProfiles.Length"); i++) {
			...
			registrantProfilesList.add(registrantProfile);
		}
		queryRegistrantProfilesResponse.setRegistrantProfiles(registrantProfilesList);

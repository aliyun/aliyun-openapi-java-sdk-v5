...
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskDetailHistoryResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskDetailHistoryResponse.CurrentPageCursor;
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskDetailHistoryResponse.NextPageCursor;
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskDetailHistoryResponse.PrePageCursor;
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskDetailHistoryResponse.TaskDetailHistory;
...
public class QueryTaskDetailHistoryResponseUnmarshaller {
	...
	public static QueryTaskDetailHistoryResponse unmarshall(QueryTaskDetailHistoryResponse queryTaskDetailHistoryResponse, UnmarshallerContext _ctx) {
		...
		List<TaskDetailHistory> objectsList = new ArrayList<TaskDetailHistory>();
		for (int i = 0; i < _ctx.lengthValue("QueryTaskDetailHistoryResponse.Objects.Length"); i++) {
			...
			objectsList.add(taskDetailHistory);
		}
		queryTaskDetailHistoryResponse.setObjects(objectsList);

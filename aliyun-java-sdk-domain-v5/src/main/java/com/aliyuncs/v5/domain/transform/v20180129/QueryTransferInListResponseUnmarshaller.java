...
import com.aliyuncs.v5.domain.model.v20180129.QueryTransferInListResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryTransferInListResponse.TransferInInfo;
...
public class QueryTransferInListResponseUnmarshaller {
	...
	public static QueryTransferInListResponse unmarshall(QueryTransferInListResponse queryTransferInListResponse, UnmarshallerContext _ctx) {
		...
		List<TransferInInfo> dataList = new ArrayList<TransferInInfo>();
		for (int i = 0; i < _ctx.lengthValue("QueryTransferInListResponse.Data.Length"); i++) {
			...
			dataList.add(transferInInfo);
		}
		queryTransferInListResponse.setData(dataList);

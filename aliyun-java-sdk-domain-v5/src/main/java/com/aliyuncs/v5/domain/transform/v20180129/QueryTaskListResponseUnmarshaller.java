...
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskListResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskListResponse.TaskInfo;
...
public class QueryTaskListResponseUnmarshaller {
	...
	public static QueryTaskListResponse unmarshall(QueryTaskListResponse queryTaskListResponse, UnmarshallerContext _ctx) {
		...
		queryTaskListResponse.setData(dataList);

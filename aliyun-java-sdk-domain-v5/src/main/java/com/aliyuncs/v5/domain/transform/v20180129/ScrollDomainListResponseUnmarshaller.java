...
import com.aliyuncs.v5.domain.model.v20180129.ScrollDomainListResponse;
import com.aliyuncs.v5.domain.model.v20180129.ScrollDomainListResponse.Domain;
...
public class ScrollDomainListResponseUnmarshaller {
	...
	public static ScrollDomainListResponse unmarshall(ScrollDomainListResponse scrollDomainListResponse, UnmarshallerContext _ctx) {
		...
		scrollDomainListResponse.setData(dataList);

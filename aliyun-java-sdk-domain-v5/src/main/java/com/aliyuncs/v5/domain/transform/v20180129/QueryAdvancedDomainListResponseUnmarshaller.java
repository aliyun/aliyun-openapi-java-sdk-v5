...
import com.aliyuncs.v5.domain.model.v20180129.QueryAdvancedDomainListResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryAdvancedDomainListResponse.Domain;
...
public class QueryAdvancedDomainListResponseUnmarshaller {
	...
	public static QueryAdvancedDomainListResponse unmarshall(QueryAdvancedDomainListResponse queryAdvancedDomainListResponse, UnmarshallerContext _ctx) {
		...
		List<Domain> dataList = new ArrayList<Domain>();
		...
		queryAdvancedDomainListResponse.setData(dataList);

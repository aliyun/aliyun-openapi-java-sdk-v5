...
import com.aliyuncs.v5.domain.model.v20180129.DeleteEmailVerificationResponse;
import com.aliyuncs.v5.domain.model.v20180129.DeleteEmailVerificationResponse.SendResult;
...
public class DeleteEmailVerificationResponseUnmarshaller {
	...
	public static DeleteEmailVerificationResponse unmarshall(DeleteEmailVerificationResponse deleteEmailVerificationResponse, UnmarshallerContext _ctx) {
		...
		deleteEmailVerificationResponse.setSuccessList(successListList);
		...
		deleteEmailVerificationResponse.setFailList(failListList);

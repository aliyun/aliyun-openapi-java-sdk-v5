...
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskInfoHistoryResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskInfoHistoryResponse.CurrentPageCursor;
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskInfoHistoryResponse.NextPageCursor;
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskInfoHistoryResponse.PrePageCursor;
import com.aliyuncs.v5.domain.model.v20180129.QueryTaskInfoHistoryResponse.TaskInfoHistory;
...
public class QueryTaskInfoHistoryResponseUnmarshaller {
	...
	public static QueryTaskInfoHistoryResponse unmarshall(QueryTaskInfoHistoryResponse queryTaskInfoHistoryResponse, UnmarshallerContext _ctx) {
		...
		List<TaskInfoHistory> objectsList = new ArrayList<TaskInfoHistory>();
		for (int i = 0; i < _ctx.lengthValue("QueryTaskInfoHistoryResponse.Objects.Length"); i++) {
			...
			objectsList.add(taskInfoHistory);
		}
		queryTaskInfoHistoryResponse.setObjects(objectsList);

...
import com.aliyuncs.v5.domain.model.v20180208.QueryBidRecordsResponse;
import com.aliyuncs.v5.domain.model.v20180208.QueryBidRecordsResponse.BidRecord;
...
public class QueryBidRecordsResponseUnmarshaller {
	...
	public static QueryBidRecordsResponse unmarshall(QueryBidRecordsResponse queryBidRecordsResponse, UnmarshallerContext _ctx) {
		...
		List<BidRecord> dataList = new ArrayList<BidRecord>();
		for (int i = 0; i < _ctx.lengthValue("QueryBidRecordsResponse.Data.Length"); i++) {
			...
			dataList.add(bidRecord);
		}
		queryBidRecordsResponse.setData(dataList);

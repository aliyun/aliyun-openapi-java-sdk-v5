...
import com.aliyuncs.v5.domain.model.v20180129.QueryOperationAuditInfoListResponse;
import com.aliyuncs.v5.domain.model.v20180129.QueryOperationAuditInfoListResponse.OperationAuditRecord;
...
public class QueryOperationAuditInfoListResponseUnmarshaller {
	...
	public static QueryOperationAuditInfoListResponse unmarshall(QueryOperationAuditInfoListResponse queryOperationAuditInfoListResponse, UnmarshallerContext _ctx) {
		...
		List<OperationAuditRecord> dataList = new ArrayList<OperationAuditRecord>();
		for (int i = 0; i < _ctx.lengthValue("QueryOperationAuditInfoListResponse.Data.Length"); i++) {
			...
			dataList.add(operationAuditRecord);
		}
		queryOperationAuditInfoListResponse.setData(dataList);

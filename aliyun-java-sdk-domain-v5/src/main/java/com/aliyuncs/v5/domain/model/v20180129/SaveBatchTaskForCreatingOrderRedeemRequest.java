...
public class SaveBatchTaskForCreatingOrderRedeemRequest extends RpcAcsRequest<SaveBatchTaskForCreatingOrderRedeemResponse> {
	...
	private List<OrderRedeemParam> orderRedeemParam;
	...
	public List<OrderRedeemParam> getOrderRedeemParam() {
		return this.orderRedeemParam;
	}

	public void setOrderRedeemParam(List<OrderRedeemParam> orderRedeemParam) {
		this.orderRedeemParam = orderRedeemParam;	
		if (orderRedeemParam != null) {
			for (int depth1 = 0; depth1 < orderRedeemParam.size(); depth1++) {
				putQueryParameter("OrderRedeemParam." + (depth1 + 1) + ".CurrentExpirationDate" , orderRedeemParam.get(depth1).getCurrentExpirationDate());
				putQueryParameter("OrderRedeemParam." + (depth1 + 1) + ".DomainName" , orderRedeemParam.get(depth1).getDomainName());
			}
		}	
	}

...
import com.aliyuncs.v5.domain.model.v20180208.QueryAuctionsResponse;
import com.aliyuncs.v5.domain.model.v20180208.QueryAuctionsResponse.AuctionDetail;
...
public class QueryAuctionsResponseUnmarshaller {
	...
	public static QueryAuctionsResponse unmarshall(QueryAuctionsResponse queryAuctionsResponse, UnmarshallerContext _ctx) {
		...
		List<AuctionDetail> dataList = new ArrayList<AuctionDetail>();
		for (int i = 0; i < _ctx.lengthValue("QueryAuctionsResponse.Data.Length"); i++) {
			...
			dataList.add(auctionDetail);
		}
		queryAuctionsResponse.setData(dataList);

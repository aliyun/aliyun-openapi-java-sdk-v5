...
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListConnectionsResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListConnectionsResponse.Data;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListConnectionsResponse.Data.ConnectionsItem;
...
public class ListConnectionsResponseUnmarshaller {
	...
	public static ListConnectionsResponse unmarshall(ListConnectionsResponse listConnectionsResponse, UnmarshallerContext _ctx) {
		...
		List<ConnectionsItem> connectionsList = new ArrayList<ConnectionsItem>();
		for (int i = 0; i < _ctx.lengthValue("ListConnectionsResponse.Data.Connections.Length"); i++) {
			...
			connectionsList.add(connectionsItem);
		}
		data.setConnections(connectionsList);

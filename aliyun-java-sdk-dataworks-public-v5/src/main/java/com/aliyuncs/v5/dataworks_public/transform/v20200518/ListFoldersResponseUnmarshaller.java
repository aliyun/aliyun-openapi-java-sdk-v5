...
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListFoldersResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListFoldersResponse.Data;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListFoldersResponse.Data.FoldersItem;
...
public class ListFoldersResponseUnmarshaller {
	...
	public static ListFoldersResponse unmarshall(ListFoldersResponse listFoldersResponse, UnmarshallerContext _ctx) {
		...
		List<FoldersItem> foldersList = new ArrayList<FoldersItem>();
		for (int i = 0; i < _ctx.lengthValue("ListFoldersResponse.Data.Folders.Length"); i++) {
			...
			foldersList.add(foldersItem);
		}
		data.setFolders(foldersList);

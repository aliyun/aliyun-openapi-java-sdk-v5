...
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListNodeIOResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListNodeIOResponse.DataItem;
...
public class ListNodeIOResponseUnmarshaller {
	...
	public static ListNodeIOResponse unmarshall(ListNodeIOResponse listNodeIOResponse, UnmarshallerContext _ctx) {
		...
		listNodeIOResponse.setData(dataList);

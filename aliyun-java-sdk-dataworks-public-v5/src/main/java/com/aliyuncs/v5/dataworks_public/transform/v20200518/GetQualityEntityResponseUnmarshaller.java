...
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetQualityEntityResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetQualityEntityResponse.EntityDto;
...
public class GetQualityEntityResponseUnmarshaller {
	...
	public static GetQualityEntityResponse unmarshall(GetQualityEntityResponse getQualityEntityResponse, UnmarshallerContext _ctx) {
		...
		List<EntityDto> dataList = new ArrayList<EntityDto>();
		for (int i = 0; i < _ctx.lengthValue("GetQualityEntityResponse.Data.Length"); i++) {
			...
			dataList.add(entityDto);
		}
		getQualityEntityResponse.setData(dataList);

...
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListQualityRulesResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListQualityRulesResponse.Data;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListQualityRulesResponse.Data.RulesItem;
...
public class ListQualityRulesResponseUnmarshaller {
	...
	public static ListQualityRulesResponse unmarshall(ListQualityRulesResponse listQualityRulesResponse, UnmarshallerContext _ctx) {
		...
		List<RulesItem> rulesList = new ArrayList<RulesItem>();
		for (int i = 0; i < _ctx.lengthValue("ListQualityRulesResponse.Data.Rules.Length"); i++) {
			...
			rulesList.add(rulesItem);
		}
		data.setRules(rulesList);

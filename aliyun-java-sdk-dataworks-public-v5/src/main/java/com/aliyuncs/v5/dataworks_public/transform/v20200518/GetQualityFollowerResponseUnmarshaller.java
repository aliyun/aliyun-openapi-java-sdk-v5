...
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetQualityFollowerResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetQualityFollowerResponse.Follower;
...
public class GetQualityFollowerResponseUnmarshaller {
	...
	public static GetQualityFollowerResponse unmarshall(GetQualityFollowerResponse getQualityFollowerResponse, UnmarshallerContext _ctx) {
		...
		List<Follower> dataList = new ArrayList<Follower>();
		...
		getQualityFollowerResponse.setData(dataList);

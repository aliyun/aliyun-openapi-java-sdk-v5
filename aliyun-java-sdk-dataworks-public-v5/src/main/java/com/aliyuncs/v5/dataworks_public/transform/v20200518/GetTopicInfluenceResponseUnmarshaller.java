...
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetTopicInfluenceResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetTopicInfluenceResponse.Data;
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetTopicInfluenceResponse.Data.InfluencesItem;
...
public class GetTopicInfluenceResponseUnmarshaller {
	...
	public static GetTopicInfluenceResponse unmarshall(GetTopicInfluenceResponse getTopicInfluenceResponse, UnmarshallerContext _ctx) {
		...
		List<InfluencesItem> influencesList = new ArrayList<InfluencesItem>();
		for (int i = 0; i < _ctx.lengthValue("GetTopicInfluenceResponse.Data.Influences.Length"); i++) {
			...
			influencesList.add(influencesItem);
		}
		data.setInfluences(influencesList);

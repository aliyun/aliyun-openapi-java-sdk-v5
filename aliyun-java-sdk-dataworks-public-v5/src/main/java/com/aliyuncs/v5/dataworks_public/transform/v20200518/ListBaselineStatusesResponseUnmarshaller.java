...
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListBaselineStatusesResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListBaselineStatusesResponse.Data;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListBaselineStatusesResponse.Data.BaselineStatusesItem;
...
public class ListBaselineStatusesResponseUnmarshaller {
	...
	public static ListBaselineStatusesResponse unmarshall(ListBaselineStatusesResponse listBaselineStatusesResponse, UnmarshallerContext _ctx) {
		...
		List<BaselineStatusesItem> baselineStatusesList = new ArrayList<BaselineStatusesItem>();
		for (int i = 0; i < _ctx.lengthValue("ListBaselineStatusesResponse.Data.BaselineStatuses.Length"); i++) {
			...
			baselineStatusesList.add(baselineStatusesItem);
		}
		data.setBaselineStatuses(baselineStatusesList);

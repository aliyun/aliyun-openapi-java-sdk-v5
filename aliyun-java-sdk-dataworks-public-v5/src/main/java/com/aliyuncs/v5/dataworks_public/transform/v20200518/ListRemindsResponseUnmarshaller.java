...
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListRemindsResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListRemindsResponse.Data;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListRemindsResponse.Data.RemindsItem;
...
public class ListRemindsResponseUnmarshaller {
	...
	public static ListRemindsResponse unmarshall(ListRemindsResponse listRemindsResponse, UnmarshallerContext _ctx) {
		...
		List<RemindsItem> remindsList = new ArrayList<RemindsItem>();
		for (int i = 0; i < _ctx.lengthValue("ListRemindsResponse.Data.Reminds.Length"); i++) {
			...
			remindsList.add(remindsItem);
		}
		data.setReminds(remindsList);

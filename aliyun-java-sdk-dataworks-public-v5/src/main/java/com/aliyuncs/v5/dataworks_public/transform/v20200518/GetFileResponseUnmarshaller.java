...
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetFileResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetFileResponse.Data;
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetFileResponse.Data.File;
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetFileResponse.Data.NodeConfiguration;
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetFileResponse.Data.NodeConfiguration.NodeInputOutput;
import com.aliyuncs.v5.dataworks_public.model.v20200518.GetFileResponse.Data.NodeConfiguration.NodeInputOutput1;
...
public class GetFileResponseUnmarshaller {
	...
	public static GetFileResponse unmarshall(GetFileResponse getFileResponse, UnmarshallerContext _ctx) {
		...
		List<NodeInputOutput> inputListList = new ArrayList<NodeInputOutput>();
		for (int i = 0; i < _ctx.lengthValue("GetFileResponse.Data.NodeConfiguration.InputList.Length"); i++) {
			...
			inputListList.add(nodeInputOutput);
		}
		nodeConfiguration.setInputList(inputListList);

		List<NodeInputOutput1> outputListList = new ArrayList<NodeInputOutput1>();
		for (int i = 0; i < _ctx.lengthValue("GetFileResponse.Data.NodeConfiguration.OutputList.Length"); i++) {
			...
			outputListList.add(nodeInputOutput1);
		}
		nodeConfiguration.setOutputList(outputListList);

...
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListResourceGroupsResponse;
import com.aliyuncs.v5.dataworks_public.model.v20200518.ListResourceGroupsResponse.DataItem;
...
public class ListResourceGroupsResponseUnmarshaller {
	...
	public static ListResourceGroupsResponse unmarshall(ListResourceGroupsResponse listResourceGroupsResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("ListResourceGroupsResponse.Data.Length"); i++) {
			...
			dataItem.setSpecs(_ctx.stringValue("ListResourceGroupsResponse.Data["+ i +"].Specs"));

			dataList.add(dataItem);
		}
		listResourceGroupsResponse.setData(dataList);

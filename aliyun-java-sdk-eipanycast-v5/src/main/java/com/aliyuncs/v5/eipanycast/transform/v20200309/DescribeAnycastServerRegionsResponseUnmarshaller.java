...
import com.aliyuncs.v5.eipanycast.model.v20200309.DescribeAnycastServerRegionsResponse.AnycastServerRegion;
...
public class DescribeAnycastServerRegionsResponseUnmarshaller {
	...
	public static DescribeAnycastServerRegionsResponse unmarshall(DescribeAnycastServerRegionsResponse describeAnycastServerRegionsResponse, UnmarshallerContext _ctx) {
		...
		List<AnycastServerRegion> anycastServerRegionListList = new ArrayList<AnycastServerRegion>();
		for (int i = 0; i < _ctx.lengthValue("DescribeAnycastServerRegionsResponse.AnycastServerRegionList.Length"); i++) {
			...
			anycastServerRegionListList.add(anycastServerRegion);
		}
		describeAnycastServerRegionsResponse.setAnycastServerRegionList(anycastServerRegionListList);

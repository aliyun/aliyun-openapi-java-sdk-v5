...
public class ListAnycastEipAddressesRequest extends RpcAcsRequest<ListAnycastEipAddressesResponse> {
	...
	public void setBindInstanceIds(List<String> bindInstanceIds) {
		this.bindInstanceIds = bindInstanceIds;	
		if (bindInstanceIds != null) {
			for (int i = 0; i < bindInstanceIds.size(); i++) {
				putQueryParameter("BindInstanceIds." + (i + 1) , bindInstanceIds.get(i));
			}
		}	
	}

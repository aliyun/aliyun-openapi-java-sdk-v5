...
import com.aliyuncs.v5.polardbx.model.v20200202.GetPolarxCommodityResponse;
import com.aliyuncs.v5.polardbx.model.v20200202.GetPolarxCommodityResponse.Component;
import com.aliyuncs.v5.polardbx.model.v20200202.GetPolarxCommodityResponse.DBInstance;
import com.aliyuncs.v5.polardbx.model.v20200202.GetPolarxCommodityResponse.DBInstance.ConnAddr;
import com.aliyuncs.v5.polardbx.model.v20200202.GetPolarxCommodityResponse.DBInstance.DBNode;
...
public class GetPolarxCommodityResponseUnmarshaller {
	...
	public static GetPolarxCommodityResponse unmarshall(GetPolarxCommodityResponse getPolarxCommodityResponse, UnmarshallerContext _ctx) {
		...
		List<ConnAddr> connAddrsList = new ArrayList<ConnAddr>();
		for (int i = 0; i < _ctx.lengthValue("GetPolarxCommodityResponse.DBInstance.ConnAddrs.Length"); i++) {
			...
			connAddrsList.add(connAddr);
		}
		dBInstance.setConnAddrs(connAddrsList);
		getPolarxCommodityResponse.setDBInstance(dBInstance);

		List<Component> componentListList = new ArrayList<Component>();
		...
		getPolarxCommodityResponse.setComponentList(componentListList);

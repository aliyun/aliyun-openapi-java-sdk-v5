...
import com.aliyuncs.v5.polardbx.model.v20200202.DescribeTasksResponse;
import com.aliyuncs.v5.polardbx.model.v20200202.DescribeTasksResponse.TaskProgressInfo;
...
public class DescribeTasksResponseUnmarshaller {
	...
	public static DescribeTasksResponse unmarshall(DescribeTasksResponse describeTasksResponse, UnmarshallerContext _ctx) {
		...
		List<TaskProgressInfo> itemsList = new ArrayList<TaskProgressInfo>();
		for (int i = 0; i < _ctx.lengthValue("DescribeTasksResponse.Items.Length"); i++) {
			...
			itemsList.add(taskProgressInfo);
		}
		describeTasksResponse.setItems(itemsList);

...
import com.aliyuncs.v5.polardbx.model.v20200202.DescribeParameterTemplatesResponse;
import com.aliyuncs.v5.polardbx.model.v20200202.DescribeParameterTemplatesResponse.Data;
import com.aliyuncs.v5.polardbx.model.v20200202.DescribeParameterTemplatesResponse.Data.TemplateRecord;
...
public class DescribeParameterTemplatesResponseUnmarshaller {
	...
	public static DescribeParameterTemplatesResponse unmarshall(DescribeParameterTemplatesResponse describeParameterTemplatesResponse, UnmarshallerContext _ctx) {
		...
		List<TemplateRecord> parametersList = new ArrayList<TemplateRecord>();
		for (int i = 0; i < _ctx.lengthValue("DescribeParameterTemplatesResponse.Data.Parameters.Length"); i++) {
			...
			parametersList.add(templateRecord);
		}
		data.setParameters(parametersList);

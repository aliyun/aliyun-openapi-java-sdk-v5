...
import com.aliyuncs.v5.polardbx.model.v20200202.DescribeModifyParameterLogResponse;
import com.aliyuncs.v5.polardbx.model.v20200202.DescribeModifyParameterLogResponse.ChangeLog;
...
public class DescribeModifyParameterLogResponseUnmarshaller {
	...
	public static DescribeModifyParameterLogResponse unmarshall(DescribeModifyParameterLogResponse describeModifyParameterLogResponse, UnmarshallerContext _ctx) {
		...
		List<ChangeLog> changeLogsList = new ArrayList<ChangeLog>();
		...
		describeModifyParameterLogResponse.setChangeLogs(changeLogsList);

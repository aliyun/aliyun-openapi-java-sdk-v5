...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeGlobalAccelerationInstancesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeGlobalAccelerationInstancesResponse.GlobalAccelerationInstance;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeGlobalAccelerationInstancesResponse.GlobalAccelerationInstance.BackendServer;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeGlobalAccelerationInstancesResponse.GlobalAccelerationInstance.LockReason;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeGlobalAccelerationInstancesResponse.GlobalAccelerationInstance.PublicIpAddress;
...
public class DescribeGlobalAccelerationInstancesResponseUnmarshaller {
	...
	public static DescribeGlobalAccelerationInstancesResponse unmarshall(DescribeGlobalAccelerationInstancesResponse describeGlobalAccelerationInstancesResponse, UnmarshallerContext _ctx) {
		...
		List<GlobalAccelerationInstance> globalAccelerationInstancesList = new ArrayList<GlobalAccelerationInstance>();
		for (int i = 0; i < _ctx.lengthValue("DescribeGlobalAccelerationInstancesResponse.GlobalAccelerationInstances.Length"); i++) {
			...
			globalAccelerationInstance.setOperationLocks(operationLocksList);

			List<BackendServer> backendServersList = new ArrayList<BackendServer>();
			for (int j = 0; j < _ctx.lengthValue("DescribeGlobalAccelerationInstancesResponse.GlobalAccelerationInstances["+ i +"].BackendServers.Length"); j++) {
				...
				backendServersList.add(backendServer);
			}
			globalAccelerationInstance.setBackendServers(backendServersList);

			List<PublicIpAddress> publicIpAddressesList = new ArrayList<PublicIpAddress>();
			for (int j = 0; j < _ctx.lengthValue("DescribeGlobalAccelerationInstancesResponse.GlobalAccelerationInstances["+ i +"].PublicIpAddresses.Length"); j++) {
				...
				publicIpAddressesList.add(publicIpAddress);
			}
			globalAccelerationInstance.setPublicIpAddresses(publicIpAddressesList);

			globalAccelerationInstancesList.add(globalAccelerationInstance);
		}
		describeGlobalAccelerationInstancesResponse.setGlobalAccelerationInstances(globalAccelerationInstancesList);

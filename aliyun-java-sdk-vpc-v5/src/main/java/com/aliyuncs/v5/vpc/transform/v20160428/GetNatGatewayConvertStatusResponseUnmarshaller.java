...
import com.aliyuncs.v5.vpc.model.v20160428.GetNatGatewayConvertStatusResponse;
import com.aliyuncs.v5.vpc.model.v20160428.GetNatGatewayConvertStatusResponse.ConvertStep;
...
public class GetNatGatewayConvertStatusResponseUnmarshaller {
	...
	public static GetNatGatewayConvertStatusResponse unmarshall(GetNatGatewayConvertStatusResponse getNatGatewayConvertStatusResponse, UnmarshallerContext _ctx) {
		...
		List<ConvertStep> convertStepsList = new ArrayList<ConvertStep>();
		for (int i = 0; i < _ctx.lengthValue("GetNatGatewayConvertStatusResponse.ConvertSteps.Length"); i++) {
			...
			convertStepsList.add(convertStep);
		}
		getNatGatewayConvertStatusResponse.setConvertSteps(convertStepsList);

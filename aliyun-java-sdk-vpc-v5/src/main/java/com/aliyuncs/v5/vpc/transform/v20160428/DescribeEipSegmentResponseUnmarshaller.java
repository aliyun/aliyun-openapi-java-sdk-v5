...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeEipSegmentResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeEipSegmentResponse.EipSegment;
...
public class DescribeEipSegmentResponseUnmarshaller {
	...
	public static DescribeEipSegmentResponse unmarshall(DescribeEipSegmentResponse describeEipSegmentResponse, UnmarshallerContext _ctx) {
		...
		List<EipSegment> eipSegmentsList = new ArrayList<EipSegment>();
		for (int i = 0; i < _ctx.lengthValue("DescribeEipSegmentResponse.EipSegments.Length"); i++) {
			...
			eipSegmentsList.add(eipSegment);
		}
		describeEipSegmentResponse.setEipSegments(eipSegmentsList);

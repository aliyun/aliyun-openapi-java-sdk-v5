...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeCustomerGatewaysResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeCustomerGatewaysResponse.CustomerGateway;
...
public class DescribeCustomerGatewaysResponseUnmarshaller {
	...
	public static DescribeCustomerGatewaysResponse unmarshall(DescribeCustomerGatewaysResponse describeCustomerGatewaysResponse, UnmarshallerContext _ctx) {
		...
		List<CustomerGateway> customerGatewaysList = new ArrayList<CustomerGateway>();
		for (int i = 0; i < _ctx.lengthValue("DescribeCustomerGatewaysResponse.CustomerGateways.Length"); i++) {
			...
			customerGatewaysList.add(customerGateway);
		}
		describeCustomerGatewaysResponse.setCustomerGateways(customerGatewaysList);

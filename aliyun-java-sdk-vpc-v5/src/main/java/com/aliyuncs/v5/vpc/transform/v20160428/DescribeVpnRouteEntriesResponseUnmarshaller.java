...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnRouteEntriesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnRouteEntriesResponse.VpnRouteEntry;
...
public class DescribeVpnRouteEntriesResponseUnmarshaller {
	...
	public static DescribeVpnRouteEntriesResponse unmarshall(DescribeVpnRouteEntriesResponse describeVpnRouteEntriesResponse, UnmarshallerContext _ctx) {
		...
		List<VpnRouteEntry> vpnRouteEntriesList = new ArrayList<VpnRouteEntry>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVpnRouteEntriesResponse.VpnRouteEntries.Length"); i++) {
			...
			vpnRouteEntriesList.add(vpnRouteEntry);
		}
		describeVpnRouteEntriesResponse.setVpnRouteEntries(vpnRouteEntriesList);

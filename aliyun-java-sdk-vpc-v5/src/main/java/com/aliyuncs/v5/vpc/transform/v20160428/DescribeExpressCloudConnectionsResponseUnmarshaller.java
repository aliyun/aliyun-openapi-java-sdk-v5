...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeExpressCloudConnectionsResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeExpressCloudConnectionsResponse.ExpressCloudConnectionType;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeExpressCloudConnectionsResponse.ExpressCloudConnectionType.VirtualBorderRouterModel;
...
public class DescribeExpressCloudConnectionsResponseUnmarshaller {
	...
	public static DescribeExpressCloudConnectionsResponse unmarshall(DescribeExpressCloudConnectionsResponse describeExpressCloudConnectionsResponse, UnmarshallerContext _ctx) {
		...
		List<ExpressCloudConnectionType> expressCloudConnectionSetList = new ArrayList<ExpressCloudConnectionType>();
		for (int i = 0; i < _ctx.lengthValue("DescribeExpressCloudConnectionsResponse.ExpressCloudConnectionSet.Length"); i++) {
			...
			List<VirtualBorderRouterModel> virtualBorderRouterModelsList = new ArrayList<VirtualBorderRouterModel>();
			for (int j = 0; j < _ctx.lengthValue("DescribeExpressCloudConnectionsResponse.ExpressCloudConnectionSet["+ i +"].VirtualBorderRouterModels.Length"); j++) {
				...
				virtualBorderRouterModelsList.add(virtualBorderRouterModel);
			}
			expressCloudConnectionType.setVirtualBorderRouterModels(virtualBorderRouterModelsList);

			expressCloudConnectionSetList.add(expressCloudConnectionType);
		}
		describeExpressCloudConnectionsResponse.setExpressCloudConnectionSet(expressCloudConnectionSetList);

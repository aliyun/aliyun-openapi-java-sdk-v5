...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeRouteTableListResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeRouteTableListResponse.RouterTableListType;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeRouteTableListResponse.RouterTableListType.Tag;
...
public class DescribeRouteTableListResponseUnmarshaller {
	...
	public static DescribeRouteTableListResponse unmarshall(DescribeRouteTableListResponse describeRouteTableListResponse, UnmarshallerContext _ctx) {
		...
		List<RouterTableListType> routerTableListList = new ArrayList<RouterTableListType>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRouteTableListResponse.RouterTableList.Length"); i++) {
			...
			routerTableListType.setTags(tagsList);

			routerTableListList.add(routerTableListType);
		}
		describeRouteTableListResponse.setRouterTableList(routerTableListList);

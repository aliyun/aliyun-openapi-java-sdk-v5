...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeIPv6TranslatorAclListsResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeIPv6TranslatorAclListsResponse.IPv6TranslatorAcl;
...
public class DescribeIPv6TranslatorAclListsResponseUnmarshaller {
	...
	public static DescribeIPv6TranslatorAclListsResponse unmarshall(DescribeIPv6TranslatorAclListsResponse describeIPv6TranslatorAclListsResponse, UnmarshallerContext _ctx) {
		...
		List<IPv6TranslatorAcl> ipv6TranslatorAclsList = new ArrayList<IPv6TranslatorAcl>();
		for (int i = 0; i < _ctx.lengthValue("DescribeIPv6TranslatorAclListsResponse.Ipv6TranslatorAcls.Length"); i++) {
			...
			ipv6TranslatorAclsList.add(iPv6TranslatorAcl);
		}
		describeIPv6TranslatorAclListsResponse.setIpv6TranslatorAcls(ipv6TranslatorAclsList);

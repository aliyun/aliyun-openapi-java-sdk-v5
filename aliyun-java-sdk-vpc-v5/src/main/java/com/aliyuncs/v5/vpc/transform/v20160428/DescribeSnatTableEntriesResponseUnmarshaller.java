...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeSnatTableEntriesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeSnatTableEntriesResponse.SnatTableEntry;
...
public class DescribeSnatTableEntriesResponseUnmarshaller {
	...
	public static DescribeSnatTableEntriesResponse unmarshall(DescribeSnatTableEntriesResponse describeSnatTableEntriesResponse, UnmarshallerContext _ctx) {
		...
		List<SnatTableEntry> snatTableEntriesList = new ArrayList<SnatTableEntry>();
		for (int i = 0; i < _ctx.lengthValue("DescribeSnatTableEntriesResponse.SnatTableEntries.Length"); i++) {
			...
			snatTableEntriesList.add(snatTableEntry);
		}
		describeSnatTableEntriesResponse.setSnatTableEntries(snatTableEntriesList);

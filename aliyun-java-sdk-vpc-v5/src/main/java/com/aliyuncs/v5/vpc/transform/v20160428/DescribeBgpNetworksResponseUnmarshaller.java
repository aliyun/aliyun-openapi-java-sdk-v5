...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeBgpNetworksResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeBgpNetworksResponse.BgpNetwork;
...
public class DescribeBgpNetworksResponseUnmarshaller {
	...
	public static DescribeBgpNetworksResponse unmarshall(DescribeBgpNetworksResponse describeBgpNetworksResponse, UnmarshallerContext _ctx) {
		...
		List<BgpNetwork> bgpNetworksList = new ArrayList<BgpNetwork>();
		for (int i = 0; i < _ctx.lengthValue("DescribeBgpNetworksResponse.BgpNetworks.Length"); i++) {
			...
			bgpNetworksList.add(bgpNetwork);
		}
		describeBgpNetworksResponse.setBgpNetworks(bgpNetworksList);

...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnConnectionsResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnConnectionsResponse.VpnConnection;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnConnectionsResponse.VpnConnection.IkeConfig;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnConnectionsResponse.VpnConnection.IpsecConfig;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnConnectionsResponse.VpnConnection.VcoHealthCheck;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnConnectionsResponse.VpnConnection.VpnBgpConfig;
...
public class DescribeVpnConnectionsResponseUnmarshaller {
	...
	public static DescribeVpnConnectionsResponse unmarshall(DescribeVpnConnectionsResponse describeVpnConnectionsResponse, UnmarshallerContext _ctx) {
		...
		List<VpnConnection> vpnConnectionsList = new ArrayList<VpnConnection>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVpnConnectionsResponse.VpnConnections.Length"); i++) {
			...
			vpnConnectionsList.add(vpnConnection);
		}
		describeVpnConnectionsResponse.setVpnConnections(vpnConnectionsList);

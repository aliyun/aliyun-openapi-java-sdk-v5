...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVSwitchesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVSwitchesResponse.VSwitch;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVSwitchesResponse.VSwitch.RouteTable;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVSwitchesResponse.VSwitch.Tag;
...
public class DescribeVSwitchesResponseUnmarshaller {
	...
	public static DescribeVSwitchesResponse unmarshall(DescribeVSwitchesResponse describeVSwitchesResponse, UnmarshallerContext _ctx) {
		...
		List<VSwitch> vSwitchesList = new ArrayList<VSwitch>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVSwitchesResponse.VSwitches.Length"); i++) {
			...
			vSwitch.setTags(tagsList);

			vSwitchesList.add(vSwitch);
		}
		describeVSwitchesResponse.setVSwitches(vSwitchesList);

...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeSslVpnClientCertsResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeSslVpnClientCertsResponse.SslVpnClientCertKey;
...
public class DescribeSslVpnClientCertsResponseUnmarshaller {
	...
	public static DescribeSslVpnClientCertsResponse unmarshall(DescribeSslVpnClientCertsResponse describeSslVpnClientCertsResponse, UnmarshallerContext _ctx) {
		...
		List<SslVpnClientCertKey> sslVpnClientCertKeysList = new ArrayList<SslVpnClientCertKey>();
		for (int i = 0; i < _ctx.lengthValue("DescribeSslVpnClientCertsResponse.SslVpnClientCertKeys.Length"); i++) {
			...
			sslVpnClientCertKeysList.add(sslVpnClientCertKey);
		}
		describeSslVpnClientCertsResponse.setSslVpnClientCertKeys(sslVpnClientCertKeysList);

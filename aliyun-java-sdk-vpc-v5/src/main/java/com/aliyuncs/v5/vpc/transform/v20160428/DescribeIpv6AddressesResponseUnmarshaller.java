...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeIpv6AddressesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeIpv6AddressesResponse.Ipv6Address;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeIpv6AddressesResponse.Ipv6Address.Ipv6InternetBandwidth;
...
public class DescribeIpv6AddressesResponseUnmarshaller {
	...
	public static DescribeIpv6AddressesResponse unmarshall(DescribeIpv6AddressesResponse describeIpv6AddressesResponse, UnmarshallerContext _ctx) {
		...
		List<Ipv6Address> ipv6AddressesList = new ArrayList<Ipv6Address>();
		for (int i = 0; i < _ctx.lengthValue("DescribeIpv6AddressesResponse.Ipv6Addresses.Length"); i++) {
			...
			ipv6AddressesList.add(ipv6Address);
		}
		describeIpv6AddressesResponse.setIpv6Addresses(ipv6AddressesList);

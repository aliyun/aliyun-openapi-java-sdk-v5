...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeBgpPeersResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeBgpPeersResponse.BgpPeer;
...
public class DescribeBgpPeersResponseUnmarshaller {
	...
	public static DescribeBgpPeersResponse unmarshall(DescribeBgpPeersResponse describeBgpPeersResponse, UnmarshallerContext _ctx) {
		...
		List<BgpPeer> bgpPeersList = new ArrayList<BgpPeer>();
		for (int i = 0; i < _ctx.lengthValue("DescribeBgpPeersResponse.BgpPeers.Length"); i++) {
			...
			bgpPeersList.add(bgpPeer);
		}
		describeBgpPeersResponse.setBgpPeers(bgpPeersList);

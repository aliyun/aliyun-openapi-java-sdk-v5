...
import com.aliyuncs.v5.vpc.model.v20160428.DescribePhysicalConnectionLOAResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribePhysicalConnectionLOAResponse.PhysicalConnectionLOAType;
import com.aliyuncs.v5.vpc.model.v20160428.DescribePhysicalConnectionLOAResponse.PhysicalConnectionLOAType.PMInfoItem;
...
public class DescribePhysicalConnectionLOAResponseUnmarshaller {
	...
	public static DescribePhysicalConnectionLOAResponse unmarshall(DescribePhysicalConnectionLOAResponse describePhysicalConnectionLOAResponse, UnmarshallerContext _ctx) {
		...
		List<PMInfoItem> pMInfoList = new ArrayList<PMInfoItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribePhysicalConnectionLOAResponse.PhysicalConnectionLOAType.PMInfo.Length"); i++) {
			...
			pMInfoList.add(pMInfoItem);
		}
		physicalConnectionLOAType.setPMInfo(pMInfoList);

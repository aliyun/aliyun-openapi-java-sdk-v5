...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeNetworkAclsResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeNetworkAclsResponse.NetworkAcl;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeNetworkAclsResponse.NetworkAcl.EgressAclEntry;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeNetworkAclsResponse.NetworkAcl.IngressAclEntry;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeNetworkAclsResponse.NetworkAcl.Resource;
...
public class DescribeNetworkAclsResponseUnmarshaller {
	...
	public static DescribeNetworkAclsResponse unmarshall(DescribeNetworkAclsResponse describeNetworkAclsResponse, UnmarshallerContext _ctx) {
		...
		List<NetworkAcl> networkAclsList = new ArrayList<NetworkAcl>();
		for (int i = 0; i < _ctx.lengthValue("DescribeNetworkAclsResponse.NetworkAcls.Length"); i++) {
			...
			networkAcl.setIngressAclEntries(ingressAclEntriesList);
			...
			networkAcl.setEgressAclEntries(egressAclEntriesList);
			...
			networkAcl.setResources(resourcesList);

			networkAclsList.add(networkAcl);
		}
		describeNetworkAclsResponse.setNetworkAcls(networkAclsList);

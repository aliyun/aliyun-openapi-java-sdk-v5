...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpcAttributeResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpcAttributeResponse.AssociatedCen;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpcAttributeResponse.CloudResourceSetType;
...
public class DescribeVpcAttributeResponseUnmarshaller {
	...
	public static DescribeVpcAttributeResponse unmarshall(DescribeVpcAttributeResponse describeVpcAttributeResponse, UnmarshallerContext _ctx) {
		...
		describeVpcAttributeResponse.setAssociatedCens(associatedCensList);

		List<CloudResourceSetType> cloudResourcesList = new ArrayList<CloudResourceSetType>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVpcAttributeResponse.CloudResources.Length"); i++) {
			...
			cloudResourcesList.add(cloudResourceSetType);
		}
		describeVpcAttributeResponse.setCloudResources(cloudResourcesList);

...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeForwardTableEntriesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeForwardTableEntriesResponse.ForwardTableEntry;
...
public class DescribeForwardTableEntriesResponseUnmarshaller {
	...
	public static DescribeForwardTableEntriesResponse unmarshall(DescribeForwardTableEntriesResponse describeForwardTableEntriesResponse, UnmarshallerContext _ctx) {
		...
		List<ForwardTableEntry> forwardTableEntriesList = new ArrayList<ForwardTableEntry>();
		for (int i = 0; i < _ctx.lengthValue("DescribeForwardTableEntriesResponse.ForwardTableEntries.Length"); i++) {
			...
			forwardTableEntriesList.add(forwardTableEntry);
		}
		describeForwardTableEntriesResponse.setForwardTableEntries(forwardTableEntriesList);

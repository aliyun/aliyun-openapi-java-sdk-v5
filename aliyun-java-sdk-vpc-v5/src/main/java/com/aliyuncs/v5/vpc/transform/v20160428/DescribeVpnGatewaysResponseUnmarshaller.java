...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnGatewaysResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnGatewaysResponse.VpnGateway;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnGatewaysResponse.VpnGateway.ReservationData;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpnGatewaysResponse.VpnGateway.Tag;
...
public class DescribeVpnGatewaysResponseUnmarshaller {
	...
	public static DescribeVpnGatewaysResponse unmarshall(DescribeVpnGatewaysResponse describeVpnGatewaysResponse, UnmarshallerContext _ctx) {
		...
		List<VpnGateway> vpnGatewaysList = new ArrayList<VpnGateway>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVpnGatewaysResponse.VpnGateways.Length"); i++) {
			...
			vpnGateway.setTags(tagsList);

			vpnGatewaysList.add(vpnGateway);
		}
		describeVpnGatewaysResponse.setVpnGateways(vpnGatewaysList);

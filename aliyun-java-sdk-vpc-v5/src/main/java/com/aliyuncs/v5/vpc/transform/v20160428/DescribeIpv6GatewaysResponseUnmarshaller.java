...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeIpv6GatewaysResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeIpv6GatewaysResponse.Ipv6Gateway;
...
public class DescribeIpv6GatewaysResponseUnmarshaller {
	...
	public static DescribeIpv6GatewaysResponse unmarshall(DescribeIpv6GatewaysResponse describeIpv6GatewaysResponse, UnmarshallerContext _ctx) {
		...
		List<Ipv6Gateway> ipv6GatewaysList = new ArrayList<Ipv6Gateway>();
		for (int i = 0; i < _ctx.lengthValue("DescribeIpv6GatewaysResponse.Ipv6Gateways.Length"); i++) {
			...
			ipv6GatewaysList.add(ipv6Gateway);
		}
		describeIpv6GatewaysResponse.setIpv6Gateways(ipv6GatewaysList);

...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpcsResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpcsResponse.Vpc;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVpcsResponse.Vpc.Tag;
...
public class DescribeVpcsResponseUnmarshaller {
	...
	public static DescribeVpcsResponse unmarshall(DescribeVpcsResponse describeVpcsResponse, UnmarshallerContext _ctx) {
		...
		List<Vpc> vpcsList = new ArrayList<Vpc>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVpcsResponse.Vpcs.Length"); i++) {
			...
			vpc.setTags(tagsList);

			vpcsList.add(vpc);
		}
		describeVpcsResponse.setVpcs(vpcsList);

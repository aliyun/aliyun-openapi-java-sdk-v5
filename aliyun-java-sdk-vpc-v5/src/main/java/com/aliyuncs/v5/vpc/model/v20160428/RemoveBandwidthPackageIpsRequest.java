...
public class RemoveBandwidthPackageIpsRequest extends RpcAcsRequest<RemoveBandwidthPackageIpsResponse> {
	...
	private List<String> removedIpAddresses;
	...
	public List<String> getRemovedIpAddresses() {
		return this.removedIpAddresses;
	}

	public void setRemovedIpAddresses(List<String> removedIpAddresses) {
		this.removedIpAddresses = removedIpAddresses;	
		if (removedIpAddresses != null) {

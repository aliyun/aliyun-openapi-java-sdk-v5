...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeNatGatewaysResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeNatGatewaysResponse.NatGateway;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeNatGatewaysResponse.NatGateway.IpList;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeNatGatewaysResponse.NatGateway.NatGatewayPrivateInfo;
...
public class DescribeNatGatewaysResponseUnmarshaller {
	...
	public static DescribeNatGatewaysResponse unmarshall(DescribeNatGatewaysResponse describeNatGatewaysResponse, UnmarshallerContext _ctx) {
		...
		List<NatGateway> natGatewaysList = new ArrayList<NatGateway>();
		for (int i = 0; i < _ctx.lengthValue("DescribeNatGatewaysResponse.NatGateways.Length"); i++) {
			...
			List<IpList> ipListsList = new ArrayList<IpList>();
			for (int j = 0; j < _ctx.lengthValue("DescribeNatGatewaysResponse.NatGateways["+ i +"].IpLists.Length"); j++) {
				...
				ipListsList.add(ipList);
			}
			natGateway.setIpLists(ipListsList);

			natGatewaysList.add(natGateway);
		}
		describeNatGatewaysResponse.setNatGateways(natGatewaysList);

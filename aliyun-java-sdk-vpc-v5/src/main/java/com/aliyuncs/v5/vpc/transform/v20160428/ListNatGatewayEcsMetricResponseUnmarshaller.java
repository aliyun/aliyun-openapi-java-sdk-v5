...
import com.aliyuncs.v5.vpc.model.v20160428.ListNatGatewayEcsMetricResponse;
import com.aliyuncs.v5.vpc.model.v20160428.ListNatGatewayEcsMetricResponse.MetricData;
...
public class ListNatGatewayEcsMetricResponseUnmarshaller {
	...
	public static ListNatGatewayEcsMetricResponse unmarshall(ListNatGatewayEcsMetricResponse listNatGatewayEcsMetricResponse, UnmarshallerContext _ctx) {
		...
		List<MetricData> metricDataListList = new ArrayList<MetricData>();
		for (int i = 0; i < _ctx.lengthValue("ListNatGatewayEcsMetricResponse.MetricDataList.Length"); i++) {
			...
			metricDataListList.add(metricData);
		}
		listNatGatewayEcsMetricResponse.setMetricDataList(metricDataListList);

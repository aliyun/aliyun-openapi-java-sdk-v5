...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVirtualBorderRoutersResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVirtualBorderRoutersResponse.VirtualBorderRouterType;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVirtualBorderRoutersResponse.VirtualBorderRouterType.AssociatedCen;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVirtualBorderRoutersResponse.VirtualBorderRouterType.AssociatedPhysicalConnection;
...
public class DescribeVirtualBorderRoutersResponseUnmarshaller {
	...
	public static DescribeVirtualBorderRoutersResponse unmarshall(DescribeVirtualBorderRoutersResponse describeVirtualBorderRoutersResponse, UnmarshallerContext _ctx) {
		...
		List<VirtualBorderRouterType> virtualBorderRouterSetList = new ArrayList<VirtualBorderRouterType>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVirtualBorderRoutersResponse.VirtualBorderRouterSet.Length"); i++) {
			...
			List<AssociatedPhysicalConnection> associatedPhysicalConnectionsList = new ArrayList<AssociatedPhysicalConnection>();
			for (int j = 0; j < _ctx.lengthValue("DescribeVirtualBorderRoutersResponse.VirtualBorderRouterSet["+ i +"].AssociatedPhysicalConnections.Length"); j++) {
				...
				associatedPhysicalConnectionsList.add(associatedPhysicalConnection);
			}
			virtualBorderRouterType.setAssociatedPhysicalConnections(associatedPhysicalConnectionsList);

			List<AssociatedCen> associatedCensList = new ArrayList<AssociatedCen>();
			for (int j = 0; j < _ctx.lengthValue("DescribeVirtualBorderRoutersResponse.VirtualBorderRouterSet["+ i +"].AssociatedCens.Length"); j++) {
				...
				associatedCensList.add(associatedCen);
			}
			virtualBorderRouterType.setAssociatedCens(associatedCensList);

			virtualBorderRouterSetList.add(virtualBorderRouterType);
		}
		describeVirtualBorderRoutersResponse.setVirtualBorderRouterSet(virtualBorderRouterSetList);

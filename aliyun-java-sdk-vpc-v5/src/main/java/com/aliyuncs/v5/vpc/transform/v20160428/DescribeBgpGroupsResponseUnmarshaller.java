...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeBgpGroupsResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeBgpGroupsResponse.BgpGroup;
...
public class DescribeBgpGroupsResponseUnmarshaller {
	...
	public static DescribeBgpGroupsResponse unmarshall(DescribeBgpGroupsResponse describeBgpGroupsResponse, UnmarshallerContext _ctx) {
		...
		List<BgpGroup> bgpGroupsList = new ArrayList<BgpGroup>();
		for (int i = 0; i < _ctx.lengthValue("DescribeBgpGroupsResponse.BgpGroups.Length"); i++) {
			...
			bgpGroupsList.add(bgpGroup);
		}
		describeBgpGroupsResponse.setBgpGroups(bgpGroupsList);

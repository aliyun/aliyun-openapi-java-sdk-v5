...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeCommonBandwidthPackagesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeCommonBandwidthPackagesResponse.CommonBandwidthPackage;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeCommonBandwidthPackagesResponse.CommonBandwidthPackage.PublicIpAddresse;
...
public class DescribeCommonBandwidthPackagesResponseUnmarshaller {
	...
	public static DescribeCommonBandwidthPackagesResponse unmarshall(DescribeCommonBandwidthPackagesResponse describeCommonBandwidthPackagesResponse, UnmarshallerContext _ctx) {
		...
		List<CommonBandwidthPackage> commonBandwidthPackagesList = new ArrayList<CommonBandwidthPackage>();
		for (int i = 0; i < _ctx.lengthValue("DescribeCommonBandwidthPackagesResponse.CommonBandwidthPackages.Length"); i++) {
			...
			commonBandwidthPackage.setPublicIpAddresses(publicIpAddressesList);

			commonBandwidthPackagesList.add(commonBandwidthPackage);
		}
		describeCommonBandwidthPackagesResponse.setCommonBandwidthPackages(commonBandwidthPackagesList);

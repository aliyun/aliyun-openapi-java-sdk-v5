...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeGrantRulesToCenResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeGrantRulesToCenResponse.CbnGrantRule;
...
public class DescribeGrantRulesToCenResponseUnmarshaller {
	...
	public static DescribeGrantRulesToCenResponse unmarshall(DescribeGrantRulesToCenResponse describeGrantRulesToCenResponse, UnmarshallerContext _ctx) {
		...
		List<CbnGrantRule> cenGrantRulesList = new ArrayList<CbnGrantRule>();
		for (int i = 0; i < _ctx.lengthValue("DescribeGrantRulesToCenResponse.CenGrantRules.Length"); i++) {
			...
			cenGrantRulesList.add(cbnGrantRule);
		}
		describeGrantRulesToCenResponse.setCenGrantRules(cenGrantRulesList);

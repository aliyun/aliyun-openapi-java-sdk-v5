...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeRouterInterfacesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeRouterInterfacesResponse.RouterInterfaceType;
...
public class DescribeRouterInterfacesResponseUnmarshaller {
	...
	public static DescribeRouterInterfacesResponse unmarshall(DescribeRouterInterfacesResponse describeRouterInterfacesResponse, UnmarshallerContext _ctx) {
		...
		List<RouterInterfaceType> routerInterfaceSetList = new ArrayList<RouterInterfaceType>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRouterInterfacesResponse.RouterInterfaceSet.Length"); i++) {
			...
			routerInterfaceSetList.add(routerInterfaceType);
		}
		describeRouterInterfacesResponse.setRouterInterfaceSet(routerInterfaceSetList);

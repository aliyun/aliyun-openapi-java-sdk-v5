...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeEipAddressesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeEipAddressesResponse.EipAddress;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeEipAddressesResponse.EipAddress.LockReason;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeEipAddressesResponse.EipAddress.Tag;
...
public class DescribeEipAddressesResponseUnmarshaller {
	...
	public static DescribeEipAddressesResponse unmarshall(DescribeEipAddressesResponse describeEipAddressesResponse, UnmarshallerContext _ctx) {
		...
		List<EipAddress> eipAddressesList = new ArrayList<EipAddress>();
		for (int i = 0; i < _ctx.lengthValue("DescribeEipAddressesResponse.EipAddresses.Length"); i++) {
			...
			eipAddress.setOperationLocks(operationLocksList);
			...
			eipAddress.setTags(tagsList);

			eipAddressesList.add(eipAddress);
		}
		describeEipAddressesResponse.setEipAddresses(eipAddressesList);

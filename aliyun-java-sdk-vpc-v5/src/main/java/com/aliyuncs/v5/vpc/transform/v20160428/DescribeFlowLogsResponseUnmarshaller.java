...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeFlowLogsResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeFlowLogsResponse.FlowLog;
...
public class DescribeFlowLogsResponseUnmarshaller {
	...
	public static DescribeFlowLogsResponse unmarshall(DescribeFlowLogsResponse describeFlowLogsResponse, UnmarshallerContext _ctx) {
		...
		List<FlowLog> flowLogsList = new ArrayList<FlowLog>();
		for (int i = 0; i < _ctx.lengthValue("DescribeFlowLogsResponse.FlowLogs.Length"); i++) {
			...
			flowLogsList.add(flowLog);
		}
		describeFlowLogsResponse.setFlowLogs(flowLogsList);

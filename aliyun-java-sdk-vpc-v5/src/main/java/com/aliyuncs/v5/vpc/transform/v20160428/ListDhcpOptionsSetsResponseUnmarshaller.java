...
import com.aliyuncs.v5.vpc.model.v20160428.ListDhcpOptionsSetsResponse;
import com.aliyuncs.v5.vpc.model.v20160428.ListDhcpOptionsSetsResponse.DhcpOptionsSet;
import com.aliyuncs.v5.vpc.model.v20160428.ListDhcpOptionsSetsResponse.DhcpOptionsSet.DhcpOptions;
...
public class ListDhcpOptionsSetsResponseUnmarshaller {
	...
	public static ListDhcpOptionsSetsResponse unmarshall(ListDhcpOptionsSetsResponse listDhcpOptionsSetsResponse, UnmarshallerContext _ctx) {
		...
		List<DhcpOptionsSet> dhcpOptionsSetsList = new ArrayList<DhcpOptionsSet>();
		for (int i = 0; i < _ctx.lengthValue("ListDhcpOptionsSetsResponse.DhcpOptionsSets.Length"); i++) {
			...
			dhcpOptionsSetsList.add(dhcpOptionsSet);
		}
		listDhcpOptionsSetsResponse.setDhcpOptionsSets(dhcpOptionsSetsList);

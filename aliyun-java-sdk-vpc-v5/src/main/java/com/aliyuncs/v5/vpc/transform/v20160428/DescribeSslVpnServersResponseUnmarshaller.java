...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeSslVpnServersResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeSslVpnServersResponse.SslVpnServer;
...
public class DescribeSslVpnServersResponseUnmarshaller {
	...
	public static DescribeSslVpnServersResponse unmarshall(DescribeSslVpnServersResponse describeSslVpnServersResponse, UnmarshallerContext _ctx) {
		...
		List<SslVpnServer> sslVpnServersList = new ArrayList<SslVpnServer>();
		for (int i = 0; i < _ctx.lengthValue("DescribeSslVpnServersResponse.SslVpnServers.Length"); i++) {
			...
			sslVpnServersList.add(sslVpnServer);
		}
		describeSslVpnServersResponse.setSslVpnServers(sslVpnServersList);

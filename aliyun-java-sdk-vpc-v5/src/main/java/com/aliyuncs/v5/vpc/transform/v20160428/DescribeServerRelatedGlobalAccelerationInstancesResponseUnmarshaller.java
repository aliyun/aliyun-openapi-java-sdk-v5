...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeServerRelatedGlobalAccelerationInstancesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeServerRelatedGlobalAccelerationInstancesResponse.GlobalAccelerationInstance;
...
public class DescribeServerRelatedGlobalAccelerationInstancesResponseUnmarshaller {
	...
	public static DescribeServerRelatedGlobalAccelerationInstancesResponse unmarshall(DescribeServerRelatedGlobalAccelerationInstancesResponse describeServerRelatedGlobalAccelerationInstancesResponse, UnmarshallerContext _ctx) {
		...
		describeServerRelatedGlobalAccelerationInstancesResponse.setGlobalAccelerationInstances(globalAccelerationInstancesList);

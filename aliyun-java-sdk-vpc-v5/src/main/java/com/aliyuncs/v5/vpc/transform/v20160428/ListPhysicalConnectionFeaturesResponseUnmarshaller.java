...
import com.aliyuncs.v5.vpc.model.v20160428.ListPhysicalConnectionFeaturesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.ListPhysicalConnectionFeaturesResponse.PhysicalConnectionFeature;
...
public class ListPhysicalConnectionFeaturesResponseUnmarshaller {
	...
	public static ListPhysicalConnectionFeaturesResponse unmarshall(ListPhysicalConnectionFeaturesResponse listPhysicalConnectionFeaturesResponse, UnmarshallerContext _ctx) {
		...
		List<PhysicalConnectionFeature> physicalConnectionFeaturesList = new ArrayList<PhysicalConnectionFeature>();
		for (int i = 0; i < _ctx.lengthValue("ListPhysicalConnectionFeaturesResponse.PhysicalConnectionFeatures.Length"); i++) {
			...
			physicalConnectionFeaturesList.add(physicalConnectionFeature);
		}
		listPhysicalConnectionFeaturesResponse.setPhysicalConnectionFeatures(physicalConnectionFeaturesList);

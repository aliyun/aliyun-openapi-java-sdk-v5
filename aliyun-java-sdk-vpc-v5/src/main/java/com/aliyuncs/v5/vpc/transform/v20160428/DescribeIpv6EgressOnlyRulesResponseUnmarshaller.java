...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeIpv6EgressOnlyRulesResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeIpv6EgressOnlyRulesResponse.Ipv6EgressOnlyRule;
...
public class DescribeIpv6EgressOnlyRulesResponseUnmarshaller {
	...
	public static DescribeIpv6EgressOnlyRulesResponse unmarshall(DescribeIpv6EgressOnlyRulesResponse describeIpv6EgressOnlyRulesResponse, UnmarshallerContext _ctx) {
		...
		List<Ipv6EgressOnlyRule> ipv6EgressOnlyRulesList = new ArrayList<Ipv6EgressOnlyRule>();
		for (int i = 0; i < _ctx.lengthValue("DescribeIpv6EgressOnlyRulesResponse.Ipv6EgressOnlyRules.Length"); i++) {
			...
			ipv6EgressOnlyRulesList.add(ipv6EgressOnlyRule);
		}
		describeIpv6EgressOnlyRulesResponse.setIpv6EgressOnlyRules(ipv6EgressOnlyRulesList);

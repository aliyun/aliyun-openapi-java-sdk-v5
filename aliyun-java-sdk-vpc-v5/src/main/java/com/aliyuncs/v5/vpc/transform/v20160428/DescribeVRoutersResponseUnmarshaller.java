...
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVRoutersResponse;
import com.aliyuncs.v5.vpc.model.v20160428.DescribeVRoutersResponse.VRouter;
...
public class DescribeVRoutersResponseUnmarshaller {
	...
	public static DescribeVRoutersResponse unmarshall(DescribeVRoutersResponse describeVRoutersResponse, UnmarshallerContext _ctx) {
		...
		List<VRouter> vRoutersList = new ArrayList<VRouter>();
		for (int i = 0; i < _ctx.lengthValue("DescribeVRoutersResponse.VRouters.Length"); i++) {
			...
			vRoutersList.add(vRouter);
		}
		describeVRoutersResponse.setVRouters(vRoutersList);

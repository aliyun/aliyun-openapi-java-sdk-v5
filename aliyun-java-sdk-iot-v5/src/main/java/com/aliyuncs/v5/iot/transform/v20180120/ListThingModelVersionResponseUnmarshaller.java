...
import com.aliyuncs.v5.iot.model.v20180120.ListThingModelVersionResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListThingModelVersionResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.ListThingModelVersionResponse.Data.ModelVersion;
...
public class ListThingModelVersionResponseUnmarshaller {
	...
	public static ListThingModelVersionResponse unmarshall(ListThingModelVersionResponse listThingModelVersionResponse, UnmarshallerContext _ctx) {
		...
		List<ModelVersion> modelVersionsList = new ArrayList<ModelVersion>();
		for (int i = 0; i < _ctx.lengthValue("ListThingModelVersionResponse.Data.ModelVersions.Length"); i++) {
			...
			modelVersionsList.add(modelVersion);
		}
		data.setModelVersions(modelVersionsList);

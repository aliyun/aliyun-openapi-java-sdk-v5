...
import com.aliyuncs.v5.iot.model.v20180120.QueryJobResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryJobResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryJobResponse.Data.JobFile;
import com.aliyuncs.v5.iot.model.v20180120.QueryJobResponse.Data.RolloutConfig;
import com.aliyuncs.v5.iot.model.v20180120.QueryJobResponse.Data.TargetConfig;
import com.aliyuncs.v5.iot.model.v20180120.QueryJobResponse.Data.TargetConfig.TargetDevicesItem;
import com.aliyuncs.v5.iot.model.v20180120.QueryJobResponse.Data.TimeoutConfig;
...
public class QueryJobResponseUnmarshaller {
	...
	public static QueryJobResponse unmarshall(QueryJobResponse queryJobResponse, UnmarshallerContext _ctx) {
		...
		List<TargetDevicesItem> targetDevicesList = new ArrayList<TargetDevicesItem>();
		for (int i = 0; i < _ctx.lengthValue("QueryJobResponse.Data.TargetConfig.TargetDevices.Length"); i++) {
			...
			targetDevicesList.add(targetDevicesItem);
		}
		targetConfig.setTargetDevices(targetDevicesList);

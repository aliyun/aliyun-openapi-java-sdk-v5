...
import com.aliyuncs.v5.iot.model.v20180120.GetEdgeInstanceDeploymentResponse;
import com.aliyuncs.v5.iot.model.v20180120.GetEdgeInstanceDeploymentResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.GetEdgeInstanceDeploymentResponse.Data.Task;
import com.aliyuncs.v5.iot.model.v20180120.GetEdgeInstanceDeploymentResponse.Data.Task.ResourceSnapshot;
...
public class GetEdgeInstanceDeploymentResponseUnmarshaller {
	...
	public static GetEdgeInstanceDeploymentResponse unmarshall(GetEdgeInstanceDeploymentResponse getEdgeInstanceDeploymentResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("GetEdgeInstanceDeploymentResponse.Data.TaskList.Length"); i++) {
			...
			List<ResourceSnapshot> resourceSnapshotListList = new ArrayList<ResourceSnapshot>();
			for (int j = 0; j < _ctx.lengthValue("GetEdgeInstanceDeploymentResponse.Data.TaskList["+ i +"].ResourceSnapshotList.Length"); j++) {
				...
				resourceSnapshotListList.add(resourceSnapshot);
			}
			task.setResourceSnapshotList(resourceSnapshotListList);

			taskListList.add(task);
		}
		data.setTaskList(taskListList);

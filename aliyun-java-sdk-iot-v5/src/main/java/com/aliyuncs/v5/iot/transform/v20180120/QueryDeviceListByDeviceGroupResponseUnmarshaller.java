...
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceListByDeviceGroupResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceListByDeviceGroupResponse.SimpleDeviceInfo;
...
public class QueryDeviceListByDeviceGroupResponseUnmarshaller {
	...
	public static QueryDeviceListByDeviceGroupResponse unmarshall(QueryDeviceListByDeviceGroupResponse queryDeviceListByDeviceGroupResponse, UnmarshallerContext _ctx) {
		...
		List<SimpleDeviceInfo> dataList = new ArrayList<SimpleDeviceInfo>();
		for (int i = 0; i < _ctx.lengthValue("QueryDeviceListByDeviceGroupResponse.Data.Length"); i++) {
			...
			dataList.add(simpleDeviceInfo);
		}
		queryDeviceListByDeviceGroupResponse.setData(dataList);

...
import com.aliyuncs.v5.iot.model.v20180120.ListDeviceDistributeJobResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListDeviceDistributeJobResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.ListDeviceDistributeJobResponse.Data.Items;
import com.aliyuncs.v5.iot.model.v20180120.ListDeviceDistributeJobResponse.Data.Items.TargetInstanceConfigsItem;
...
public class ListDeviceDistributeJobResponseUnmarshaller {
	...
	public static ListDeviceDistributeJobResponse unmarshall(ListDeviceDistributeJobResponse listDeviceDistributeJobResponse, UnmarshallerContext _ctx) {
		...
		List<Items> jobInfoList = new ArrayList<Items>();
		for (int i = 0; i < _ctx.lengthValue("ListDeviceDistributeJobResponse.Data.JobInfo.Length"); i++) {
			...
			List<TargetInstanceConfigsItem> targetInstanceConfigsList = new ArrayList<TargetInstanceConfigsItem>();
			for (int j = 0; j < _ctx.lengthValue("ListDeviceDistributeJobResponse.Data.JobInfo["+ i +"].TargetInstanceConfigs.Length"); j++) {
				...
				targetInstanceConfigsList.add(targetInstanceConfigsItem);
			}
			items.setTargetInstanceConfigs(targetInstanceConfigsList);

			jobInfoList.add(items);
		}
		data.setJobInfo(jobInfoList);

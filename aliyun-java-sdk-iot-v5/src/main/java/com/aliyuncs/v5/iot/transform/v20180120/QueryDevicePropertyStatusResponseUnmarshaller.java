...
import com.aliyuncs.v5.iot.model.v20180120.QueryDevicePropertyStatusResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDevicePropertyStatusResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryDevicePropertyStatusResponse.Data.PropertyStatusInfo;
...
public class QueryDevicePropertyStatusResponseUnmarshaller {
	...
	public static QueryDevicePropertyStatusResponse unmarshall(QueryDevicePropertyStatusResponse queryDevicePropertyStatusResponse, UnmarshallerContext _ctx) {
		...
		List<PropertyStatusInfo> listList = new ArrayList<PropertyStatusInfo>();
		for (int i = 0; i < _ctx.lengthValue("QueryDevicePropertyStatusResponse.Data.List.Length"); i++) {
			...
			listList.add(propertyStatusInfo);
		}

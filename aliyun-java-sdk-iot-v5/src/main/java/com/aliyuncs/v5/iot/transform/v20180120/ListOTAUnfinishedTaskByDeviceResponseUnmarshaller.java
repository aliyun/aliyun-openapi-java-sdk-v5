...
import com.aliyuncs.v5.iot.model.v20180120.ListOTAUnfinishedTaskByDeviceResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListOTAUnfinishedTaskByDeviceResponse.SimpleOTATaskInfo;
...
public class ListOTAUnfinishedTaskByDeviceResponseUnmarshaller {
	...
	public static ListOTAUnfinishedTaskByDeviceResponse unmarshall(ListOTAUnfinishedTaskByDeviceResponse listOTAUnfinishedTaskByDeviceResponse, UnmarshallerContext _ctx) {
		...
		List<SimpleOTATaskInfo> dataList = new ArrayList<SimpleOTATaskInfo>();
		for (int i = 0; i < _ctx.lengthValue("ListOTAUnfinishedTaskByDeviceResponse.Data.Length"); i++) {
			...
			dataList.add(simpleOTATaskInfo);
		}
		listOTAUnfinishedTaskByDeviceResponse.setData(dataList);

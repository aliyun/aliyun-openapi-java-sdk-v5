...
import com.aliyuncs.v5.iot.model.v20180120.QueryProductTopicResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryProductTopicResponse.ProductTopicInfo;
...
public class QueryProductTopicResponseUnmarshaller {
	...
	public static QueryProductTopicResponse unmarshall(QueryProductTopicResponse queryProductTopicResponse, UnmarshallerContext _ctx) {
		...
		List<ProductTopicInfo> dataList = new ArrayList<ProductTopicInfo>();
		for (int i = 0; i < _ctx.lengthValue("QueryProductTopicResponse.Data.Length"); i++) {
			...
			dataList.add(productTopicInfo);
		}
		queryProductTopicResponse.setData(dataList);

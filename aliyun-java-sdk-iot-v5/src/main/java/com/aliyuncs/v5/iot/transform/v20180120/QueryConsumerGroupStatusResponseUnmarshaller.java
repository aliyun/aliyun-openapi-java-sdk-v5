...
import com.aliyuncs.v5.iot.model.v20180120.QueryConsumerGroupStatusResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryConsumerGroupStatusResponse.ConsumerGroupClientConnectionInfo;
...
public class QueryConsumerGroupStatusResponseUnmarshaller {
	...
	public static QueryConsumerGroupStatusResponse unmarshall(QueryConsumerGroupStatusResponse queryConsumerGroupStatusResponse, UnmarshallerContext _ctx) {
		...
		List<ConsumerGroupClientConnectionInfo> clientConnectionStatusListList = new ArrayList<ConsumerGroupClientConnectionInfo>();
		for (int i = 0; i < _ctx.lengthValue("QueryConsumerGroupStatusResponse.ClientConnectionStatusList.Length"); i++) {
			...
			clientConnectionStatusListList.add(consumerGroupClientConnectionInfo);
		}
		queryConsumerGroupStatusResponse.setClientConnectionStatusList(clientConnectionStatusListList);

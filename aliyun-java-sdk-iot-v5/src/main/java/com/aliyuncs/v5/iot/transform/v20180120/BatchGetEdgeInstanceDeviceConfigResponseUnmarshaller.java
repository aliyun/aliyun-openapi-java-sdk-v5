...
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeInstanceDeviceConfigResponse;
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeInstanceDeviceConfigResponse.DeviceConfig;
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeInstanceDeviceConfigResponse.DeviceConfig.Config;
...
public class BatchGetEdgeInstanceDeviceConfigResponseUnmarshaller {
	...
	public static BatchGetEdgeInstanceDeviceConfigResponse unmarshall(BatchGetEdgeInstanceDeviceConfigResponse batchGetEdgeInstanceDeviceConfigResponse, UnmarshallerContext _ctx) {
		...
		List<DeviceConfig> deviceConfigListList = new ArrayList<DeviceConfig>();
		for (int i = 0; i < _ctx.lengthValue("BatchGetEdgeInstanceDeviceConfigResponse.DeviceConfigList.Length"); i++) {
			...
			deviceConfigListList.add(deviceConfig);
		}
		batchGetEdgeInstanceDeviceConfigResponse.setDeviceConfigList(deviceConfigListList);

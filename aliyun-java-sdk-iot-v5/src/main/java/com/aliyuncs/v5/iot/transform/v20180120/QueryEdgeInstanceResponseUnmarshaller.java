...
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceResponse.Data.Instance;
...
public class QueryEdgeInstanceResponseUnmarshaller {
	...
	public static QueryEdgeInstanceResponse unmarshall(QueryEdgeInstanceResponse queryEdgeInstanceResponse, UnmarshallerContext _ctx) {
		...
		List<Instance> instanceListList = new ArrayList<Instance>();
		for (int i = 0; i < _ctx.lengthValue("QueryEdgeInstanceResponse.Data.InstanceList.Length"); i++) {
			...
			instanceListList.add(instance);
		}
		data.setInstanceList(instanceListList);

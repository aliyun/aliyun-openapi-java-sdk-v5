...
import com.aliyuncs.v5.iot.model.v20180120.ListTaskByPageResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListTaskByPageResponse.DataItem;
...
public class ListTaskByPageResponseUnmarshaller {
	...
	public static ListTaskByPageResponse unmarshall(ListTaskByPageResponse listTaskByPageResponse, UnmarshallerContext _ctx) {
		...
		listTaskByPageResponse.setData(dataList);

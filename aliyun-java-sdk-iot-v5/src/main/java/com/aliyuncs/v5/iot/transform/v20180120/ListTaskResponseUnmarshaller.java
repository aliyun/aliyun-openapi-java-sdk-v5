...
import com.aliyuncs.v5.iot.model.v20180120.ListTaskResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListTaskResponse.DataItem;
...
public class ListTaskResponseUnmarshaller {
	...
	public static ListTaskResponse unmarshall(ListTaskResponse listTaskResponse, UnmarshallerContext _ctx) {
		...
		listTaskResponse.setData(dataList);

...
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceMessageRoutingResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceMessageRoutingResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceMessageRoutingResponse.Data.MessageRoute;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceMessageRoutingResponse.Data.MessageRoute.RouteContext;
...
public class QueryEdgeInstanceMessageRoutingResponseUnmarshaller {
	...
	public static QueryEdgeInstanceMessageRoutingResponse unmarshall(QueryEdgeInstanceMessageRoutingResponse queryEdgeInstanceMessageRoutingResponse, UnmarshallerContext _ctx) {
		...
		List<MessageRoute> messageRouteListList = new ArrayList<MessageRoute>();
		for (int i = 0; i < _ctx.lengthValue("QueryEdgeInstanceMessageRoutingResponse.Data.MessageRouteList.Length"); i++) {
			...
			messageRouteListList.add(messageRoute);
		}
		data.setMessageRouteList(messageRouteListList);

...
import com.aliyuncs.v5.iot.model.v20180120.ListOTAFirmwareResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListOTAFirmwareResponse.SimpleFirmwareInfo;
...
public class ListOTAFirmwareResponseUnmarshaller {
	...
	public static ListOTAFirmwareResponse unmarshall(ListOTAFirmwareResponse listOTAFirmwareResponse, UnmarshallerContext _ctx) {
		...
		List<SimpleFirmwareInfo> firmwareInfoList = new ArrayList<SimpleFirmwareInfo>();
		for (int i = 0; i < _ctx.lengthValue("ListOTAFirmwareResponse.FirmwareInfo.Length"); i++) {
			...
			firmwareInfoList.add(simpleFirmwareInfo);
		}
		listOTAFirmwareResponse.setFirmwareInfo(firmwareInfoList);

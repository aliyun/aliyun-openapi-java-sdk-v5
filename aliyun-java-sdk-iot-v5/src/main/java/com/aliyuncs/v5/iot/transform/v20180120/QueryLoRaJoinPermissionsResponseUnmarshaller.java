...
import com.aliyuncs.v5.iot.model.v20180120.QueryLoRaJoinPermissionsResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryLoRaJoinPermissionsResponse.JoinPermission;
...
public class QueryLoRaJoinPermissionsResponseUnmarshaller {
	...
	public static QueryLoRaJoinPermissionsResponse unmarshall(QueryLoRaJoinPermissionsResponse queryLoRaJoinPermissionsResponse, UnmarshallerContext _ctx) {
		...
		List<JoinPermission> joinPermissionsList = new ArrayList<JoinPermission>();
		for (int i = 0; i < _ctx.lengthValue("QueryLoRaJoinPermissionsResponse.JoinPermissions.Length"); i++) {
			...
			joinPermissionsList.add(joinPermission);
		}
		queryLoRaJoinPermissionsResponse.setJoinPermissions(joinPermissionsList);

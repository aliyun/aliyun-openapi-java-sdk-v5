...
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceDriverResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceDriverResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceDriverResponse.Data.Driver;
...
public class QueryEdgeInstanceDriverResponseUnmarshaller {
	...
	public static QueryEdgeInstanceDriverResponse unmarshall(QueryEdgeInstanceDriverResponse queryEdgeInstanceDriverResponse, UnmarshallerContext _ctx) {
		...
		List<Driver> driverListList = new ArrayList<Driver>();
		for (int i = 0; i < _ctx.lengthValue("QueryEdgeInstanceDriverResponse.Data.DriverList.Length"); i++) {
			...
			driverListList.add(driver);
		}
		data.setDriverList(driverListList);

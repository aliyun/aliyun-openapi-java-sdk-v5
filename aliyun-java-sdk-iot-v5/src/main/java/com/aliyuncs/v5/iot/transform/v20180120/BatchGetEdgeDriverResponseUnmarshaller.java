...
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeDriverResponse;
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeDriverResponse.Driver;
...
public class BatchGetEdgeDriverResponseUnmarshaller {
	...
	public static BatchGetEdgeDriverResponse unmarshall(BatchGetEdgeDriverResponse batchGetEdgeDriverResponse, UnmarshallerContext _ctx) {
		...
		batchGetEdgeDriverResponse.setDriverList(driverListList);

...
import com.aliyuncs.v5.iot.model.v20180120.ListRuleResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListRuleResponse.RuleInfo;
...
public class ListRuleResponseUnmarshaller {
	...
	public static ListRuleResponse unmarshall(ListRuleResponse listRuleResponse, UnmarshallerContext _ctx) {
		...
		List<RuleInfo> dataList = new ArrayList<RuleInfo>();
		for (int i = 0; i < _ctx.lengthValue("ListRuleResponse.Data.Length"); i++) {
			...
			dataList.add(ruleInfo);
		}
		listRuleResponse.setData(dataList);

...
import com.aliyuncs.v5.iot.model.v20180120.QueryAppDeviceListResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryAppDeviceListResponse.DataItem;
...
public class QueryAppDeviceListResponseUnmarshaller {
	...
	public static QueryAppDeviceListResponse unmarshall(QueryAppDeviceListResponse queryAppDeviceListResponse, UnmarshallerContext _ctx) {
		...
		queryAppDeviceListResponse.setData(dataList);

...
import com.aliyuncs.v5.iot.model.v20180120.CreateProductTagsResponse;
import com.aliyuncs.v5.iot.model.v20180120.CreateProductTagsResponse.ProductTag;
...
public class CreateProductTagsResponseUnmarshaller {
	...
	public static CreateProductTagsResponse unmarshall(CreateProductTagsResponse createProductTagsResponse, UnmarshallerContext _ctx) {
		...
		List<ProductTag> invalidProductTagsList = new ArrayList<ProductTag>();
		for (int i = 0; i < _ctx.lengthValue("CreateProductTagsResponse.InvalidProductTags.Length"); i++) {
			...
			invalidProductTagsList.add(productTag);
		}
		createProductTagsResponse.setInvalidProductTags(invalidProductTagsList);

...
import com.aliyuncs.v5.iot.model.v20180120.BatchGetDeviceStateResponse;
import com.aliyuncs.v5.iot.model.v20180120.BatchGetDeviceStateResponse.DeviceStatus;
...
public class BatchGetDeviceStateResponseUnmarshaller {
	...
	public static BatchGetDeviceStateResponse unmarshall(BatchGetDeviceStateResponse batchGetDeviceStateResponse, UnmarshallerContext _ctx) {
		...
		List<DeviceStatus> deviceStatusListList = new ArrayList<DeviceStatus>();
		for (int i = 0; i < _ctx.lengthValue("BatchGetDeviceStateResponse.DeviceStatusList.Length"); i++) {
			...
			deviceStatusListList.add(deviceStatus);
		}
		batchGetDeviceStateResponse.setDeviceStatusList(deviceStatusListList);

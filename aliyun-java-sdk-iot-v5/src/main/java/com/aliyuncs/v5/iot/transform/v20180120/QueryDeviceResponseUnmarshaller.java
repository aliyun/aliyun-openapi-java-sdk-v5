...
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceResponse.DeviceInfo;
...
public class QueryDeviceResponseUnmarshaller {
	...
	public static QueryDeviceResponse unmarshall(QueryDeviceResponse queryDeviceResponse, UnmarshallerContext _ctx) {
		...
		List<DeviceInfo> dataList = new ArrayList<DeviceInfo>();
		...
		queryDeviceResponse.setData(dataList);

...
public class BatchCheckDeviceNamesRequest extends RpcAcsRequest<BatchCheckDeviceNamesResponse> {
	...
	public void setDeviceNameList(List<DeviceNameList> deviceNameList) {
		this.deviceNameList = deviceNameList;	
		if (deviceNameList != null) {
			for (int depth1 = 0; depth1 < deviceNameList.size(); depth1++) {
				putQueryParameter("DeviceNameList." + (depth1 + 1) + ".DeviceNickname" , deviceNameList.get(depth1).getDeviceNickname());
				putQueryParameter("DeviceNameList." + (depth1 + 1) + ".DeviceName" , deviceNameList.get(depth1).getDeviceName());
			}
		}	
	}

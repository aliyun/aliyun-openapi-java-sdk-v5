...
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceGroupListResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceGroupListResponse.GroupInfo;
...
public class QueryDeviceGroupListResponseUnmarshaller {
	...
	public static QueryDeviceGroupListResponse unmarshall(QueryDeviceGroupListResponse queryDeviceGroupListResponse, UnmarshallerContext _ctx) {
		...
		queryDeviceGroupListResponse.setData(dataList);

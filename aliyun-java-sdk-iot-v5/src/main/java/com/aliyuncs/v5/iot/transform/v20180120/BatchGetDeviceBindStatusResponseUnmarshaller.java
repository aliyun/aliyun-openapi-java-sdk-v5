...
import com.aliyuncs.v5.iot.model.v20180120.BatchGetDeviceBindStatusResponse;
import com.aliyuncs.v5.iot.model.v20180120.BatchGetDeviceBindStatusResponse.DeviceStatus;
...
public class BatchGetDeviceBindStatusResponseUnmarshaller {
	...
	public static BatchGetDeviceBindStatusResponse unmarshall(BatchGetDeviceBindStatusResponse batchGetDeviceBindStatusResponse, UnmarshallerContext _ctx) {
		...
		List<DeviceStatus> dataList = new ArrayList<DeviceStatus>();
		...
		batchGetDeviceBindStatusResponse.setData(dataList);

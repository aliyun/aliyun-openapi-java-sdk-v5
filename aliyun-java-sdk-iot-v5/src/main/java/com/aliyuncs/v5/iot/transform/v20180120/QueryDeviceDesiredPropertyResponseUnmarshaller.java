...
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceDesiredPropertyResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceDesiredPropertyResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceDesiredPropertyResponse.Data.DesiredPropertyInfo;
...
public class QueryDeviceDesiredPropertyResponseUnmarshaller {
	...
	public static QueryDeviceDesiredPropertyResponse unmarshall(QueryDeviceDesiredPropertyResponse queryDeviceDesiredPropertyResponse, UnmarshallerContext _ctx) {
		...
		List<DesiredPropertyInfo> listList = new ArrayList<DesiredPropertyInfo>();
		for (int i = 0; i < _ctx.lengthValue("QueryDeviceDesiredPropertyResponse.Data.List.Length"); i++) {
			...
			listList.add(desiredPropertyInfo);
		}

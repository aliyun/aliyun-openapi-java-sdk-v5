...
import com.aliyuncs.v5.iot.model.v20180120.ListOTAJobByFirmwareResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListOTAJobByFirmwareResponse.SimpleOTAJobInfo;
import com.aliyuncs.v5.iot.model.v20180120.ListOTAJobByFirmwareResponse.SimpleOTAJobInfo.OtaTagDTO;
...
public class ListOTAJobByFirmwareResponseUnmarshaller {
	...
	public static ListOTAJobByFirmwareResponse unmarshall(ListOTAJobByFirmwareResponse listOTAJobByFirmwareResponse, UnmarshallerContext _ctx) {
		...
		List<SimpleOTAJobInfo> dataList = new ArrayList<SimpleOTAJobInfo>();
		for (int i = 0; i < _ctx.lengthValue("ListOTAJobByFirmwareResponse.Data.Length"); i++) {
			...
			simpleOTAJobInfo.setTags(tagsList);

			dataList.add(simpleOTAJobInfo);
		}
		listOTAJobByFirmwareResponse.setData(dataList);

...
import com.aliyuncs.v5.iot.model.v20180120.QueryConsumerGroupListResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryConsumerGroupListResponse.ConsumerGroupDTO;
...
public class QueryConsumerGroupListResponseUnmarshaller {
	...
	public static QueryConsumerGroupListResponse unmarshall(QueryConsumerGroupListResponse queryConsumerGroupListResponse, UnmarshallerContext _ctx) {
		...
		List<ConsumerGroupDTO> dataList = new ArrayList<ConsumerGroupDTO>();
		for (int i = 0; i < _ctx.lengthValue("QueryConsumerGroupListResponse.Data.Length"); i++) {
			...
			dataList.add(consumerGroupDTO);
		}
		queryConsumerGroupListResponse.setData(dataList);

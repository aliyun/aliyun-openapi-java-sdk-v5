...
public class DeleteSpeechRequest extends RpcAcsRequest<DeleteSpeechResponse> {
	...
	public void setSpeechCodeList(List<String> speechCodeList) {
		this.speechCodeList = speechCodeList;	
		if (speechCodeList != null) {
			for (int i = 0; i < speechCodeList.size(); i++) {
				putBodyParameter("SpeechCodeList." + (i + 1) , speechCodeList.get(i));
			}
		}	
	}

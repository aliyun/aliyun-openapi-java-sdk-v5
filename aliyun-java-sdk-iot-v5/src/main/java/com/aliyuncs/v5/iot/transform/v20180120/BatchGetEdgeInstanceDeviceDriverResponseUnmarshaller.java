...
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeInstanceDeviceDriverResponse;
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeInstanceDeviceDriverResponse.DeviceDriver;
...
public class BatchGetEdgeInstanceDeviceDriverResponseUnmarshaller {
	...
	public static BatchGetEdgeInstanceDeviceDriverResponse unmarshall(BatchGetEdgeInstanceDeviceDriverResponse batchGetEdgeInstanceDeviceDriverResponse, UnmarshallerContext _ctx) {
		...
		List<DeviceDriver> deviceDriverListList = new ArrayList<DeviceDriver>();
		for (int i = 0; i < _ctx.lengthValue("BatchGetEdgeInstanceDeviceDriverResponse.DeviceDriverList.Length"); i++) {
			...
			deviceDriverListList.add(deviceDriver);
		}
		batchGetEdgeInstanceDeviceDriverResponse.setDeviceDriverList(deviceDriverListList);

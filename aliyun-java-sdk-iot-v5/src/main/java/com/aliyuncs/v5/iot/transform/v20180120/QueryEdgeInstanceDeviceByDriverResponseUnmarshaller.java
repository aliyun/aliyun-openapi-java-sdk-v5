...
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceDeviceByDriverResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceDeviceByDriverResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceDeviceByDriverResponse.Data.Device;
...
public class QueryEdgeInstanceDeviceByDriverResponseUnmarshaller {
	...
	public static QueryEdgeInstanceDeviceByDriverResponse unmarshall(QueryEdgeInstanceDeviceByDriverResponse queryEdgeInstanceDeviceByDriverResponse, UnmarshallerContext _ctx) {
		...
		List<Device> deviceListList = new ArrayList<Device>();
		for (int i = 0; i < _ctx.lengthValue("QueryEdgeInstanceDeviceByDriverResponse.Data.DeviceList.Length"); i++) {
			...
			deviceListList.add(device);
		}
		data.setDeviceList(deviceListList);

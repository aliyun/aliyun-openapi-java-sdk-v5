...
import com.aliyuncs.v5.iot.model.v20180120.ListThingTemplatesResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListThingTemplatesResponse.CategoryInfo;
...
public class ListThingTemplatesResponseUnmarshaller {
	...
	public static ListThingTemplatesResponse unmarshall(ListThingTemplatesResponse listThingTemplatesResponse, UnmarshallerContext _ctx) {
		...
		List<CategoryInfo> dataList = new ArrayList<CategoryInfo>();
		...
		listThingTemplatesResponse.setData(dataList);

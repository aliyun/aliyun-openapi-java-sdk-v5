...
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeDriverVersionResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeDriverVersionResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeDriverVersionResponse.Data.DriverVersion;
...
public class QueryEdgeDriverVersionResponseUnmarshaller {
	...
	public static QueryEdgeDriverVersionResponse unmarshall(QueryEdgeDriverVersionResponse queryEdgeDriverVersionResponse, UnmarshallerContext _ctx) {
		...
		List<DriverVersion> driverVersionListList = new ArrayList<DriverVersion>();
		for (int i = 0; i < _ctx.lengthValue("QueryEdgeDriverVersionResponse.Data.DriverVersionList.Length"); i++) {
			...
			driverVersionListList.add(driverVersion);
		}
		data.setDriverVersionList(driverVersionListList);

...
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceGroupByDeviceResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceGroupByDeviceResponse.GroupInfo;
...
public class QueryDeviceGroupByDeviceResponseUnmarshaller {
	...
	public static QueryDeviceGroupByDeviceResponse unmarshall(QueryDeviceGroupByDeviceResponse queryDeviceGroupByDeviceResponse, UnmarshallerContext _ctx) {
		...
		List<GroupInfo> groupInfosList = new ArrayList<GroupInfo>();
		...
		queryDeviceGroupByDeviceResponse.setGroupInfos(groupInfosList);

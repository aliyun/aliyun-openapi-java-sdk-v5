...
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeInstanceChannelResponse;
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeInstanceChannelResponse.Channel;
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeInstanceChannelResponse.Channel.Config;
...
public class BatchGetEdgeInstanceChannelResponseUnmarshaller {
	...
	public static BatchGetEdgeInstanceChannelResponse unmarshall(BatchGetEdgeInstanceChannelResponse batchGetEdgeInstanceChannelResponse, UnmarshallerContext _ctx) {
		...
		batchGetEdgeInstanceChannelResponse.setData(dataList);

...
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceHistoricDeploymentResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceHistoricDeploymentResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceHistoricDeploymentResponse.Data.Deployment;
...
public class QueryEdgeInstanceHistoricDeploymentResponseUnmarshaller {
	...
	public static QueryEdgeInstanceHistoricDeploymentResponse unmarshall(QueryEdgeInstanceHistoricDeploymentResponse queryEdgeInstanceHistoricDeploymentResponse, UnmarshallerContext _ctx) {
		...
		List<Deployment> deploymentListList = new ArrayList<Deployment>();
		for (int i = 0; i < _ctx.lengthValue("QueryEdgeInstanceHistoricDeploymentResponse.Data.DeploymentList.Length"); i++) {
			...
			deploymentListList.add(deployment);
		}
		data.setDeploymentList(deploymentListList);

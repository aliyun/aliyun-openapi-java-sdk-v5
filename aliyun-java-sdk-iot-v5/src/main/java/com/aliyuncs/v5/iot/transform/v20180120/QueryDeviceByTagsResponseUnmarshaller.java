...
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceByTagsResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceByTagsResponse.SimpleDeviceInfo;
...
public class QueryDeviceByTagsResponseUnmarshaller {
	...
	public static QueryDeviceByTagsResponse unmarshall(QueryDeviceByTagsResponse queryDeviceByTagsResponse, UnmarshallerContext _ctx) {
		...
		queryDeviceByTagsResponse.setData(dataList);

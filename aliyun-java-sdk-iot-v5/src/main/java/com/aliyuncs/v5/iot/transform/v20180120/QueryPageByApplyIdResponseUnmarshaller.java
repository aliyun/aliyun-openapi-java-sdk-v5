...
import com.aliyuncs.v5.iot.model.v20180120.QueryPageByApplyIdResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryPageByApplyIdResponse.ApplyDeviceInfo;
...
public class QueryPageByApplyIdResponseUnmarshaller {
	...
	public static QueryPageByApplyIdResponse unmarshall(QueryPageByApplyIdResponse queryPageByApplyIdResponse, UnmarshallerContext _ctx) {
		...
		List<ApplyDeviceInfo> applyDeviceListList = new ArrayList<ApplyDeviceInfo>();
		for (int i = 0; i < _ctx.lengthValue("QueryPageByApplyIdResponse.ApplyDeviceList.Length"); i++) {
			...
			applyDeviceListList.add(applyDeviceInfo);
		}
		queryPageByApplyIdResponse.setApplyDeviceList(applyDeviceListList);

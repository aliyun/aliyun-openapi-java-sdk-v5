...
import com.aliyuncs.v5.iot.model.v20180120.QueryDevicePropertiesDataResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDevicePropertiesDataResponse.PropertyDataInfo;
import com.aliyuncs.v5.iot.model.v20180120.QueryDevicePropertiesDataResponse.PropertyDataInfo.PropertyInfo;
...
public class QueryDevicePropertiesDataResponseUnmarshaller {
	...
	public static QueryDevicePropertiesDataResponse unmarshall(QueryDevicePropertiesDataResponse queryDevicePropertiesDataResponse, UnmarshallerContext _ctx) {
		...
		List<PropertyDataInfo> propertyDataInfosList = new ArrayList<PropertyDataInfo>();
		for (int i = 0; i < _ctx.lengthValue("QueryDevicePropertiesDataResponse.PropertyDataInfos.Length"); i++) {
			...
			List<PropertyInfo> listList = new ArrayList<PropertyInfo>();
			for (int j = 0; j < _ctx.lengthValue("QueryDevicePropertiesDataResponse.PropertyDataInfos["+ i +"].List.Length"); j++) {
				...
				listList.add(propertyInfo);
			}
			propertyDataInfo.setList(listList);

			propertyDataInfosList.add(propertyDataInfo);
		}
		queryDevicePropertiesDataResponse.setPropertyDataInfos(propertyDataInfosList);

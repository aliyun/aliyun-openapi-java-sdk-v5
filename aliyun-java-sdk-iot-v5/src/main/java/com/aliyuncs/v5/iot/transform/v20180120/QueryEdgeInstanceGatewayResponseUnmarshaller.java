...
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceGatewayResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceGatewayResponse.Gateway;
...
public class QueryEdgeInstanceGatewayResponseUnmarshaller {
	...
	public static QueryEdgeInstanceGatewayResponse unmarshall(QueryEdgeInstanceGatewayResponse queryEdgeInstanceGatewayResponse, UnmarshallerContext _ctx) {
		...
		List<Gateway> gatewayListList = new ArrayList<Gateway>();
		for (int i = 0; i < _ctx.lengthValue("QueryEdgeInstanceGatewayResponse.GatewayList.Length"); i++) {
			...
			gatewayListList.add(gateway);
		}
		queryEdgeInstanceGatewayResponse.setGatewayList(gatewayListList);

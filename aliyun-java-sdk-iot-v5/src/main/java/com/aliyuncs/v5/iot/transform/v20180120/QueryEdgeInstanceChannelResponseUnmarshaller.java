...
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceChannelResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceChannelResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceChannelResponse.Data.Channel;
import com.aliyuncs.v5.iot.model.v20180120.QueryEdgeInstanceChannelResponse.Data.Channel.Config;
...
public class QueryEdgeInstanceChannelResponseUnmarshaller {
	...
	public static QueryEdgeInstanceChannelResponse unmarshall(QueryEdgeInstanceChannelResponse queryEdgeInstanceChannelResponse, UnmarshallerContext _ctx) {
		...
		List<Channel> channelListList = new ArrayList<Channel>();
		for (int i = 0; i < _ctx.lengthValue("QueryEdgeInstanceChannelResponse.Data.ChannelList.Length"); i++) {
			...
			channel.setConfigList(configListList);

			channelListList.add(channel);
		}
		data.setChannelList(channelListList);

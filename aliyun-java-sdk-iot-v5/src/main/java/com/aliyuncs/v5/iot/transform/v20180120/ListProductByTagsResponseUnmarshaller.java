...
import com.aliyuncs.v5.iot.model.v20180120.ListProductByTagsResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListProductByTagsResponse.ProductInfo;
...
public class ListProductByTagsResponseUnmarshaller {
	...
	public static ListProductByTagsResponse unmarshall(ListProductByTagsResponse listProductByTagsResponse, UnmarshallerContext _ctx) {
		...
		List<ProductInfo> productInfosList = new ArrayList<ProductInfo>();
		for (int i = 0; i < _ctx.lengthValue("ListProductByTagsResponse.ProductInfos.Length"); i++) {
			...
			productInfosList.add(productInfo);
		}
		listProductByTagsResponse.setProductInfos(productInfosList);

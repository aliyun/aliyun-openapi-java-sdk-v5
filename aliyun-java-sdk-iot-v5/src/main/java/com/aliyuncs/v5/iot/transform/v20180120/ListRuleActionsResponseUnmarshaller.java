...
import com.aliyuncs.v5.iot.model.v20180120.ListRuleActionsResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListRuleActionsResponse.RuleActionInfo;
...
public class ListRuleActionsResponseUnmarshaller {
	...
	public static ListRuleActionsResponse unmarshall(ListRuleActionsResponse listRuleActionsResponse, UnmarshallerContext _ctx) {
		...
		List<RuleActionInfo> ruleActionListList = new ArrayList<RuleActionInfo>();
		for (int i = 0; i < _ctx.lengthValue("ListRuleActionsResponse.RuleActionList.Length"); i++) {
			...
			ruleActionListList.add(ruleActionInfo);
		}
		listRuleActionsResponse.setRuleActionList(ruleActionListList);

...
import com.aliyuncs.v5.iot.model.v20180120.GetDataAPIServiceDetailResponse;
import com.aliyuncs.v5.iot.model.v20180120.GetDataAPIServiceDetailResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.GetDataAPIServiceDetailResponse.Data.SqlTemplateDTO;
import com.aliyuncs.v5.iot.model.v20180120.GetDataAPIServiceDetailResponse.Data.SqlTemplateDTO.RequestParamsItem;
import com.aliyuncs.v5.iot.model.v20180120.GetDataAPIServiceDetailResponse.Data.SqlTemplateDTO.ResponseParamsItem;
...
public class GetDataAPIServiceDetailResponseUnmarshaller {
	...
	public static GetDataAPIServiceDetailResponse unmarshall(GetDataAPIServiceDetailResponse getDataAPIServiceDetailResponse, UnmarshallerContext _ctx) {
		...
		List<RequestParamsItem> requestParamsList = new ArrayList<RequestParamsItem>();
		for (int i = 0; i < _ctx.lengthValue("GetDataAPIServiceDetailResponse.Data.SqlTemplateDTO.RequestParams.Length"); i++) {
			...
			requestParamsList.add(requestParamsItem);
		}
		sqlTemplateDTO.setRequestParams(requestParamsList);

		List<ResponseParamsItem> responseParamsList = new ArrayList<ResponseParamsItem>();
		for (int i = 0; i < _ctx.lengthValue("GetDataAPIServiceDetailResponse.Data.SqlTemplateDTO.ResponseParams.Length"); i++) {
			...
			responseParamsList.add(responseParamsItem);
		}
		sqlTemplateDTO.setResponseParams(responseParamsList);

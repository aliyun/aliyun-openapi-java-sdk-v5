...
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceByStatusResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceByStatusResponse.SimpleDeviceInfo;
...
public class QueryDeviceByStatusResponseUnmarshaller {
	...
	public static QueryDeviceByStatusResponse unmarshall(QueryDeviceByStatusResponse queryDeviceByStatusResponse, UnmarshallerContext _ctx) {
		...
		queryDeviceByStatusResponse.setData(dataList);

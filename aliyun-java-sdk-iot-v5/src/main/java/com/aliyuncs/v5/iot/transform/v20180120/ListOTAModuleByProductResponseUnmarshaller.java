...
import com.aliyuncs.v5.iot.model.v20180120.ListOTAModuleByProductResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListOTAModuleByProductResponse.OtaModuleDTO;
...
public class ListOTAModuleByProductResponseUnmarshaller {
	...
	public static ListOTAModuleByProductResponse unmarshall(ListOTAModuleByProductResponse listOTAModuleByProductResponse, UnmarshallerContext _ctx) {
		...
		List<OtaModuleDTO> dataList = new ArrayList<OtaModuleDTO>();
		for (int i = 0; i < _ctx.lengthValue("ListOTAModuleByProductResponse.Data.Length"); i++) {
			...
			dataList.add(otaModuleDTO);
		}
		listOTAModuleByProductResponse.setData(dataList);

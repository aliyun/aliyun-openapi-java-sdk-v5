...
import com.aliyuncs.v5.iot.model.v20180120.QueryClientIdsResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryClientIdsResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryClientIdsResponse.Data.DynamicRegClientId;
...
public class QueryClientIdsResponseUnmarshaller {
	...
	public static QueryClientIdsResponse unmarshall(QueryClientIdsResponse queryClientIdsResponse, UnmarshallerContext _ctx) {
		...
		List<DynamicRegClientId> dynamicRegClientIdsList = new ArrayList<DynamicRegClientId>();
		for (int i = 0; i < _ctx.lengthValue("QueryClientIdsResponse.Data.DynamicRegClientIds.Length"); i++) {
			...
			dynamicRegClientIdsList.add(dynamicRegClientId);
		}
		data.setDynamicRegClientIds(dynamicRegClientIdsList);

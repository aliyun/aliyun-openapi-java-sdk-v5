...
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeInstanceDeviceChannelResponse;
import com.aliyuncs.v5.iot.model.v20180120.BatchGetEdgeInstanceDeviceChannelResponse.DeviceChannel;
...
public class BatchGetEdgeInstanceDeviceChannelResponseUnmarshaller {
	...
	public static BatchGetEdgeInstanceDeviceChannelResponse unmarshall(BatchGetEdgeInstanceDeviceChannelResponse batchGetEdgeInstanceDeviceChannelResponse, UnmarshallerContext _ctx) {
		...
		List<DeviceChannel> deviceChannelListList = new ArrayList<DeviceChannel>();
		for (int i = 0; i < _ctx.lengthValue("BatchGetEdgeInstanceDeviceChannelResponse.DeviceChannelList.Length"); i++) {
			...
			deviceChannelListList.add(deviceChannel);
		}
		batchGetEdgeInstanceDeviceChannelResponse.setDeviceChannelList(deviceChannelListList);

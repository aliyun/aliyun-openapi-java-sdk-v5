...
import com.aliyuncs.v5.iot.model.v20180120.BatchQueryDeviceDetailResponse;
import com.aliyuncs.v5.iot.model.v20180120.BatchQueryDeviceDetailResponse.DataItem;
...
public class BatchQueryDeviceDetailResponseUnmarshaller {
	...
	public static BatchQueryDeviceDetailResponse unmarshall(BatchQueryDeviceDetailResponse batchQueryDeviceDetailResponse, UnmarshallerContext _ctx) {
		...
		batchQueryDeviceDetailResponse.setData(dataList);

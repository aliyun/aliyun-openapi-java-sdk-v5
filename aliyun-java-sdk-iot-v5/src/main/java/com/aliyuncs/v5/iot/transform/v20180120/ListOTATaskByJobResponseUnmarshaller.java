...
import com.aliyuncs.v5.iot.model.v20180120.ListOTATaskByJobResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListOTATaskByJobResponse.SimpleOTATaskInfo;
...
public class ListOTATaskByJobResponseUnmarshaller {
	...
	public static ListOTATaskByJobResponse unmarshall(ListOTATaskByJobResponse listOTATaskByJobResponse, UnmarshallerContext _ctx) {
		...
		listOTATaskByJobResponse.setData(dataList);

...
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceOriginalPropertyStatusResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceOriginalPropertyStatusResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceOriginalPropertyStatusResponse.Data.PropertyStatusDataInfo;
...
public class QueryDeviceOriginalPropertyStatusResponseUnmarshaller {
	...
	public static QueryDeviceOriginalPropertyStatusResponse unmarshall(QueryDeviceOriginalPropertyStatusResponse queryDeviceOriginalPropertyStatusResponse, UnmarshallerContext _ctx) {
		...
		List<PropertyStatusDataInfo> listList = new ArrayList<PropertyStatusDataInfo>();
		for (int i = 0; i < _ctx.lengthValue("QueryDeviceOriginalPropertyStatusResponse.Data.List.Length"); i++) {
			...
			listList.add(propertyStatusDataInfo);
		}

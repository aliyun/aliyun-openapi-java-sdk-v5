...
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceFileListResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceFileListResponse.FileSummary;
...
public class QueryDeviceFileListResponseUnmarshaller {
	...
	public static QueryDeviceFileListResponse unmarshall(QueryDeviceFileListResponse queryDeviceFileListResponse, UnmarshallerContext _ctx) {
		...
		List<FileSummary> dataList = new ArrayList<FileSummary>();
		for (int i = 0; i < _ctx.lengthValue("QueryDeviceFileListResponse.Data.Length"); i++) {
			...
			dataList.add(fileSummary);
		}
		queryDeviceFileListResponse.setData(dataList);

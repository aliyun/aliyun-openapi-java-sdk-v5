...
import com.aliyuncs.v5.iot.model.v20180120.ListJobResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListJobResponse.DataItem;
...
public class ListJobResponseUnmarshaller {
	...
	public static ListJobResponse unmarshall(ListJobResponse listJobResponse, UnmarshallerContext _ctx) {
		...
		listJobResponse.setData(dataList);

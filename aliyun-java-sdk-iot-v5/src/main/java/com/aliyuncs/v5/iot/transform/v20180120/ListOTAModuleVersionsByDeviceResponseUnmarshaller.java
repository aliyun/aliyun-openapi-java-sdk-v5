...
import com.aliyuncs.v5.iot.model.v20180120.ListOTAModuleVersionsByDeviceResponse;
import com.aliyuncs.v5.iot.model.v20180120.ListOTAModuleVersionsByDeviceResponse.SimpleOTAModuleInfo;
...
public class ListOTAModuleVersionsByDeviceResponseUnmarshaller {
	...
	public static ListOTAModuleVersionsByDeviceResponse unmarshall(ListOTAModuleVersionsByDeviceResponse listOTAModuleVersionsByDeviceResponse, UnmarshallerContext _ctx) {
		...
		List<SimpleOTAModuleInfo> dataList = new ArrayList<SimpleOTAModuleInfo>();
		for (int i = 0; i < _ctx.lengthValue("ListOTAModuleVersionsByDeviceResponse.Data.Length"); i++) {
			...
			dataList.add(simpleOTAModuleInfo);
		}
		listOTAModuleVersionsByDeviceResponse.setData(dataList);

...
import com.aliyuncs.v5.iot.model.v20180120.QuerySolutionDeviceGroupPageResponse;
import com.aliyuncs.v5.iot.model.v20180120.QuerySolutionDeviceGroupPageResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.QuerySolutionDeviceGroupPageResponse.Data.ItemName;
...
public class QuerySolutionDeviceGroupPageResponseUnmarshaller {
	...
	public static QuerySolutionDeviceGroupPageResponse unmarshall(QuerySolutionDeviceGroupPageResponse querySolutionDeviceGroupPageResponse, UnmarshallerContext _ctx) {
		...
		List<ItemName> listList = new ArrayList<ItemName>();

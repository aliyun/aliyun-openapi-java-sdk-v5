...
import com.aliyuncs.v5.iot.model.v20180120.GetSolutionVoiceResponse;
import com.aliyuncs.v5.iot.model.v20180120.GetSolutionVoiceResponse.Data;
import com.aliyuncs.v5.iot.model.v20180120.GetSolutionVoiceResponse.Data.Items;
...
public class GetSolutionVoiceResponseUnmarshaller {
	...
	public static GetSolutionVoiceResponse unmarshall(GetSolutionVoiceResponse getSolutionVoiceResponse, UnmarshallerContext _ctx) {
		...
		List<Items> speechModelVoiceVOListList = new ArrayList<Items>();
		for (int i = 0; i < _ctx.lengthValue("GetSolutionVoiceResponse.Data.SpeechModelVoiceVOList.Length"); i++) {
			...
			speechModelVoiceVOListList.add(items);
		}
		data.setSpeechModelVoiceVOList(speechModelVoiceVOListList);

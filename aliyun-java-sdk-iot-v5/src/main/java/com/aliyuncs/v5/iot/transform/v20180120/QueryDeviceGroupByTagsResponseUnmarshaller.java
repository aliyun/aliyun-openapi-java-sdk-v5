...
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceGroupByTagsResponse;
import com.aliyuncs.v5.iot.model.v20180120.QueryDeviceGroupByTagsResponse.DeviceGroup;
...
public class QueryDeviceGroupByTagsResponseUnmarshaller {
	...
	public static QueryDeviceGroupByTagsResponse unmarshall(QueryDeviceGroupByTagsResponse queryDeviceGroupByTagsResponse, UnmarshallerContext _ctx) {
		...
		List<DeviceGroup> dataList = new ArrayList<DeviceGroup>();
		for (int i = 0; i < _ctx.lengthValue("QueryDeviceGroupByTagsResponse.Data.Length"); i++) {
			...
			dataList.add(deviceGroup);
		}
		queryDeviceGroupByTagsResponse.setData(dataList);

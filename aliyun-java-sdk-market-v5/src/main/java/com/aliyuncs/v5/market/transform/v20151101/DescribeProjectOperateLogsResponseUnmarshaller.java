...
import com.aliyuncs.v5.market.model.v20151101.DescribeProjectOperateLogsResponse;
import com.aliyuncs.v5.market.model.v20151101.DescribeProjectOperateLogsResponse.ProjectMessage;
...
public class DescribeProjectOperateLogsResponseUnmarshaller {
	...
	public static DescribeProjectOperateLogsResponse unmarshall(DescribeProjectOperateLogsResponse describeProjectOperateLogsResponse, UnmarshallerContext _ctx) {
		...
		List<ProjectMessage> resultList = new ArrayList<ProjectMessage>();
		for (int i = 0; i < _ctx.lengthValue("DescribeProjectOperateLogsResponse.Result.Length"); i++) {
			...
			resultList.add(projectMessage);
		}
		describeProjectOperateLogsResponse.setResult(resultList);

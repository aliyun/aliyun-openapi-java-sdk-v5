...
import com.aliyuncs.v5.market.model.v20151101.DescribeInstancesResponse;
import com.aliyuncs.v5.market.model.v20151101.DescribeInstancesResponse.InstanceItem;
...
public class DescribeInstancesResponseUnmarshaller {
	...
	public static DescribeInstancesResponse unmarshall(DescribeInstancesResponse describeInstancesResponse, UnmarshallerContext _ctx) {
		...
		List<InstanceItem> instanceItemsList = new ArrayList<InstanceItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeInstancesResponse.InstanceItems.Length"); i++) {
			...
			instanceItemsList.add(instanceItem);
		}
		describeInstancesResponse.setInstanceItems(instanceItemsList);

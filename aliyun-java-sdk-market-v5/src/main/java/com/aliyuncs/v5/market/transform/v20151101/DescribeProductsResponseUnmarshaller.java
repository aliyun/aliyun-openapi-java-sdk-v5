...
import com.aliyuncs.v5.market.model.v20151101.DescribeProductsResponse;
import com.aliyuncs.v5.market.model.v20151101.DescribeProductsResponse.ProductItem;
...
public class DescribeProductsResponseUnmarshaller {
	...
	public static DescribeProductsResponse unmarshall(DescribeProductsResponse describeProductsResponse, UnmarshallerContext _ctx) {
		...
		describeProductsResponse.setProductItems(productItemsList);

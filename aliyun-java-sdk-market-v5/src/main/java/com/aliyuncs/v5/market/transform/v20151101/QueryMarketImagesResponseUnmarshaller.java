...
import com.aliyuncs.v5.market.model.v20151101.QueryMarketImagesResponse;
import com.aliyuncs.v5.market.model.v20151101.QueryMarketImagesResponse.ImageProduct;
import com.aliyuncs.v5.market.model.v20151101.QueryMarketImagesResponse.ImageProduct.Image;
import com.aliyuncs.v5.market.model.v20151101.QueryMarketImagesResponse.ImageProduct.Image.DiskDeviceMapping;
import com.aliyuncs.v5.market.model.v20151101.QueryMarketImagesResponse.ImageProduct.PriceInfo;
import com.aliyuncs.v5.market.model.v20151101.QueryMarketImagesResponse.ImageProduct.PriceInfo.Order;
import com.aliyuncs.v5.market.model.v20151101.QueryMarketImagesResponse.ImageProduct.PriceInfo.Rule;
import com.aliyuncs.v5.market.model.v20151101.QueryMarketImagesResponse.ImageProduct.Quota;
...
public class QueryMarketImagesResponseUnmarshaller {
	...
	public static QueryMarketImagesResponse unmarshall(QueryMarketImagesResponse queryMarketImagesResponse, UnmarshallerContext _ctx) {
		...
		List<ImageProduct> resultList = new ArrayList<ImageProduct>();
		for (int i = 0; i < _ctx.lengthValue("QueryMarketImagesResponse.Result.Length"); i++) {
			...
			for (int j = 0; j < _ctx.lengthValue("QueryMarketImagesResponse.Result["+ i +"].Images.Length"); j++) {
				...
				List<DiskDeviceMapping> diskDeviceMappingsList = new ArrayList<DiskDeviceMapping>();
				for (int k = 0; k < _ctx.lengthValue("QueryMarketImagesResponse.Result["+ i +"].Images["+ j +"].DiskDeviceMappings.Length"); k++) {
					...
					diskDeviceMappingsList.add(diskDeviceMapping);
				}
				image.setDiskDeviceMappings(diskDeviceMappingsList);

				imagesList.add(image);
			}
			imageProduct.setImages(imagesList);

			resultList.add(imageProduct);
		}
		queryMarketImagesResponse.setResult(resultList);

...
import com.aliyuncs.v5.market.model.v20151101.DescribeLicenseResponse;
import com.aliyuncs.v5.market.model.v20151101.DescribeLicenseResponse.License;
import com.aliyuncs.v5.market.model.v20151101.DescribeLicenseResponse.License.ExtendInfo;
import com.aliyuncs.v5.market.model.v20151101.DescribeLicenseResponse.License.LicenseAttribute;
...
public class DescribeLicenseResponseUnmarshaller {
	...
	public static DescribeLicenseResponse unmarshall(DescribeLicenseResponse describeLicenseResponse, UnmarshallerContext _ctx) {
		...
		List<LicenseAttribute> extendArrayList = new ArrayList<LicenseAttribute>();
		for (int i = 0; i < _ctx.lengthValue("DescribeLicenseResponse.License.ExtendArray.Length"); i++) {
			...
			extendArrayList.add(licenseAttribute);
		}
		license.setExtendArray(extendArrayList);

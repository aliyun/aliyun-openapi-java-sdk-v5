...
import com.aliyuncs.v5.market.model.v20151101.DescribeProjectAttachmentsResponse;
import com.aliyuncs.v5.market.model.v20151101.DescribeProjectAttachmentsResponse.ProjectAttachment;
...
public class DescribeProjectAttachmentsResponseUnmarshaller {
	...
	public static DescribeProjectAttachmentsResponse unmarshall(DescribeProjectAttachmentsResponse describeProjectAttachmentsResponse, UnmarshallerContext _ctx) {
		...
		List<ProjectAttachment> resultList = new ArrayList<ProjectAttachment>();
		for (int i = 0; i < _ctx.lengthValue("DescribeProjectAttachmentsResponse.Result.Length"); i++) {
			...
			resultList.add(projectAttachment);
		}
		describeProjectAttachmentsResponse.setResult(resultList);

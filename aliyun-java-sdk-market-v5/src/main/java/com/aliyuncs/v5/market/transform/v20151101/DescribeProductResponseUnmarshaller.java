...
import com.aliyuncs.v5.market.model.v20151101.DescribeProductResponse;
import com.aliyuncs.v5.market.model.v20151101.DescribeProductResponse.ProductExtra;
import com.aliyuncs.v5.market.model.v20151101.DescribeProductResponse.ProductSku;
import com.aliyuncs.v5.market.model.v20151101.DescribeProductResponse.ProductSku.Module;
import com.aliyuncs.v5.market.model.v20151101.DescribeProductResponse.ProductSku.Module.Property;
import com.aliyuncs.v5.market.model.v20151101.DescribeProductResponse.ProductSku.Module.Property.PropertyValue;
import com.aliyuncs.v5.market.model.v20151101.DescribeProductResponse.ProductSku.OrderPeriod;
import com.aliyuncs.v5.market.model.v20151101.DescribeProductResponse.ShopInfo;
import com.aliyuncs.v5.market.model.v20151101.DescribeProductResponse.ShopInfo.WangWang;
...
public class DescribeProductResponseUnmarshaller {
	...
	public static DescribeProductResponse unmarshall(DescribeProductResponse describeProductResponse, UnmarshallerContext _ctx) {
		...
		List<WangWang> wangWangsList = new ArrayList<WangWang>();
		for (int i = 0; i < _ctx.lengthValue("DescribeProductResponse.ShopInfo.WangWangs.Length"); i++) {
			...
			wangWangsList.add(wangWang);
		}
		shopInfo.setWangWangs(wangWangsList);
		describeProductResponse.setShopInfo(shopInfo);

		List<ProductSku> productSkusList = new ArrayList<ProductSku>();
		for (int i = 0; i < _ctx.lengthValue("DescribeProductResponse.ProductSkus.Length"); i++) {
			...
			List<OrderPeriod> orderPeriodsList = new ArrayList<OrderPeriod>();
			for (int j = 0; j < _ctx.lengthValue("DescribeProductResponse.ProductSkus["+ i +"].OrderPeriods.Length"); j++) {
				...
				orderPeriodsList.add(orderPeriod);
			}
			productSku.setOrderPeriods(orderPeriodsList);
			...
			for (int j = 0; j < _ctx.lengthValue("DescribeProductResponse.ProductSkus["+ i +"].Modules.Length"); j++) {
				...
				for (int k = 0; k < _ctx.lengthValue("DescribeProductResponse.ProductSkus["+ i +"].Modules["+ j +"].Properties.Length"); k++) {
					...
					property.setPropertyValues(propertyValuesList);

					propertiesList.add(property);
				}
				module.setProperties(propertiesList);

				modulesList.add(module);
			}
			productSku.setModules(modulesList);

			productSkusList.add(productSku);
		}
		describeProductResponse.setProductSkus(productSkusList);

		List<ProductExtra> productExtrasList = new ArrayList<ProductExtra>();
		for (int i = 0; i < _ctx.lengthValue("DescribeProductResponse.ProductExtras.Length"); i++) {
			...
			productExtrasList.add(productExtra);
		}
		describeProductResponse.setProductExtras(productExtrasList);

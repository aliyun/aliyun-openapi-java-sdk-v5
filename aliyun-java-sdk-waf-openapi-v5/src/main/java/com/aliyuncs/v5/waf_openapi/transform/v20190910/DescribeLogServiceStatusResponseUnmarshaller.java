...
import com.aliyuncs.v5.waf_openapi.model.v20190910.DescribeLogServiceStatusResponse;
import com.aliyuncs.v5.waf_openapi.model.v20190910.DescribeLogServiceStatusResponse.Status;
...
public class DescribeLogServiceStatusResponseUnmarshaller {
	...
	public static DescribeLogServiceStatusResponse unmarshall(DescribeLogServiceStatusResponse describeLogServiceStatusResponse, UnmarshallerContext _ctx) {
		...
		List<Status> domainStatusList = new ArrayList<Status>();
		...
		describeLogServiceStatusResponse.setDomainStatus(domainStatusList);

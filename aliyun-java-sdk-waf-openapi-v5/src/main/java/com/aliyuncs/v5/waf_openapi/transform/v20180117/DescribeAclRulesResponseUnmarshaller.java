...
import com.aliyuncs.v5.waf_openapi.model.v20180117.DescribeAclRulesResponse;
import com.aliyuncs.v5.waf_openapi.model.v20180117.DescribeAclRulesResponse.Result;
import com.aliyuncs.v5.waf_openapi.model.v20180117.DescribeAclRulesResponse.Result.AclRule;
import com.aliyuncs.v5.waf_openapi.model.v20180117.DescribeAclRulesResponse.Result.AclRule.Condition;
...
public class DescribeAclRulesResponseUnmarshaller {
	...
	public static DescribeAclRulesResponse unmarshall(DescribeAclRulesResponse describeAclRulesResponse, UnmarshallerContext _ctx) {
		...
		List<AclRule> aclRulesList = new ArrayList<AclRule>();
		for (int i = 0; i < _ctx.lengthValue("DescribeAclRulesResponse.Result.AclRules.Length"); i++) {
			...
			aclRule.setConditions(conditionsList);

			aclRulesList.add(aclRule);
		}
		result.setAclRules(aclRulesList);

...
import com.aliyuncs.v5.waf_openapi.model.v20190910.DescribeCertificatesResponse;
import com.aliyuncs.v5.waf_openapi.model.v20190910.DescribeCertificatesResponse.Certificate;
...
public class DescribeCertificatesResponseUnmarshaller {
	...
	public static DescribeCertificatesResponse unmarshall(DescribeCertificatesResponse describeCertificatesResponse, UnmarshallerContext _ctx) {
		...
		describeCertificatesResponse.setCertificates(certificatesList);

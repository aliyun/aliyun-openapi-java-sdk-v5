...
import com.aliyuncs.v5.waf_openapi.model.v20190910.DescribeInstanceInfosResponse;
import com.aliyuncs.v5.waf_openapi.model.v20190910.DescribeInstanceInfosResponse.InstanceInfo;
...
public class DescribeInstanceInfosResponseUnmarshaller {
	...
	public static DescribeInstanceInfosResponse unmarshall(DescribeInstanceInfosResponse describeInstanceInfosResponse, UnmarshallerContext _ctx) {
		...
		List<InstanceInfo> instanceInfosList = new ArrayList<InstanceInfo>();
		...
		describeInstanceInfosResponse.setInstanceInfos(instanceInfosList);

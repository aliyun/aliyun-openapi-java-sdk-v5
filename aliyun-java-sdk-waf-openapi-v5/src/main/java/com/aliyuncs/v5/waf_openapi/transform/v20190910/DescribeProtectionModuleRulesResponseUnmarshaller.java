...
import com.aliyuncs.v5.waf_openapi.model.v20190910.DescribeProtectionModuleRulesResponse;
import com.aliyuncs.v5.waf_openapi.model.v20190910.DescribeProtectionModuleRulesResponse.Rule;
...
public class DescribeProtectionModuleRulesResponseUnmarshaller {
	...
	public static DescribeProtectionModuleRulesResponse unmarshall(DescribeProtectionModuleRulesResponse describeProtectionModuleRulesResponse, UnmarshallerContext _ctx) {
		...
		describeProtectionModuleRulesResponse.setRules(rulesList);

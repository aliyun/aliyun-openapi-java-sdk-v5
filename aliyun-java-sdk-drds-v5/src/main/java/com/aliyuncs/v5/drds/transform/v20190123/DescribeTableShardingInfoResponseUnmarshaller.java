...
import com.aliyuncs.v5.drds.model.v20190123.DescribeTableShardingInfoResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeTableShardingInfoResponse.Data;
import com.aliyuncs.v5.drds.model.v20190123.DescribeTableShardingInfoResponse.Data.Column;
...
public class DescribeTableShardingInfoResponseUnmarshaller {
	...
	public static DescribeTableShardingInfoResponse unmarshall(DescribeTableShardingInfoResponse describeTableShardingInfoResponse, UnmarshallerContext _ctx) {
		...
		List<Column> columnListList = new ArrayList<Column>();

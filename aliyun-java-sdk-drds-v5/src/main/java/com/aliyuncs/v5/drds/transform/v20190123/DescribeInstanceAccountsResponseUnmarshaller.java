...
import com.aliyuncs.v5.drds.model.v20190123.DescribeInstanceAccountsResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeInstanceAccountsResponse.InstanceAccount;
import com.aliyuncs.v5.drds.model.v20190123.DescribeInstanceAccountsResponse.InstanceAccount.DbPrivilege;
...
public class DescribeInstanceAccountsResponseUnmarshaller {
	...
	public static DescribeInstanceAccountsResponse unmarshall(DescribeInstanceAccountsResponse describeInstanceAccountsResponse, UnmarshallerContext _ctx) {
		...
		List<InstanceAccount> instanceAccountsList = new ArrayList<InstanceAccount>();
		for (int i = 0; i < _ctx.lengthValue("DescribeInstanceAccountsResponse.InstanceAccounts.Length"); i++) {
			...
			List<DbPrivilege> dbPrivilegesList = new ArrayList<DbPrivilege>();
			for (int j = 0; j < _ctx.lengthValue("DescribeInstanceAccountsResponse.InstanceAccounts["+ i +"].DbPrivileges.Length"); j++) {
				...
				dbPrivilegesList.add(dbPrivilege);
			}
			instanceAccount.setDbPrivileges(dbPrivilegesList);

			instanceAccountsList.add(instanceAccount);
		}
		describeInstanceAccountsResponse.setInstanceAccounts(instanceAccountsList);

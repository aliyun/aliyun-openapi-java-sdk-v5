...
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsParamsResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsParamsResponse.ListItem;
...
public class DescribeDrdsParamsResponseUnmarshaller {
	...
	public static DescribeDrdsParamsResponse unmarshall(DescribeDrdsParamsResponse describeDrdsParamsResponse, UnmarshallerContext _ctx) {
		...
		describeDrdsParamsResponse.setList(listList);

...
import com.aliyuncs.v5.drds.model.v20190123.DescribeShardTaskListResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeShardTaskListResponse.ListItem;
...
public class DescribeShardTaskListResponseUnmarshaller {
	...
	public static DescribeShardTaskListResponse unmarshall(DescribeShardTaskListResponse describeShardTaskListResponse, UnmarshallerContext _ctx) {
		...
		describeShardTaskListResponse.setList(listList);

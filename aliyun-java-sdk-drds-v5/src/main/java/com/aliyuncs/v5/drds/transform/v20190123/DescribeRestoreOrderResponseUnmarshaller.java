...
import com.aliyuncs.v5.drds.model.v20190123.DescribeRestoreOrderResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeRestoreOrderResponse.RestoreOrderDO;
import com.aliyuncs.v5.drds.model.v20190123.DescribeRestoreOrderResponse.RestoreOrderDO.DrdsOrderDOListItem;
import com.aliyuncs.v5.drds.model.v20190123.DescribeRestoreOrderResponse.RestoreOrderDO.PolarOrderDOListItem;
import com.aliyuncs.v5.drds.model.v20190123.DescribeRestoreOrderResponse.RestoreOrderDO.RdsOrderDOListItem;
...
public class DescribeRestoreOrderResponseUnmarshaller {
	...
	public static DescribeRestoreOrderResponse unmarshall(DescribeRestoreOrderResponse describeRestoreOrderResponse, UnmarshallerContext _ctx) {
		...
		List<DrdsOrderDOListItem> drdsOrderDOListList = new ArrayList<DrdsOrderDOListItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRestoreOrderResponse.RestoreOrderDO.DrdsOrderDOList.Length"); i++) {
			...
			drdsOrderDOListList.add(drdsOrderDOListItem);
		}
		restoreOrderDO.setDrdsOrderDOList(drdsOrderDOListList);

		List<RdsOrderDOListItem> rdsOrderDOListList = new ArrayList<RdsOrderDOListItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRestoreOrderResponse.RestoreOrderDO.RdsOrderDOList.Length"); i++) {
			...
			rdsOrderDOListList.add(rdsOrderDOListItem);
		}
		restoreOrderDO.setRdsOrderDOList(rdsOrderDOListList);

		List<PolarOrderDOListItem> polarOrderDOListList = new ArrayList<PolarOrderDOListItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRestoreOrderResponse.RestoreOrderDO.PolarOrderDOList.Length"); i++) {
			...
			polarOrderDOListList.add(polarOrderDOListItem);
		}
		restoreOrderDO.setPolarOrderDOList(polarOrderDOListList);

...
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsInstancesResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsInstancesResponse.Instance;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsInstancesResponse.Instance.Vip;
...
public class DescribeDrdsInstancesResponseUnmarshaller {
	...
	public static DescribeDrdsInstancesResponse unmarshall(DescribeDrdsInstancesResponse describeDrdsInstancesResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeDrdsInstancesResponse.Instances.Length"); i++) {
			...
			List<Vip> vipsList = new ArrayList<Vip>();
			...
			instance.setVips(vipsList);

			instancesList.add(instance);
		}
		describeDrdsInstancesResponse.setInstances(instancesList);

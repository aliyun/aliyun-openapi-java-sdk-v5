...
import com.aliyuncs.v5.drds.model.v20190123.DescribeMyCatReportInfoResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeMyCatReportInfoResponse.EvaluateReportInfo;
import com.aliyuncs.v5.drds.model.v20190123.DescribeMyCatReportInfoResponse.EvaluateReportInfo.DbInfo;
import com.aliyuncs.v5.drds.model.v20190123.DescribeMyCatReportInfoResponse.EvaluateReportInfo.DbInfo.TableInfo;
...
public class DescribeMyCatReportInfoResponseUnmarshaller {
	...
	public static DescribeMyCatReportInfoResponse unmarshall(DescribeMyCatReportInfoResponse describeMyCatReportInfoResponse, UnmarshallerContext _ctx) {
		...
		List<TableInfo> tableInfoListList = new ArrayList<TableInfo>();
		for (int i = 0; i < _ctx.lengthValue("DescribeMyCatReportInfoResponse.EvaluateReportInfo.DbInfo.TableInfoList.Length"); i++) {
			...
			tableInfoListList.add(tableInfo);
		}
		dbInfo.setTableInfoList(tableInfoListList);

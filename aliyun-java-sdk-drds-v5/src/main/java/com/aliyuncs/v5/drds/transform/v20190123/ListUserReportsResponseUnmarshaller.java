...
import com.aliyuncs.v5.drds.model.v20190123.ListUserReportsResponse;
import com.aliyuncs.v5.drds.model.v20190123.ListUserReportsResponse.SqlComparisonReport;
import com.aliyuncs.v5.drds.model.v20190123.ListUserReportsResponse.SqlComparisonReport.ExecuteDetail;
...
public class ListUserReportsResponseUnmarshaller {
	...
	public static ListUserReportsResponse unmarshall(ListUserReportsResponse listUserReportsResponse, UnmarshallerContext _ctx) {
		...
		List<ExecuteDetail> executeDetailListList = new ArrayList<ExecuteDetail>();
		for (int i = 0; i < _ctx.lengthValue("ListUserReportsResponse.sqlComparisonReport.executeDetailList.Length"); i++) {
			...
			executeDetailListList.add(executeDetail);
		}
		sqlComparisonReport.setExecuteDetailList(executeDetailListList);

...
import com.aliyuncs.v5.drds.model.v20190123.ListVersionsResponse;
import com.aliyuncs.v5.drds.model.v20190123.ListVersionsResponse.VersionsItem;
...
public class ListVersionsResponseUnmarshaller {
	...
	public static ListVersionsResponse unmarshall(ListVersionsResponse listVersionsResponse, UnmarshallerContext _ctx) {
		...
		List<VersionsItem> versionsList = new ArrayList<VersionsItem>();
		for (int i = 0; i < _ctx.lengthValue("ListVersionsResponse.versions.Length"); i++) {
			...
			versionsList.add(versionsItem);
		}
		listVersionsResponse.setVersions(versionsList);

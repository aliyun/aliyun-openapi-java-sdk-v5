...
import com.aliyuncs.v5.drds.model.v20190123.DescribeRecycleBinTablesResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeRecycleBinTablesResponse.DataItem;
...
public class DescribeRecycleBinTablesResponseUnmarshaller {
	...
	public static DescribeRecycleBinTablesResponse unmarshall(DescribeRecycleBinTablesResponse describeRecycleBinTablesResponse, UnmarshallerContext _ctx) {
		...
		describeRecycleBinTablesResponse.setData(dataList);

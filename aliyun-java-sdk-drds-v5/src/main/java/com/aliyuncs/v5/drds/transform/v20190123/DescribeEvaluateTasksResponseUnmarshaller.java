...
import com.aliyuncs.v5.drds.model.v20190123.DescribeEvaluateTasksResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeEvaluateTasksResponse.EvaluateTask;
...
public class DescribeEvaluateTasksResponseUnmarshaller {
	...
	public static DescribeEvaluateTasksResponse unmarshall(DescribeEvaluateTasksResponse describeEvaluateTasksResponse, UnmarshallerContext _ctx) {
		...
		List<EvaluateTask> dataList = new ArrayList<EvaluateTask>();
		for (int i = 0; i < _ctx.lengthValue("DescribeEvaluateTasksResponse.Data.Length"); i++) {
			...
			dataList.add(evaluateTask);
		}
		describeEvaluateTasksResponse.setData(dataList);

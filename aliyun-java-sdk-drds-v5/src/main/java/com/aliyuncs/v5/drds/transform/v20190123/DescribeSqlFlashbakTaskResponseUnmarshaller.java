...
import com.aliyuncs.v5.drds.model.v20190123.DescribeSqlFlashbakTaskResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeSqlFlashbakTaskResponse.SqlFlashbackTask;
...
public class DescribeSqlFlashbakTaskResponseUnmarshaller {
	...
	public static DescribeSqlFlashbakTaskResponse unmarshall(DescribeSqlFlashbakTaskResponse describeSqlFlashbakTaskResponse, UnmarshallerContext _ctx) {
		...
		List<SqlFlashbackTask> sqlFlashbackTasksList = new ArrayList<SqlFlashbackTask>();
		for (int i = 0; i < _ctx.lengthValue("DescribeSqlFlashbakTaskResponse.SqlFlashbackTasks.Length"); i++) {
			...
			sqlFlashbackTasksList.add(sqlFlashbackTask);
		}
		describeSqlFlashbakTaskResponse.setSqlFlashbackTasks(sqlFlashbackTasksList);

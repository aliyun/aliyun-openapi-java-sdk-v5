...
import com.aliyuncs.v5.drds.model.v20190123.DescribeDataExportTasksResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDataExportTasksResponse.DataExportTask;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDataExportTasksResponse.DataExportTask.JingweiProgress;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDataExportTasksResponse.DataExportTask.JingweiProgress.Full;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDataExportTasksResponse.DataExportTask.JingweiProgress.Increment;
...
public class DescribeDataExportTasksResponseUnmarshaller {
	...
	public static DescribeDataExportTasksResponse unmarshall(DescribeDataExportTasksResponse describeDataExportTasksResponse, UnmarshallerContext _ctx) {
		...
		List<DataExportTask> dataList = new ArrayList<DataExportTask>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDataExportTasksResponse.Data.Length"); i++) {
			...
			dataList.add(dataExportTask);
		}
		describeDataExportTasksResponse.setData(dataList);

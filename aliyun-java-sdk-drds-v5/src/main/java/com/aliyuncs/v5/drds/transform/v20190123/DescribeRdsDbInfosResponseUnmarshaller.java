...
import com.aliyuncs.v5.drds.model.v20190123.DescribeRdsDbInfosResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeRdsDbInfosResponse.Database;
...
public class DescribeRdsDbInfosResponseUnmarshaller {
	...
	public static DescribeRdsDbInfosResponse unmarshall(DescribeRdsDbInfosResponse describeRdsDbInfosResponse, UnmarshallerContext _ctx) {
		...
		describeRdsDbInfosResponse.setDatabases(databasesList);

...
import com.aliyuncs.v5.drds.model.v20190123.ValidateShardTaskResponse;
import com.aliyuncs.v5.drds.model.v20190123.ValidateShardTaskResponse.ListItem;
...
public class ValidateShardTaskResponseUnmarshaller {
	...
	public static ValidateShardTaskResponse unmarshall(ValidateShardTaskResponse validateShardTaskResponse, UnmarshallerContext _ctx) {
		...
		validateShardTaskResponse.setList(listList);

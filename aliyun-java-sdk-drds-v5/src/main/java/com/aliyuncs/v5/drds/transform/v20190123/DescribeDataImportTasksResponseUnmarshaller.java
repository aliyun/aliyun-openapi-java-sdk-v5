...
import com.aliyuncs.v5.drds.model.v20190123.DescribeDataImportTasksResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDataImportTasksResponse.DataImportTask;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDataImportTasksResponse.DataImportTask.JingweiProgress;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDataImportTasksResponse.DataImportTask.JingweiProgress.Full;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDataImportTasksResponse.DataImportTask.JingweiProgress.Increment;
...
public class DescribeDataImportTasksResponseUnmarshaller {
	...
	public static DescribeDataImportTasksResponse unmarshall(DescribeDataImportTasksResponse describeDataImportTasksResponse, UnmarshallerContext _ctx) {
		...
		List<DataImportTask> dataList = new ArrayList<DataImportTask>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDataImportTasksResponse.Data.Length"); i++) {
			...
			dataList.add(dataImportTask);
		}
		describeDataImportTasksResponse.setData(dataList);

...
import com.aliyuncs.v5.drds.model.v20190123.DescribeDbInstanceDbsResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDbInstanceDbsResponse.Database;
...
public class DescribeDbInstanceDbsResponseUnmarshaller {
	...
	public static DescribeDbInstanceDbsResponse unmarshall(DescribeDbInstanceDbsResponse describeDbInstanceDbsResponse, UnmarshallerContext _ctx) {
		...
		describeDbInstanceDbsResponse.setDatabases(databasesList);

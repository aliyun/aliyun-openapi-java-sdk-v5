...
import com.aliyuncs.v5.drds.model.v20190123.DescribeTableListByTypeResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeTableListByTypeResponse.ListItem;
...
public class DescribeTableListByTypeResponseUnmarshaller {
	...
	public static DescribeTableListByTypeResponse unmarshall(DescribeTableListByTypeResponse describeTableListByTypeResponse, UnmarshallerContext _ctx) {
		...
		describeTableListByTypeResponse.setList(listList);

...
import com.aliyuncs.v5.drds.model.v20171016.DescribeDrdsDBsResponse;
import com.aliyuncs.v5.drds.model.v20171016.DescribeDrdsDBsResponse.Db;
...
public class DescribeDrdsDBsResponseUnmarshaller {
	...
	public static DescribeDrdsDBsResponse unmarshall(DescribeDrdsDBsResponse describeDrdsDBsResponse, UnmarshallerContext _ctx) {
		...
		describeDrdsDBsResponse.setData(dataList);

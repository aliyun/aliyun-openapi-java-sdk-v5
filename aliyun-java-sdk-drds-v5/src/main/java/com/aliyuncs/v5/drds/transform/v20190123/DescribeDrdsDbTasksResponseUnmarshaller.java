...
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsDbTasksResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsDbTasksResponse.Task;
...
public class DescribeDrdsDbTasksResponseUnmarshaller {
	...
	public static DescribeDrdsDbTasksResponse unmarshall(DescribeDrdsDbTasksResponse describeDrdsDbTasksResponse, UnmarshallerContext _ctx) {
		...
		describeDrdsDbTasksResponse.setTasks(tasksList);

...
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsShardingDbsResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsShardingDbsResponse.ShardingDb;
...
public class DescribeDrdsShardingDbsResponseUnmarshaller {
	...
	public static DescribeDrdsShardingDbsResponse unmarshall(DescribeDrdsShardingDbsResponse describeDrdsShardingDbsResponse, UnmarshallerContext _ctx) {
		...
		List<ShardingDb> shardingDbsList = new ArrayList<ShardingDb>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDrdsShardingDbsResponse.ShardingDbs.Length"); i++) {
			...
			shardingDbsList.add(shardingDb);
		}
		describeDrdsShardingDbsResponse.setShardingDbs(shardingDbsList);

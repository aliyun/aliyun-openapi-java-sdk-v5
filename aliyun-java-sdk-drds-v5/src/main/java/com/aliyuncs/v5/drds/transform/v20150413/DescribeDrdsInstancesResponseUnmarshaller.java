...
import com.aliyuncs.v5.drds.model.v20150413.DescribeDrdsInstancesResponse;
import com.aliyuncs.v5.drds.model.v20150413.DescribeDrdsInstancesResponse.Instance;
import com.aliyuncs.v5.drds.model.v20150413.DescribeDrdsInstancesResponse.Instance.Vip;
...
public class DescribeDrdsInstancesResponseUnmarshaller {
	...
	public static DescribeDrdsInstancesResponse unmarshall(DescribeDrdsInstancesResponse describeDrdsInstancesResponse, UnmarshallerContext _ctx) {
		...
		describeDrdsInstancesResponse.setData(dataList);

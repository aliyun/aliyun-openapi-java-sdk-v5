...
import com.aliyuncs.v5.drds.model.v20190123.DescribeRdsInstInfosResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeRdsInstInfosResponse.DBInstance;
...
public class DescribeRdsInstInfosResponseUnmarshaller {
	...
	public static DescribeRdsInstInfosResponse unmarshall(DescribeRdsInstInfosResponse describeRdsInstInfosResponse, UnmarshallerContext _ctx) {
		...
		describeRdsInstInfosResponse.setItems(itemsList);

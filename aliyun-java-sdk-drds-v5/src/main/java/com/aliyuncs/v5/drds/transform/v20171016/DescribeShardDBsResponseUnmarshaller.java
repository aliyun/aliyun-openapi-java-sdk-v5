...
import com.aliyuncs.v5.drds.model.v20171016.DescribeShardDBsResponse;
import com.aliyuncs.v5.drds.model.v20171016.DescribeShardDBsResponse.DbIntancePair;
...
public class DescribeShardDBsResponseUnmarshaller {
	...
	public static DescribeShardDBsResponse unmarshall(DescribeShardDBsResponse describeShardDBsResponse, UnmarshallerContext _ctx) {
		...
		List<DbIntancePair> dataList = new ArrayList<DbIntancePair>();
		for (int i = 0; i < _ctx.lengthValue("DescribeShardDBsResponse.Data.Length"); i++) {
			...
			dataList.add(dbIntancePair);
		}
		describeShardDBsResponse.setData(dataList);

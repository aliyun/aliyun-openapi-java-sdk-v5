...
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsDbInstancesResponse;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsDbInstancesResponse.DbInstance;
import com.aliyuncs.v5.drds.model.v20190123.DescribeDrdsDbInstancesResponse.DbInstance.ReadOnlyInstance;
...
public class DescribeDrdsDbInstancesResponseUnmarshaller {
	...
	public static DescribeDrdsDbInstancesResponse unmarshall(DescribeDrdsDbInstancesResponse describeDrdsDbInstancesResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeDrdsDbInstancesResponse.DbInstances.Length"); i++) {
			...
			List<ReadOnlyInstance> readOnlyInstancesList = new ArrayList<ReadOnlyInstance>();
			for (int j = 0; j < _ctx.lengthValue("DescribeDrdsDbInstancesResponse.DbInstances["+ i +"].ReadOnlyInstances.Length"); j++) {
				...
				readOnlyInstancesList.add(readOnlyInstance);
			}
			dbInstance.setReadOnlyInstances(readOnlyInstancesList);

			dbInstancesList.add(dbInstance);
		}
		describeDrdsDbInstancesResponse.setDbInstances(dbInstancesList);

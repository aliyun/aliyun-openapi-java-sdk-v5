...
import com.aliyuncs.v5.imagerecog.model.v20190930.RecognizeLogoResponse;
import com.aliyuncs.v5.imagerecog.model.v20190930.RecognizeLogoResponse.Data;
import com.aliyuncs.v5.imagerecog.model.v20190930.RecognizeLogoResponse.Data.Element;
import com.aliyuncs.v5.imagerecog.model.v20190930.RecognizeLogoResponse.Data.Element.Result;
import com.aliyuncs.v5.imagerecog.model.v20190930.RecognizeLogoResponse.Data.Element.Result.LogoData;
	...
	public static RecognizeLogoResponse unmarshall(RecognizeLogoResponse recognizeLogoResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("RecognizeLogoResponse.Data.Elements.Length"); i++) {
			...
			for (int j = 0; j < _ctx.lengthValue("RecognizeLogoResponse.Data.Elements["+ i +"].Results.Length"); j++) {
				...
				List<LogoData> logosDataList = new ArrayList<LogoData>();
				for (int k = 0; k < _ctx.lengthValue("RecognizeLogoResponse.Data.Elements["+ i +"].Results["+ j +"].LogosData.Length"); k++) {
					...
					logosDataList.add(logoData);
				}
				result.setLogosData(logosDataList);

				resultsList.add(result);
			}
			element.setResults(resultsList);

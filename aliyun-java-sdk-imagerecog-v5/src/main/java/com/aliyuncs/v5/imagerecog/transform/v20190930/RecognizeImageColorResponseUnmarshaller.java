...
import com.aliyuncs.v5.imagerecog.model.v20190930.RecognizeImageColorResponse;
import com.aliyuncs.v5.imagerecog.model.v20190930.RecognizeImageColorResponse.Data;
import com.aliyuncs.v5.imagerecog.model.v20190930.RecognizeImageColorResponse.Data.ColorTemplate;
...
public class RecognizeImageColorResponseUnmarshaller {
	...
	public static RecognizeImageColorResponse unmarshall(RecognizeImageColorResponse recognizeImageColorResponse, UnmarshallerContext _ctx) {
		...
		List<ColorTemplate> colorTemplateListList = new ArrayList<ColorTemplate>();
		for (int i = 0; i < _ctx.lengthValue("RecognizeImageColorResponse.Data.ColorTemplateList.Length"); i++) {
			...
			colorTemplateListList.add(colorTemplate);
		}
		data.setColorTemplateList(colorTemplateListList);

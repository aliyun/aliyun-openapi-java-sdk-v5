...
import com.aliyuncs.v5.dds.model.v20151201.DescribeRoleZoneInfoResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeRoleZoneInfoResponse.ZoneInfo;
...
public class DescribeRoleZoneInfoResponseUnmarshaller {
	...
	public static DescribeRoleZoneInfoResponse unmarshall(DescribeRoleZoneInfoResponse describeRoleZoneInfoResponse, UnmarshallerContext _ctx) {
		...
		List<ZoneInfo> zoneInfosList = new ArrayList<ZoneInfo>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRoleZoneInfoResponse.ZoneInfos.Length"); i++) {
			...
			zoneInfosList.add(zoneInfo);
		}
		describeRoleZoneInfoResponse.setZoneInfos(zoneInfosList);

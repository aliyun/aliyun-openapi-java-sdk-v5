...
import com.aliyuncs.v5.dds.model.v20151201.DescribeAuditFilesResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeAuditFilesResponse.LogFile;
...
public class DescribeAuditFilesResponseUnmarshaller {
	...
	public static DescribeAuditFilesResponse unmarshall(DescribeAuditFilesResponse describeAuditFilesResponse, UnmarshallerContext _ctx) {
		...
		describeAuditFilesResponse.setItems(itemsList);

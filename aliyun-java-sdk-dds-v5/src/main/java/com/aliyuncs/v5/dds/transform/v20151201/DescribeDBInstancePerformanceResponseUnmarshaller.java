...
import com.aliyuncs.v5.dds.model.v20151201.DescribeDBInstancePerformanceResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeDBInstancePerformanceResponse.PerformanceKey;
import com.aliyuncs.v5.dds.model.v20151201.DescribeDBInstancePerformanceResponse.PerformanceKey.PerformanceValue;
...
public class DescribeDBInstancePerformanceResponseUnmarshaller {
	...
	public static DescribeDBInstancePerformanceResponse unmarshall(DescribeDBInstancePerformanceResponse describeDBInstancePerformanceResponse, UnmarshallerContext _ctx) {
		...
		List<PerformanceKey> performanceKeysList = new ArrayList<PerformanceKey>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDBInstancePerformanceResponse.PerformanceKeys.Length"); i++) {
			...
			List<PerformanceValue> performanceValuesList = new ArrayList<PerformanceValue>();
			for (int j = 0; j < _ctx.lengthValue("DescribeDBInstancePerformanceResponse.PerformanceKeys["+ i +"].PerformanceValues.Length"); j++) {
				...
				performanceValuesList.add(performanceValue);
			}
			performanceKey.setPerformanceValues(performanceValuesList);

			performanceKeysList.add(performanceKey);
		}
		describeDBInstancePerformanceResponse.setPerformanceKeys(performanceKeysList);

...
import com.aliyuncs.v5.dds.model.v20151201.DescribeSecurityGroupConfigurationResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeSecurityGroupConfigurationResponse.RdsEcsSecurityGroupRel;
...
public class DescribeSecurityGroupConfigurationResponseUnmarshaller {
	...
	public static DescribeSecurityGroupConfigurationResponse unmarshall(DescribeSecurityGroupConfigurationResponse describeSecurityGroupConfigurationResponse, UnmarshallerContext _ctx) {
		...
		List<RdsEcsSecurityGroupRel> itemsList = new ArrayList<RdsEcsSecurityGroupRel>();
		for (int i = 0; i < _ctx.lengthValue("DescribeSecurityGroupConfigurationResponse.Items.Length"); i++) {
			...
			itemsList.add(rdsEcsSecurityGroupRel);
		}
		describeSecurityGroupConfigurationResponse.setItems(itemsList);

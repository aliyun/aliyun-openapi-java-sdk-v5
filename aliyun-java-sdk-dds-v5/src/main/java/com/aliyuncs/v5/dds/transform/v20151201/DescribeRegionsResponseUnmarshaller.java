...
import com.aliyuncs.v5.dds.model.v20151201.DescribeRegionsResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeRegionsResponse.DdsRegion;
import com.aliyuncs.v5.dds.model.v20151201.DescribeRegionsResponse.DdsRegion.Zone;
...
public class DescribeRegionsResponseUnmarshaller {
	...
	public static DescribeRegionsResponse unmarshall(DescribeRegionsResponse describeRegionsResponse, UnmarshallerContext _ctx) {
		...
		List<DdsRegion> regionsList = new ArrayList<DdsRegion>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRegionsResponse.Regions.Length"); i++) {
			...
			ddsRegion.setZones(zonesList);

			regionsList.add(ddsRegion);
		}

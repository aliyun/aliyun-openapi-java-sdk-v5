...
import com.aliyuncs.v5.dds.model.v20151201.DescribeBackupsResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeBackupsResponse.Backup;
...
public class DescribeBackupsResponseUnmarshaller {
	...
	public static DescribeBackupsResponse unmarshall(DescribeBackupsResponse describeBackupsResponse, UnmarshallerContext _ctx) {
		...
		describeBackupsResponse.setBackups(backupsList);

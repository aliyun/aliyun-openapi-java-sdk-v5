...
import com.aliyuncs.v5.dds.model.v20151201.DescribeIndexRecommendationResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeIndexRecommendationResponse.Analyzation;
import com.aliyuncs.v5.dds.model.v20151201.DescribeIndexRecommendationResponse.Analyzation.Recommendation;
...
public class DescribeIndexRecommendationResponseUnmarshaller {
	...
	public static DescribeIndexRecommendationResponse unmarshall(DescribeIndexRecommendationResponse describeIndexRecommendationResponse, UnmarshallerContext _ctx) {
		...
		List<Analyzation> analyzationsList = new ArrayList<Analyzation>();
		for (int i = 0; i < _ctx.lengthValue("DescribeIndexRecommendationResponse.Analyzations.Length"); i++) {
			...
			List<Recommendation> indexRecommendationsList = new ArrayList<Recommendation>();
			for (int j = 0; j < _ctx.lengthValue("DescribeIndexRecommendationResponse.Analyzations["+ i +"].IndexRecommendations.Length"); j++) {
				...
				indexRecommendationsList.add(recommendation);
			}
			analyzation.setIndexRecommendations(indexRecommendationsList);

			analyzationsList.add(analyzation);
		}
		describeIndexRecommendationResponse.setAnalyzations(analyzationsList);

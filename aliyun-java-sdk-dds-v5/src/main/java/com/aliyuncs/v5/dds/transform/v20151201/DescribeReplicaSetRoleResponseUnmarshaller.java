...
import com.aliyuncs.v5.dds.model.v20151201.DescribeReplicaSetRoleResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeReplicaSetRoleResponse.ReplicaSet;
...
public class DescribeReplicaSetRoleResponseUnmarshaller {
	...
	public static DescribeReplicaSetRoleResponse unmarshall(DescribeReplicaSetRoleResponse describeReplicaSetRoleResponse, UnmarshallerContext _ctx) {
		...
		describeReplicaSetRoleResponse.setReplicaSets(replicaSetsList);

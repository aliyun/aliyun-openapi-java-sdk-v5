...
import com.aliyuncs.v5.dds.model.v20151201.DescribeBackupDBsResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeBackupDBsResponse.Database;
...
public class DescribeBackupDBsResponseUnmarshaller {
	...
	public static DescribeBackupDBsResponse unmarshall(DescribeBackupDBsResponse describeBackupDBsResponse, UnmarshallerContext _ctx) {
		...
		describeBackupDBsResponse.setDatabases(databasesList);

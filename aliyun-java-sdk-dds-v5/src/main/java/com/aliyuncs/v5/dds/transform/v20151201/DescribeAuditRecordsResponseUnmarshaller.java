...
import com.aliyuncs.v5.dds.model.v20151201.DescribeAuditRecordsResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeAuditRecordsResponse.SQLRecord;
...
public class DescribeAuditRecordsResponseUnmarshaller {
	...
	public static DescribeAuditRecordsResponse unmarshall(DescribeAuditRecordsResponse describeAuditRecordsResponse, UnmarshallerContext _ctx) {
		...
		describeAuditRecordsResponse.setItems(itemsList);

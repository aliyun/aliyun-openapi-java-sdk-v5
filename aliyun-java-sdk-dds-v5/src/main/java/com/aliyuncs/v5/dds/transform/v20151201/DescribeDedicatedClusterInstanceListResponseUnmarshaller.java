...
import com.aliyuncs.v5.dds.model.v20151201.DescribeDedicatedClusterInstanceListResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeDedicatedClusterInstanceListResponse.DbInstance;
import com.aliyuncs.v5.dds.model.v20151201.DescribeDedicatedClusterInstanceListResponse.DbInstance.InstanceNodes;
...
public class DescribeDedicatedClusterInstanceListResponseUnmarshaller {
	...
	public static DescribeDedicatedClusterInstanceListResponse unmarshall(DescribeDedicatedClusterInstanceListResponse describeDedicatedClusterInstanceListResponse, UnmarshallerContext _ctx) {
		...
		List<DbInstance> instancesList = new ArrayList<DbInstance>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDedicatedClusterInstanceListResponse.Instances.Length"); i++) {
			...
			List<InstanceNodes> instanceNodeListList = new ArrayList<InstanceNodes>();
			for (int j = 0; j < _ctx.lengthValue("DescribeDedicatedClusterInstanceListResponse.Instances["+ i +"].InstanceNodeList.Length"); j++) {
				...
				instanceNodeListList.add(instanceNodes);
			}
			dbInstance.setInstanceNodeList(instanceNodeListList);

			instancesList.add(dbInstance);
		}
		describeDedicatedClusterInstanceListResponse.setInstances(instancesList);

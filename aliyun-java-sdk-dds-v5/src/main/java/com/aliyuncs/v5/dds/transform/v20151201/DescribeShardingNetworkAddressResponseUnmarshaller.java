...
import com.aliyuncs.v5.dds.model.v20151201.DescribeShardingNetworkAddressResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeShardingNetworkAddressResponse.CompatibleConnection;
import com.aliyuncs.v5.dds.model.v20151201.DescribeShardingNetworkAddressResponse.NetworkAddress;
...
public class DescribeShardingNetworkAddressResponseUnmarshaller {
	...
	public static DescribeShardingNetworkAddressResponse unmarshall(DescribeShardingNetworkAddressResponse describeShardingNetworkAddressResponse, UnmarshallerContext _ctx) {
		...
		List<NetworkAddress> networkAddressesList = new ArrayList<NetworkAddress>();
		for (int i = 0; i < _ctx.lengthValue("DescribeShardingNetworkAddressResponse.NetworkAddresses.Length"); i++) {
			...
			networkAddressesList.add(networkAddress);
		}
		describeShardingNetworkAddressResponse.setNetworkAddresses(networkAddressesList);

		List<CompatibleConnection> compatibleConnectionsList = new ArrayList<CompatibleConnection>();
		for (int i = 0; i < _ctx.lengthValue("DescribeShardingNetworkAddressResponse.CompatibleConnections.Length"); i++) {
			...
			compatibleConnectionsList.add(compatibleConnection);
		}
		describeShardingNetworkAddressResponse.setCompatibleConnections(compatibleConnectionsList);

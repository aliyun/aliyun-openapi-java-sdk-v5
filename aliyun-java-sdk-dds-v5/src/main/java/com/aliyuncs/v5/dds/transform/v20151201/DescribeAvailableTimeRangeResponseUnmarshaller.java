...
import com.aliyuncs.v5.dds.model.v20151201.DescribeAvailableTimeRangeResponse;
import com.aliyuncs.v5.dds.model.v20151201.DescribeAvailableTimeRangeResponse.TimeRangeItem;
...
public class DescribeAvailableTimeRangeResponseUnmarshaller {
	...
	public static DescribeAvailableTimeRangeResponse unmarshall(DescribeAvailableTimeRangeResponse describeAvailableTimeRangeResponse, UnmarshallerContext _ctx) {
		...
		List<TimeRangeItem> timeRangeList = new ArrayList<TimeRangeItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeAvailableTimeRangeResponse.TimeRange.Length"); i++) {
			...
			timeRangeList.add(timeRangeItem);
		}
		describeAvailableTimeRangeResponse.setTimeRange(timeRangeList);

...
import com.aliyuncs.v5.dbs.model.v20190306.DescribeRestoreTaskListResponse;
import com.aliyuncs.v5.dbs.model.v20190306.DescribeRestoreTaskListResponse.RestoreTaskDetail;
...
public class DescribeRestoreTaskListResponseUnmarshaller {
	...
	public static DescribeRestoreTaskListResponse unmarshall(DescribeRestoreTaskListResponse describeRestoreTaskListResponse, UnmarshallerContext _ctx) {
		...
		List<RestoreTaskDetail> itemsList = new ArrayList<RestoreTaskDetail>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRestoreTaskListResponse.Items.Length"); i++) {
			...
			itemsList.add(restoreTaskDetail);
		}
		describeRestoreTaskListResponse.setItems(itemsList);

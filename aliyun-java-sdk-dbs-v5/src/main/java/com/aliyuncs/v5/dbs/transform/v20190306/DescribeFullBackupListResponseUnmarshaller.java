...
import com.aliyuncs.v5.dbs.model.v20190306.DescribeFullBackupListResponse;
import com.aliyuncs.v5.dbs.model.v20190306.DescribeFullBackupListResponse.FullBackupFile;
...
public class DescribeFullBackupListResponseUnmarshaller {
	...
	public static DescribeFullBackupListResponse unmarshall(DescribeFullBackupListResponse describeFullBackupListResponse, UnmarshallerContext _ctx) {
		...
		List<FullBackupFile> itemsList = new ArrayList<FullBackupFile>();
		for (int i = 0; i < _ctx.lengthValue("DescribeFullBackupListResponse.Items.Length"); i++) {
			...
			itemsList.add(fullBackupFile);
		}
		describeFullBackupListResponse.setItems(itemsList);

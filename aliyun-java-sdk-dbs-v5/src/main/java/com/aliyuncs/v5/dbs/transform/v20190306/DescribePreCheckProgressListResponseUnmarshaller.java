...
import com.aliyuncs.v5.dbs.model.v20190306.DescribePreCheckProgressListResponse;
import com.aliyuncs.v5.dbs.model.v20190306.DescribePreCheckProgressListResponse.PreCheckProgressDetail;
...
public class DescribePreCheckProgressListResponseUnmarshaller {
	...
	public static DescribePreCheckProgressListResponse unmarshall(DescribePreCheckProgressListResponse describePreCheckProgressListResponse, UnmarshallerContext _ctx) {
		...
		List<PreCheckProgressDetail> itemsList = new ArrayList<PreCheckProgressDetail>();
		for (int i = 0; i < _ctx.lengthValue("DescribePreCheckProgressListResponse.Items.Length"); i++) {
			...
			itemsList.add(preCheckProgressDetail);
		}
		describePreCheckProgressListResponse.setItems(itemsList);

...
import com.aliyuncs.v5.dbs.model.v20190306.DescribeBackupSetDownloadTaskListResponse;
import com.aliyuncs.v5.dbs.model.v20190306.DescribeBackupSetDownloadTaskListResponse.BackupSetDownloadTaskDetail;
...
public class DescribeBackupSetDownloadTaskListResponseUnmarshaller {
	...
	public static DescribeBackupSetDownloadTaskListResponse unmarshall(DescribeBackupSetDownloadTaskListResponse describeBackupSetDownloadTaskListResponse, UnmarshallerContext _ctx) {
		...
		List<BackupSetDownloadTaskDetail> itemsList = new ArrayList<BackupSetDownloadTaskDetail>();
		for (int i = 0; i < _ctx.lengthValue("DescribeBackupSetDownloadTaskListResponse.Items.Length"); i++) {
			...
			itemsList.add(backupSetDownloadTaskDetail);
		}
		describeBackupSetDownloadTaskListResponse.setItems(itemsList);

...
import com.aliyuncs.v5.dbs.model.v20190306.DescribeBackupPlanListResponse;
import com.aliyuncs.v5.dbs.model.v20190306.DescribeBackupPlanListResponse.BackupPlanDetail;
...
public class DescribeBackupPlanListResponseUnmarshaller {
	...
	public static DescribeBackupPlanListResponse unmarshall(DescribeBackupPlanListResponse describeBackupPlanListResponse, UnmarshallerContext _ctx) {
		...
		List<BackupPlanDetail> itemsList = new ArrayList<BackupPlanDetail>();
		for (int i = 0; i < _ctx.lengthValue("DescribeBackupPlanListResponse.Items.Length"); i++) {
			...
			itemsList.add(backupPlanDetail);
		}
		describeBackupPlanListResponse.setItems(itemsList);

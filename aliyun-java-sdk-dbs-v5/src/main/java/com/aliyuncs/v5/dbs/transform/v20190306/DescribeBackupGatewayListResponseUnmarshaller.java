...
import com.aliyuncs.v5.dbs.model.v20190306.DescribeBackupGatewayListResponse;
import com.aliyuncs.v5.dbs.model.v20190306.DescribeBackupGatewayListResponse.BackupGateway;
...
public class DescribeBackupGatewayListResponseUnmarshaller {
	...
	public static DescribeBackupGatewayListResponse unmarshall(DescribeBackupGatewayListResponse describeBackupGatewayListResponse, UnmarshallerContext _ctx) {
		...
		List<BackupGateway> itemsList = new ArrayList<BackupGateway>();
		for (int i = 0; i < _ctx.lengthValue("DescribeBackupGatewayListResponse.Items.Length"); i++) {
			...
			itemsList.add(backupGateway);
		}
		describeBackupGatewayListResponse.setItems(itemsList);

...
import com.aliyuncs.v5.dbs.model.v20190306.DescribeRestoreRangeInfoResponse;
import com.aliyuncs.v5.dbs.model.v20190306.DescribeRestoreRangeInfoResponse.DBSRecoverRange;
import com.aliyuncs.v5.dbs.model.v20190306.DescribeRestoreRangeInfoResponse.DBSRecoverRange.FullBackupDetail;
...
public class DescribeRestoreRangeInfoResponseUnmarshaller {
	...
	public static DescribeRestoreRangeInfoResponse unmarshall(DescribeRestoreRangeInfoResponse describeRestoreRangeInfoResponse, UnmarshallerContext _ctx) {
		...
		List<DBSRecoverRange> itemsList = new ArrayList<DBSRecoverRange>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRestoreRangeInfoResponse.Items.Length"); i++) {
			...
			List<FullBackupDetail> fullBackupListList = new ArrayList<FullBackupDetail>();
			for (int j = 0; j < _ctx.lengthValue("DescribeRestoreRangeInfoResponse.Items["+ i +"].FullBackupList.Length"); j++) {
				...
				fullBackupListList.add(fullBackupDetail);
			}
			dBSRecoverRange.setFullBackupList(fullBackupListList);

			itemsList.add(dBSRecoverRange);
		}
		describeRestoreRangeInfoResponse.setItems(itemsList);

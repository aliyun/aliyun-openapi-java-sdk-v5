...
import com.aliyuncs.v5.dts.model.v20200101.DescribeJobMonitorRuleResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeJobMonitorRuleResponse.MonitorRule;
...
public class DescribeJobMonitorRuleResponseUnmarshaller {
	...
	public static DescribeJobMonitorRuleResponse unmarshall(DescribeJobMonitorRuleResponse describeJobMonitorRuleResponse, UnmarshallerContext _ctx) {
		...
		List<MonitorRule> monitorRulesList = new ArrayList<MonitorRule>();
		for (int i = 0; i < _ctx.lengthValue("DescribeJobMonitorRuleResponse.MonitorRules.Length"); i++) {
			...
			monitorRulesList.add(monitorRule);
		}
		describeJobMonitorRuleResponse.setMonitorRules(monitorRulesList);

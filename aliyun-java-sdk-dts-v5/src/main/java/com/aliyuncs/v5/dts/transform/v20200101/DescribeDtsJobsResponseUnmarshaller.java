...
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.DataEtlStatus;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.DataInitializationStatus;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.DataSynchronizationStatus;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.DestinationEndpoint;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.DtsTag;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.MigrationMode;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.Performance;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.PrecheckStatus;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.PrecheckStatus.PrecheckDetail;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.ReverseJob;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.ReverseJob.DataInitializationStatus1;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.ReverseJob.DataSynchronizationStatus2;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.ReverseJob.DestinationEndpoint3;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.ReverseJob.MigrationMode4;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.ReverseJob.Performance5;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.ReverseJob.PrecheckStatus6;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.ReverseJob.PrecheckStatus6.PrecheckDetail10;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.ReverseJob.SourceEndpoint7;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.ReverseJob.StructureInitializationStatus8;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.SourceEndpoint;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobsResponse.DtsJobStatus.StructureInitializationStatus;
...
public class DescribeDtsJobsResponseUnmarshaller {
	...
	public static DescribeDtsJobsResponse unmarshall(DescribeDtsJobsResponse describeDtsJobsResponse, UnmarshallerContext _ctx) {
		...
		List<DtsJobStatus> dtsJobListList = new ArrayList<DtsJobStatus>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDtsJobsResponse.DtsJobList.Length"); i++) {
			...
			List<PrecheckDetail> detailList = new ArrayList<PrecheckDetail>();
			for (int j = 0; j < _ctx.lengthValue("DescribeDtsJobsResponse.DtsJobList["+ i +"].PrecheckStatus.Detail.Length"); j++) {
				...
				detailList.add(precheckDetail);
			}
			precheckStatus.setDetail(detailList);
			...
			List<PrecheckDetail10> detail9List = new ArrayList<PrecheckDetail10>();
			for (int j = 0; j < _ctx.lengthValue("DescribeDtsJobsResponse.DtsJobList["+ i +"].ReverseJob.PrecheckStatus.Detail.Length"); j++) {
				...
				detail9List.add(precheckDetail10);
			}
			precheckStatus6.setDetail9(detail9List);
			...
			List<DtsTag> tagListList = new ArrayList<DtsTag>();
			for (int j = 0; j < _ctx.lengthValue("DescribeDtsJobsResponse.DtsJobList["+ i +"].TagList.Length"); j++) {
				...
				tagListList.add(dtsTag);
			}
			dtsJobStatus.setTagList(tagListList);

			dtsJobListList.add(dtsJobStatus);
		}
		describeDtsJobsResponse.setDtsJobList(dtsJobListList);

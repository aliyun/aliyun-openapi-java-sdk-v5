...
import com.aliyuncs.v5.dts.model.v20200101.DescribeConsumerGroupResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeConsumerGroupResponse.DescribeConsumerChannel;
...
public class DescribeConsumerGroupResponseUnmarshaller {
	...
	public static DescribeConsumerGroupResponse unmarshall(DescribeConsumerGroupResponse describeConsumerGroupResponse, UnmarshallerContext _ctx) {
		...
		List<DescribeConsumerChannel> consumerChannelsList = new ArrayList<DescribeConsumerChannel>();
		for (int i = 0; i < _ctx.lengthValue("DescribeConsumerGroupResponse.ConsumerChannels.Length"); i++) {
			...
			consumerChannelsList.add(describeConsumerChannel);
		}
		describeConsumerGroupResponse.setConsumerChannels(consumerChannelsList);

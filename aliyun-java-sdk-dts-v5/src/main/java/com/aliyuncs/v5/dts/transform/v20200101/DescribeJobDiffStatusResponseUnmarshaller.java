...
import com.aliyuncs.v5.dts.model.v20200101.DescribeJobDiffStatusResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeJobDiffStatusResponse.DiffInfosItem;
...
public class DescribeJobDiffStatusResponseUnmarshaller {
	...
	public static DescribeJobDiffStatusResponse unmarshall(DescribeJobDiffStatusResponse describeJobDiffStatusResponse, UnmarshallerContext _ctx) {
		...
		List<DiffInfosItem> diffInfosList = new ArrayList<DiffInfosItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeJobDiffStatusResponse.DiffInfos.Length"); i++) {
			...
			diffInfosList.add(diffInfosItem);
		}
		describeJobDiffStatusResponse.setDiffInfos(diffInfosList);

...
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.DataInitializationStatus;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.DataSynchronizationStatus;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.DestinationEndpoint;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.Performance;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.PrecheckStatus;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.PrecheckStatus.CheckItem;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.SourceEndpoint;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.StructureInitializationStatus;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.SynchronizationObject;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.SynchronizationObject.TableExclude;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.SynchronizationObject.TableInclude;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSynchronizationJobsResponse.SynchronizationInstance.Tag;
...
public class DescribeSynchronizationJobsResponseUnmarshaller {
	...
	public static DescribeSynchronizationJobsResponse unmarshall(DescribeSynchronizationJobsResponse describeSynchronizationJobsResponse, UnmarshallerContext _ctx) {
		...
		List<SynchronizationInstance> synchronizationInstancesList = new ArrayList<SynchronizationInstance>();
		for (int i = 0; i < _ctx.lengthValue("DescribeSynchronizationJobsResponse.SynchronizationInstances.Length"); i++) {
			...
			List<CheckItem> detailList = new ArrayList<CheckItem>();
			...
			synchronizationInstance.setTags(tagsList);

			List<SynchronizationObject> synchronizationObjectsList = new ArrayList<SynchronizationObject>();
			for (int j = 0; j < _ctx.lengthValue("DescribeSynchronizationJobsResponse.SynchronizationInstances["+ i +"].SynchronizationObjects.Length"); j++) {
				...
				List<TableExclude> tableExcludesList = new ArrayList<TableExclude>();
				for (int k = 0; k < _ctx.lengthValue("DescribeSynchronizationJobsResponse.SynchronizationInstances["+ i +"].SynchronizationObjects["+ j +"].TableExcludes.Length"); k++) {
					...
					tableExcludesList.add(tableExclude);
				}
				synchronizationObject.setTableExcludes(tableExcludesList);

				List<TableInclude> tableIncludesList = new ArrayList<TableInclude>();
				for (int k = 0; k < _ctx.lengthValue("DescribeSynchronizationJobsResponse.SynchronizationInstances["+ i +"].SynchronizationObjects["+ j +"].TableIncludes.Length"); k++) {
					...
					tableIncludesList.add(tableInclude);
				}
				synchronizationObject.setTableIncludes(tableIncludesList);

				synchronizationObjectsList.add(synchronizationObject);
			}
			synchronizationInstance.setSynchronizationObjects(synchronizationObjectsList);

			synchronizationInstancesList.add(synchronizationInstance);
		}
		describeSynchronizationJobsResponse.setSynchronizationInstances(synchronizationInstancesList);

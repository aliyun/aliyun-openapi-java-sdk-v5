...
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse.MigrationJob;
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse.MigrationJob.DataInitialization;
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse.MigrationJob.DataSynchronization;
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse.MigrationJob.DestinationEndpoint;
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse.MigrationJob.MigrationMode;
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse.MigrationJob.Precheck;
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse.MigrationJob.SourceEndpoint;
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse.MigrationJob.StructureInitialization;
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse.MigrationJob.SynchronousObject;
import com.aliyuncs.v5.dts.model.v20200101.DescribeMigrationJobsResponse.MigrationJob.Tag;
...
public class DescribeMigrationJobsResponseUnmarshaller {
	...
	public static DescribeMigrationJobsResponse unmarshall(DescribeMigrationJobsResponse describeMigrationJobsResponse, UnmarshallerContext _ctx) {
		...
		List<MigrationJob> migrationJobsList = new ArrayList<MigrationJob>();
		for (int i = 0; i < _ctx.lengthValue("DescribeMigrationJobsResponse.MigrationJobs.Length"); i++) {
			...
			List<SynchronousObject> migrationObjectList = new ArrayList<SynchronousObject>();
			for (int j = 0; j < _ctx.lengthValue("DescribeMigrationJobsResponse.MigrationJobs["+ i +"].MigrationObject.Length"); j++) {
				...
				migrationObjectList.add(synchronousObject);
			}
			migrationJob.setMigrationObject(migrationObjectList);
			...
			migrationJob.setTags(tagsList);

			migrationJobsList.add(migrationJob);
		}
		describeMigrationJobsResponse.setMigrationJobs(migrationJobsList);

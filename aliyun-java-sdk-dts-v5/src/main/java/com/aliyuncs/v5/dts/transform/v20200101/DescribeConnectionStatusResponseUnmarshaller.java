...
import com.aliyuncs.v5.dts.model.v20200101.DescribeConnectionStatusResponse;
...
public class DescribeConnectionStatusResponseUnmarshaller {
	...
	public static DescribeConnectionStatusResponse unmarshall(DescribeConnectionStatusResponse describeConnectionStatusResponse, UnmarshallerContext _ctx) {
		...
		describeConnectionStatusResponse.setSourceConnectionStatus(_ctx.stringValue("DescribeConnectionStatusResponse.SourceConnectionStatus"));
		describeConnectionStatusResponse.setDestinationConnectionStatus(_ctx.stringValue("DescribeConnectionStatusResponse.DestinationConnectionStatus"));

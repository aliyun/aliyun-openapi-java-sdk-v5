...
import com.aliyuncs.v5.dts.model.v20200101.DescribeConsumerChannelResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeConsumerChannelResponse.ConsumerChannel;
...
public class DescribeConsumerChannelResponseUnmarshaller {
	...
	public static DescribeConsumerChannelResponse unmarshall(DescribeConsumerChannelResponse describeConsumerChannelResponse, UnmarshallerContext _ctx) {
		...
		List<ConsumerChannel> consumerChannelsList = new ArrayList<ConsumerChannel>();
		for (int i = 0; i < _ctx.lengthValue("DescribeConsumerChannelResponse.ConsumerChannels.Length"); i++) {
			...
			consumerChannelsList.add(consumerChannel);
		}
		describeConsumerChannelResponse.setConsumerChannels(consumerChannelsList);

...
import com.aliyuncs.v5.dts.model.v20200101.DescribeCenVpcResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeCenVpcResponse.CenVpcItem;
...
public class DescribeCenVpcResponseUnmarshaller {
	...
	public static DescribeCenVpcResponse unmarshall(DescribeCenVpcResponse describeCenVpcResponse, UnmarshallerContext _ctx) {
		...
		List<CenVpcItem> cenVpcList = new ArrayList<CenVpcItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeCenVpcResponse.CenVpc.Length"); i++) {
			...
			cenVpcList.add(cenVpcItem);
		}
		describeCenVpcResponse.setCenVpc(cenVpcList);

...
import com.aliyuncs.v5.dts.model.v20200101.DescribeDgDatabasesResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDgDatabasesResponse.DgDatabasesItem;
...
public class DescribeDgDatabasesResponseUnmarshaller {
	...
	public static DescribeDgDatabasesResponse unmarshall(DescribeDgDatabasesResponse describeDgDatabasesResponse, UnmarshallerContext _ctx) {
		...
		List<DgDatabasesItem> dgDatabasesList = new ArrayList<DgDatabasesItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDgDatabasesResponse.DgDatabases.Length"); i++) {
			...
			dgDatabasesList.add(dgDatabasesItem);
		}
		describeDgDatabasesResponse.setDgDatabases(dgDatabasesList);

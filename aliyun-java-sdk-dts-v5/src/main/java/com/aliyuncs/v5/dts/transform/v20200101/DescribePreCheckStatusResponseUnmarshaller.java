...
import com.aliyuncs.v5.dts.model.v20200101.DescribePreCheckStatusResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribePreCheckStatusResponse.ProgressInfo;
import com.aliyuncs.v5.dts.model.v20200101.DescribePreCheckStatusResponse.ProgressInfo.JobLog;
import com.aliyuncs.v5.dts.model.v20200101.DescribePreCheckStatusResponse.SubDistributedJobStatusItem;
import com.aliyuncs.v5.dts.model.v20200101.DescribePreCheckStatusResponse.SubDistributedJobStatusItem.ProgressInfo2;
import com.aliyuncs.v5.dts.model.v20200101.DescribePreCheckStatusResponse.SubDistributedJobStatusItem.ProgressInfo2.JobLog4;
...
public class DescribePreCheckStatusResponseUnmarshaller {
	...
	public static DescribePreCheckStatusResponse unmarshall(DescribePreCheckStatusResponse describePreCheckStatusResponse, UnmarshallerContext _ctx) {
		...
		List<ProgressInfo> jobProgressList = new ArrayList<ProgressInfo>();
		for (int i = 0; i < _ctx.lengthValue("DescribePreCheckStatusResponse.JobProgress.Length"); i++) {
			...
			List<JobLog> logsList = new ArrayList<JobLog>();
			...
			progressInfo.setLogs(logsList);

			jobProgressList.add(progressInfo);
		}
		describePreCheckStatusResponse.setJobProgress(jobProgressList);

		List<SubDistributedJobStatusItem> subDistributedJobStatusList = new ArrayList<SubDistributedJobStatusItem>();
		for (int i = 0; i < _ctx.lengthValue("DescribePreCheckStatusResponse.SubDistributedJobStatus.Length"); i++) {
			...
			List<ProgressInfo2> jobProgress1List = new ArrayList<ProgressInfo2>();
			for (int j = 0; j < _ctx.lengthValue("DescribePreCheckStatusResponse.SubDistributedJobStatus["+ i +"].JobProgress.Length"); j++) {
				...
				List<JobLog4> logs3List = new ArrayList<JobLog4>();
				for (int k = 0; k < _ctx.lengthValue("DescribePreCheckStatusResponse.SubDistributedJobStatus["+ i +"].JobProgress["+ j +"].Logs.Length"); k++) {
					...
					logs3List.add(jobLog4);
				}
				progressInfo2.setLogs3(logs3List);

				jobProgress1List.add(progressInfo2);
			}
			subDistributedJobStatusItem.setJobProgress1(jobProgress1List);

			subDistributedJobStatusList.add(subDistributedJobStatusItem);
		}
		describePreCheckStatusResponse.setSubDistributedJobStatus(subDistributedJobStatusList);

...
import com.aliyuncs.v5.dts.model.v20200101.DescribeSubscriptionInstancesResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSubscriptionInstancesResponse.SubscriptionInstance;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSubscriptionInstancesResponse.SubscriptionInstance.SourceEndpoint;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSubscriptionInstancesResponse.SubscriptionInstance.SubscriptionDataType;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSubscriptionInstancesResponse.SubscriptionInstance.SubscriptionHost;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSubscriptionInstancesResponse.SubscriptionInstance.SynchronousObject;
import com.aliyuncs.v5.dts.model.v20200101.DescribeSubscriptionInstancesResponse.SubscriptionInstance.Tag;
...
public class DescribeSubscriptionInstancesResponseUnmarshaller {
	...
	public static DescribeSubscriptionInstancesResponse unmarshall(DescribeSubscriptionInstancesResponse describeSubscriptionInstancesResponse, UnmarshallerContext _ctx) {
		...
		List<SubscriptionInstance> subscriptionInstancesList = new ArrayList<SubscriptionInstance>();
		for (int i = 0; i < _ctx.lengthValue("DescribeSubscriptionInstancesResponse.SubscriptionInstances.Length"); i++) {
			...
			subscriptionInstance.setSubscriptionObject(subscriptionObjectList);
			...
			subscriptionInstance.setTags(tagsList);

			subscriptionInstancesList.add(subscriptionInstance);
		}
		describeSubscriptionInstancesResponse.setSubscriptionInstances(subscriptionInstancesList);

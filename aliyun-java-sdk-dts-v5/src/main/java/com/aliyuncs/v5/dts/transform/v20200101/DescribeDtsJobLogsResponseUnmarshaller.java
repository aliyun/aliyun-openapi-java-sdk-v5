...
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobLogsResponse;
import com.aliyuncs.v5.dts.model.v20200101.DescribeDtsJobLogsResponse.JobRunningLog;
...
public class DescribeDtsJobLogsResponseUnmarshaller {
	...
	public static DescribeDtsJobLogsResponse unmarshall(DescribeDtsJobLogsResponse describeDtsJobLogsResponse, UnmarshallerContext _ctx) {
		...
		List<JobRunningLog> jobRunningLogsList = new ArrayList<JobRunningLog>();
		for (int i = 0; i < _ctx.lengthValue("DescribeDtsJobLogsResponse.JobRunningLogs.Length"); i++) {
			...
			jobRunningLogsList.add(jobRunningLog);
		}
		describeDtsJobLogsResponse.setJobRunningLogs(jobRunningLogsList);
